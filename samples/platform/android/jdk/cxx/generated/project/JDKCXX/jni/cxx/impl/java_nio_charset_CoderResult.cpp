...
JDKCXX::java_nio_charset_CoderResult java_nio_charset_CoderResult::malformedForLength(int& arg0)
{
	LOGV("JDKCXX::java_nio_charset_CoderResult java_nio_charset_CoderResult::malformedForLength(int& arg0) enter");
	...
	LOGV("JDKCXX::java_nio_charset_CoderResult java_nio_charset_CoderResult::malformedForLength(int& arg0) exit");
...
JDKCXX::java_nio_charset_CoderResult java_nio_charset_CoderResult::unmappableForLength(int& arg0)
{
	LOGV("JDKCXX::java_nio_charset_CoderResult java_nio_charset_CoderResult::unmappableForLength(int& arg0) enter");
	...
	LOGV("JDKCXX::java_nio_charset_CoderResult java_nio_charset_CoderResult::unmappableForLength(int& arg0) exit");
