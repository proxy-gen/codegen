...
template void convert_proxy<android_content_ClipData_Item>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
android_content_ClipData::android_content_ClipData(const android_content_ClipData& cc)
{
	LOGV("android_content_ClipData::android_content_ClipData(const android_content_ClipData& cc) invoked");
...
{
	LOGV("android_content_ClipData::android_content_ClipData(void * proxy) invoked");
...
{
	LOGV("android_content_ClipData::~android_content_ClipData() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
java_lang_String *  android_content_ClipData::toString()
{
	const char *methodName = "toString";
	const char *methodSignature = "()Ljava/lang/String;";
	const char *className = "android_content_ClipData";
...
void android_content_ClipData::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
...
android_content_ClipData *  android_content_ClipData::newIntent(java_lang_CharSequence& arg0,android_content_Intent& arg1)
{
...
android_content_ClipData *  android_content_ClipData::newPlainText(java_lang_CharSequence& arg0)
{
	const char *methodName = "newPlainText";
	const char *methodSignature = "(Ljava/lang/CharSequence;)Landroid/content/ClipData;";
	const char *className = "android_content_ClipData";
...
android_content_ClipData *  android_content_ClipData::newHtmlText(java_lang_CharSequence& arg0,java_lang_String& arg1)
{
	const char *methodName = "newHtmlText";
	const char *methodSignature = "(Ljava/lang/CharSequence;Ljava/lang/String;)Landroid/content/ClipData;";
	const char *className = "android_content_ClipData";
...
android_content_ClipData *  android_content_ClipData::newUri(android_content_ContentResolver& arg0,java_lang_CharSequence& arg1,android_net_Uri& arg2)
{
...
android_content_ClipData *  android_content_ClipData::newRawUri(java_lang_CharSequence& arg0,android_net_Uri& arg1)
{
...
android_content_ClipDescription *  android_content_ClipData::getDescription()
{
...
void android_content_ClipData::addItem(android_content_ClipData_Item& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_content_ClipData_Item>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
android_content_ClipData_Item *  android_content_ClipData::getItemAt(int& arg0)
{
	...
	android_content_ClipData_Item *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature,jarg0);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
	...
	result = (android_content_ClipData_Item * ) (*((android_content_ClipData_Item *  *) cxx_value));
