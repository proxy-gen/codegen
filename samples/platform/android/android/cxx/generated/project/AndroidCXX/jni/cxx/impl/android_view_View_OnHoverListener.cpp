...
#define LOG_TAG "android_view_View_OnHoverListener"
...
bool android_view_View_OnHoverListener::onHover(android_view_View& arg0,android_view_MotionEvent& arg1)
{
	const char *methodName = "onHover";
	const char *methodSignature = "(Landroid/view/View;Landroid/view/MotionEvent;)Z";
	const char *className = "android_view_View_OnHoverListener";
	...
	LOGV("android_view_View_OnHoverListener jni address %d", javaObject);
