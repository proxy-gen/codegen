...
{
	LOGV("android_view_MotionEvent_PointerCoords::android_view_MotionEvent_PointerCoords(const android_view_MotionEvent_PointerCoords& cc) invoked");
...
{
	LOGV("android_view_MotionEvent_PointerCoords::android_view_MotionEvent_PointerCoords(void * proxy) invoked");
...
{
	LOGV("android_view_MotionEvent_PointerCoords::~android_view_MotionEvent_PointerCoords() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
