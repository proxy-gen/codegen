...
AndroidCXX::java_lang_String java_lang_Boolean::toString()
{
	LOGV("AndroidCXX::java_lang_String java_lang_Boolean::toString() enter");
...
{
	LOGV("int java_lang_Boolean::hashCode() enter");
...
{
	LOGV("bool java_lang_Boolean::booleanValue() enter");
