...
{
	LOGV("bool android_os_MessageQueue_IdleHandler::queueIdle() enter");

	const char *methodName = "queueIdle";
	const char *methodSignature = "()Z";
	const char *className = "android/os/MessageQueue$IdleHandler";

	LOGV("android_os_MessageQueue_IdleHandler className %s methodName %s methodSignature %s", className, methodName, methodSignature);
