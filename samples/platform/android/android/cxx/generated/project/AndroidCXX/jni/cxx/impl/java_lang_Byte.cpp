...
{
	LOGV("java_lang_Byte::java_lang_Byte(const java_lang_Byte& cc) invoked");
...
{
	LOGV("java_lang_Byte::java_lang_Byte(void * proxy) invoked");
...
{
	LOGV("java_lang_Byte::~java_lang_Byte() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
