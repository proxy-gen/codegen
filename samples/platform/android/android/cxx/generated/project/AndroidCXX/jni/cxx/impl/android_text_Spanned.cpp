...
std::vector<long> android_text_Spanned::getSpans(int& arg0,java_lang_Class& arg1)
{
	...
	const char *methodSignature = "(ILjava/lang/Class;)[java/lang/Object";
	const char *className = "android_text_Spanned";
	...
	LOGV("android_text_Spanned jni address %d", javaObject);
...
int android_text_Spanned::nextSpanTransition(int& arg0,java_lang_Class& arg1)
{
	...
	const char *methodSignature = "(ILjava/lang/Class;)I";
	const char *className = "android_text_Spanned";
