...
{
	LOGV("java_io_PrintWriter::java_io_PrintWriter(const java_io_PrintWriter& cc) invoked");
...
{
	LOGV("java_io_PrintWriter::java_io_PrintWriter(void * proxy) invoked");
...
{
	LOGV("java_io_PrintWriter::~java_io_PrintWriter() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
void java_io_PrintWriter::println(char& arg0,bool& arg1,java_lang_Object& arg2,java_lang_String& arg3,std::vector<char>& arg4,double& arg5,float& arg6,long& arg7,int& arg8)
{
	const char *methodName = "println";
	const char *methodSignature = "(CZLjava/lang/Object;Ljava/lang/String;[[CDFJI)V";
	const char *className = "java_io_PrintWriter";
	...
	jdouble jarg5;
	{
		...
		// Convert to JNI
		jarg5 = convert_jni_double_to_jni(java_value);
	}
	jfloat jarg6;
	{
	...
	jlong jarg7;
	{
		...
		// Convert to JNI
		jarg7 = convert_jni_long_to_jni(java_value);
	}
	jint jarg8;
	{
...
java_io_PrintWriter *  java_io_PrintWriter::append(java_lang_CharSequence& arg0,int& arg1,char& arg2)
{
	const char *methodName = "append";
	const char *methodSignature = "(Ljava/lang/CharSequence;IC)Ljava/io/PrintWriter;";
	const char *className = "java_io_PrintWriter";
	...
	result = (java_io_PrintWriter * ) (*((java_io_PrintWriter *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
java_io_PrintWriter *  java_io_PrintWriter::format(java_util_Locale& arg0,java_lang_String& arg1,std::vector<long>& arg2)
{
	const char *methodName = "format";
	const char *methodSignature = "(Ljava/util/Locale;Ljava/lang/String;[java/lang/Object)Ljava/io/PrintWriter;";
	const char *className = "java_io_PrintWriter";
...
void java_io_PrintWriter::write(std::vector<char>& arg0,int& arg1,java_lang_String& arg2)
{
	const char *methodName = "write";
	const char *methodSignature = "([[CILjava/lang/String;)V";
	const char *className = "java_io_PrintWriter";
...
void java_io_PrintWriter::print(java_lang_String& arg0,java_lang_Object& arg1,bool& arg2,char& arg3,int& arg4,long& arg5,float& arg6,double& arg7,std::vector<char>& arg8)
{
	const char *methodName = "print";
	const char *methodSignature = "(Ljava/lang/String;Ljava/lang/Object;ZCIJFD[[C)V";
	const char *className = "java_io_PrintWriter";
	...
	jchar jarg3;
	{
		...
		// Convert to JNI
		jarg3 = convert_jni_char_to_jni(java_value);
	}
	jint jarg4;
	{
		long cxx_value = (long) & arg4;
	...
	jcharArray jarg8;
	{
		...
		// Convert to JNI
		jarg8 = convert_jni__char_array_type_to_jni(java_value);
	}
...
java_io_PrintWriter *  java_io_PrintWriter::printf(java_lang_String& arg0,std::vector<long>& arg1,java_util_Locale& arg2)
{
	const char *methodName = "printf";
	const char *methodSignature = "(Ljava/lang/String;[java/lang/ObjectLjava/util/Locale;)Ljava/io/PrintWriter;";
	const char *className = "java_io_PrintWriter";
