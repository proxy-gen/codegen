...
// Functions
void android_database_DatabaseErrorHandler::onCorruption(android_database_sqlite_SQLiteDatabase& arg0)
{
	const char *methodName = "onCorruption";
	const char *methodSignature = "(Landroid/database/sqlite/SQLiteDatabase;)V";
	const char *className = "android_database_DatabaseErrorHandler";
