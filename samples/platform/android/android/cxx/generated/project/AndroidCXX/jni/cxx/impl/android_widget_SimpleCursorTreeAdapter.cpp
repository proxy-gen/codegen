...
template void convert_proxy<android_widget_SimpleCursorTreeAdapter_ViewBinder>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
android_widget_SimpleCursorTreeAdapter_ViewBinder *  android_widget_SimpleCursorTreeAdapter::getViewBinder()
{
	const char *methodName = "getViewBinder";
	const char *methodSignature = "()Landroid/widget/SimpleCursorTreeAdapter$ViewBinder;";
	const char *className = "android_widget_SimpleCursorTreeAdapter";
	...
	android_widget_SimpleCursorTreeAdapter_ViewBinder *  result;
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		convert_proxy<android_widget_SimpleCursorTreeAdapter_ViewBinder>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_widget_SimpleCursorTreeAdapter_ViewBinder * ) (*((android_widget_SimpleCursorTreeAdapter_ViewBinder *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
void android_widget_SimpleCursorTreeAdapter::setViewBinder(android_widget_SimpleCursorTreeAdapter_ViewBinder& arg0)
{
...
void android_widget_SimpleCursorTreeAdapter::setViewText(android_widget_TextView& arg0,java_lang_String& arg1)
{
