...
template void convert_proxy<android_widget_RelativeLayout_LayoutParams>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
{
	LOGV("android_widget_RelativeLayout::android_widget_RelativeLayout(const android_widget_RelativeLayout& cc) invoked");
...
{
	LOGV("android_widget_RelativeLayout::android_widget_RelativeLayout(void * proxy) invoked");
...
{
	LOGV("android_widget_RelativeLayout::~android_widget_RelativeLayout() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
bool android_widget_RelativeLayout::dispatchPopulateAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
	...
	const char *className = "android_widget_RelativeLayout";
...
android_widget_RelativeLayout_LayoutParams *  android_widget_RelativeLayout::generateLayoutParams(android_util_AttributeSet& arg0)
{
	...
	android_widget_RelativeLayout_LayoutParams *  result;
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_widget_RelativeLayout_LayoutParams>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_widget_RelativeLayout_LayoutParams * ) (*((android_widget_RelativeLayout_LayoutParams *  *) cxx_value));
...
void android_widget_RelativeLayout::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_RelativeLayout::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
