...
android_widget_SimpleAdapter_ViewBinder::android_widget_SimpleAdapter_ViewBinder(void * proxy)
{
	LOGV("android_widget_SimpleAdapter_ViewBinder::android_widget_SimpleAdapter_ViewBinder(void * proxy) enter");
	...
	LOGV("android_widget_SimpleAdapter_ViewBinder::android_widget_SimpleAdapter_ViewBinder(void * proxy) exit");
}
android_widget_SimpleAdapter_ViewBinder::android_widget_SimpleAdapter_ViewBinder()
{
	...
	LOGV("android_widget_SimpleAdapter_ViewBinder className %d methodName %s methodSignature %s", className, methodName, methodSignature);
...
// Functions
bool android_widget_SimpleAdapter_ViewBinder::setViewValue(AndroidCXX::android_view_View& arg0,AndroidCXX::java_lang_Object& arg1,AndroidCXX::java_lang_String& arg2)
{
	LOGV("bool android_widget_SimpleAdapter_ViewBinder::setViewValue(AndroidCXX::android_view_View& arg0,AndroidCXX::java_lang_Object& arg1,AndroidCXX::java_lang_String& arg2) enter");
	...
	LOGV("bool android_widget_SimpleAdapter_ViewBinder::setViewValue(AndroidCXX::android_view_View& arg0,AndroidCXX::java_lang_Object& arg1,AndroidCXX::java_lang_String& arg2) exit");
