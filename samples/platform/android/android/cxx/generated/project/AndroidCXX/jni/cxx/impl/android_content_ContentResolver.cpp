...
#define LOG_TAG "android_content_ContentResolver"
...
template void convert_proxy<android_content_ContentProviderClient>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_database_ContentObserver>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_accounts_Account>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_content_SyncInfo>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_content_SyncStatusObserver>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
java_lang_String *  android_content_ContentResolver::getType(android_net_Uri& arg0)
{
	const char *methodName = "getType";
	const char *methodSignature = "(Landroid/net/Uri;)Ljava/lang/String;";
	const char *className = "android_content_ContentResolver";
...
int android_content_ContentResolver::_delete(android_net_Uri& arg0,java_lang_String& arg1,std::vector<long>& arg2)
{
	const char *methodName = "delete";
	const char *methodSignature = "(Landroid/net/Uri;Ljava/lang/String;[java/lang/String)I";
	const char *className = "android_content_ContentResolver";
...
android_net_Uri *  android_content_ContentResolver::insert(android_net_Uri& arg0,android_content_ContentValues& arg1)
{
...
android_database_Cursor *  android_content_ContentResolver::query(android_net_Uri& arg0,std::vector<long>& arg1,java_lang_String& arg2,android_os_CancellationSignal& arg3)
{
	const char *methodName = "query";
	const char *methodSignature = "(Landroid/net/Uri;[java/lang/StringLjava/lang/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor;";
	const char *className = "android_content_ContentResolver";
...
int android_content_ContentResolver::update(android_net_Uri& arg0,android_content_ContentValues& arg1,java_lang_String& arg2,std::vector<long>& arg3)
{
	const char *methodName = "update";
	const char *methodSignature = "(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[java/lang/String)I";
	const char *className = "android_content_ContentResolver";
...
std::vector<long> android_content_ContentResolver::getStreamTypes(android_net_Uri& arg0,java_lang_String& arg1)
{
	const char *methodName = "getStreamTypes";
	const char *methodSignature = "(Landroid/net/Uri;Ljava/lang/String;)[java/lang/String";
	const char *className = "android_content_ContentResolver";
...
java_io_InputStream *  android_content_ContentResolver::openInputStream(android_net_Uri& arg0)
{
...
java_io_OutputStream *  android_content_ContentResolver::openOutputStream(android_net_Uri& arg0,java_lang_String& arg1)
{
...
android_os_ParcelFileDescriptor *  android_content_ContentResolver::openFileDescriptor(android_net_Uri& arg0,java_lang_String& arg1)
{
...
android_content_res_AssetFileDescriptor *  android_content_ContentResolver::openAssetFileDescriptor(android_net_Uri& arg0,java_lang_String& arg1)
{
...
android_content_res_AssetFileDescriptor *  android_content_ContentResolver::openTypedAssetFileDescriptor(android_net_Uri& arg0,java_lang_String& arg1,android_os_Bundle& arg2)
{
...
std::vector<long> android_content_ContentResolver::applyBatch(java_lang_String& arg0,java_util_ArrayList& arg1)
{
	const char *methodName = "applyBatch";
	const char *methodSignature = "(Ljava/lang/String;Ljava/util/ArrayList;)[android/content/ContentProviderResult";
	const char *className = "android_content_ContentResolver";
	...
	jobject jarg1;
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<android_content_ContentProviderOperation>);				
	...
	long java_value = convert_jni__object_array_type_to_java(jni_result);
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<android_content_ContentProviderResult>);				
...
int android_content_ContentResolver::bulkInsert(android_net_Uri& arg0,std::vector<long>& arg1)
{
	const char *methodName = "bulkInsert";
	const char *methodSignature = "(Landroid/net/Uri;[android/content/ContentValues)I";
	const char *className = "android_content_ContentResolver";
	...
	jobjectArray jarg1;
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<android_content_ContentValues>);				
...
android_os_Bundle *  android_content_ContentResolver::call(android_net_Uri& arg0,java_lang_String& arg1,android_os_Bundle& arg2)
{
	const char *methodName = "call";
	const char *methodSignature = "(Landroid/net/Uri;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;";
	const char *className = "android_content_ContentResolver";
...
android_content_ContentProviderClient *  android_content_ContentResolver::acquireContentProviderClient(android_net_Uri& arg0,java_lang_String& arg1)
{
	const char *methodName = "acquireContentProviderClient";
	const char *methodSignature = "(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/ContentProviderClient;";
	const char *className = "android_content_ContentResolver";
	...
	android_content_ContentProviderClient *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature,jarg0,jarg1);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.content.ContentProviderClient");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_content_ContentProviderClient>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_content_ContentProviderClient * ) (*((android_content_ContentProviderClient *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
android_content_ContentProviderClient *  android_content_ContentResolver::acquireUnstableContentProviderClient(android_net_Uri& arg0,java_lang_String& arg1)
{
...
void android_content_ContentResolver::registerContentObserver(android_net_Uri& arg0,bool& arg1,android_database_ContentObserver& arg2)
{
	...
	jobject jarg2;
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.database.ContentObserver");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_database_ContentObserver>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_content_ContentResolver::unregisterContentObserver(android_database_ContentObserver& arg0)
{
...
void android_content_ContentResolver::notifyChange(android_net_Uri& arg0,android_database_ContentObserver& arg1,bool& arg2)
{
...
void android_content_ContentResolver::startSync(android_net_Uri& arg0,android_os_Bundle& arg1)
{
...
void android_content_ContentResolver::requestSync(android_accounts_Account& arg0,java_lang_String& arg1,android_os_Bundle& arg2)
{
	...
	jobject jarg0;
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.accounts.Account");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_accounts_Account>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_content_ContentResolver::validateSyncExtrasBundle(android_os_Bundle& arg0)
{
...
void android_content_ContentResolver::cancelSync(android_net_Uri& arg0,android_accounts_Account& arg1,java_lang_String& arg2)
{
	const char *methodName = "cancelSync";
	const char *methodSignature = "(Landroid/net/Uri;Landroid/accounts/Account;Ljava/lang/String;)V";
	const char *className = "android_content_ContentResolver";
...
std::vector<long> android_content_ContentResolver::getSyncAdapterTypes()
{
	const char *methodName = "getSyncAdapterTypes";
	const char *methodSignature = "()[android/content/SyncAdapterType";
	const char *className = "android_content_ContentResolver";
	...
	long java_value = convert_jni__object_array_type_to_java(jni_result);
	{
		...
		}
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.content.SyncAdapterType");
		}
		std::stack<long> converter_stack;
		
		{
			{
				converter_stack.push((long) &convert_proxy<android_content_SyncAdapterType>);				
...
bool android_content_ContentResolver::getSyncAutomatically(android_accounts_Account& arg0,java_lang_String& arg1)
{
...
void android_content_ContentResolver::setSyncAutomatically(android_accounts_Account& arg0,java_lang_String& arg1,bool& arg2)
{
...
void android_content_ContentResolver::addPeriodicSync(android_accounts_Account& arg0,java_lang_String& arg1,android_os_Bundle& arg2,long& arg3)
{
...
void android_content_ContentResolver::removePeriodicSync(android_accounts_Account& arg0,java_lang_String& arg1,android_os_Bundle& arg2)
{
...
java_util_List *  android_content_ContentResolver::getPeriodicSyncs(android_accounts_Account& arg0,java_lang_String& arg1)
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		}
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.content.PeriodicSync");
		}
		std::stack<long> converter_stack;
		
		{
			{
				converter_stack.push((long) &convert_proxy<android_content_PeriodicSync>);				
...
int android_content_ContentResolver::getIsSyncable(android_accounts_Account& arg0,java_lang_String& arg1)
{
...
void android_content_ContentResolver::setIsSyncable(android_accounts_Account& arg0,java_lang_String& arg1,int& arg2)
{
...
{
	const char *methodName = "getMasterSyncAutomatically";
...
bool android_content_ContentResolver::isSyncActive(android_accounts_Account& arg0,java_lang_String& arg1)
{
...
android_content_SyncInfo *  android_content_ContentResolver::getCurrentSync()
{
	const char *methodName = "getCurrentSync";
	const char *methodSignature = "()Landroid/content/SyncInfo;";
	const char *className = "android_content_ContentResolver";
	...
	android_content_SyncInfo *  result;
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.content.SyncInfo");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_content_SyncInfo>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_content_SyncInfo * ) (*((android_content_SyncInfo *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
java_util_List *  android_content_ContentResolver::getCurrentSyncs()
{
	const char *methodName = "getCurrentSyncs";
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<android_content_SyncInfo>);				
...
bool android_content_ContentResolver::isSyncPending(android_accounts_Account& arg0,java_lang_String& arg1)
{
...
java_lang_Object *  android_content_ContentResolver::addStatusChangeListener(int& arg0,android_content_SyncStatusObserver& arg1)
{
	...
	jobject jarg1;
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.content.SyncStatusObserver");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_content_SyncStatusObserver>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_content_ContentResolver::removeStatusChangeListener(java_lang_Object& arg0)
{
