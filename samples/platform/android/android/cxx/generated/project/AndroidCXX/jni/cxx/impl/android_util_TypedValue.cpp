...
{
	LOGV("android_util_TypedValue::android_util_TypedValue(const android_util_TypedValue& cc) invoked");
...
{
	LOGV("android_util_TypedValue::android_util_TypedValue(void * proxy) invoked");
...
{
	LOGV("android_util_TypedValue::~android_util_TypedValue() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
