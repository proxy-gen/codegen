...
{
	LOGV("android_os_ParcelFileDescriptor::android_os_ParcelFileDescriptor(const android_os_ParcelFileDescriptor& cc) invoked");
...
{
	LOGV("android_os_ParcelFileDescriptor::android_os_ParcelFileDescriptor(void * proxy) invoked");
...
{
	LOGV("android_os_ParcelFileDescriptor::~android_os_ParcelFileDescriptor() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
java_lang_String *  android_os_ParcelFileDescriptor::toString()
{
	const char *methodName = "toString";
	const char *methodSignature = "()Ljava/lang/String;";
	const char *className = "android_os_ParcelFileDescriptor";
...
android_os_ParcelFileDescriptor *  android_os_ParcelFileDescriptor::open(java_io_File& arg0,int& arg1)
{
...
android_os_ParcelFileDescriptor *  android_os_ParcelFileDescriptor::dup(java_io_FileDescriptor& arg0)
{
...
void android_os_ParcelFileDescriptor::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
...
android_os_ParcelFileDescriptor *  android_os_ParcelFileDescriptor::fromFd(int& arg0)
{
...
android_os_ParcelFileDescriptor *  android_os_ParcelFileDescriptor::adoptFd(int& arg0)
{
...
android_os_ParcelFileDescriptor *  android_os_ParcelFileDescriptor::fromSocket(java_net_Socket& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<java_net_Socket>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
android_os_ParcelFileDescriptor *  android_os_ParcelFileDescriptor::fromDatagramSocket(java_net_DatagramSocket& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<java_net_DatagramSocket>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
std::vector<long> android_os_ParcelFileDescriptor::createPipe()
{
	const char *methodName = "createPipe";
	const char *methodSignature = "()[android/os/ParcelFileDescriptor";
	const char *className = "android_os_ParcelFileDescriptor";
	...
	long java_value = convert_jni__object_array_type_to_java(jni_result);
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<android_os_ParcelFileDescriptor>);				
...
java_io_FileDescriptor *  android_os_ParcelFileDescriptor::getFileDescriptor()
{
