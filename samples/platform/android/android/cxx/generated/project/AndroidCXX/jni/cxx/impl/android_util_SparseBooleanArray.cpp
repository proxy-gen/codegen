...
{
	LOGV("android_util_SparseBooleanArray::android_util_SparseBooleanArray() enter");	
...
{
	LOGV("AndroidCXX::android_util_SparseBooleanArray android_util_SparseBooleanArray::clone() enter");
...
{
	LOGV("void android_util_SparseBooleanArray::clear() enter");
...
{
	LOGV("int android_util_SparseBooleanArray::size() enter");
