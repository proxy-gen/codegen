...
{
	LOGV("android_content_pm_ApplicationInfo::android_content_pm_ApplicationInfo(const android_content_pm_ApplicationInfo& cc) invoked");
...
{
	LOGV("android_content_pm_ApplicationInfo::android_content_pm_ApplicationInfo(void * proxy) invoked");
...
{
	LOGV("android_content_pm_ApplicationInfo::~android_content_pm_ApplicationInfo() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
java_lang_String *  android_content_pm_ApplicationInfo::toString()
{
	const char *methodName = "toString";
	const char *methodSignature = "()Ljava/lang/String;";
	const char *className = "android_content_pm_ApplicationInfo";
...
void android_content_pm_ApplicationInfo::dump(android_util_Printer& arg0,java_lang_String& arg1)
{
...
void android_content_pm_ApplicationInfo::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
...
java_lang_CharSequence *  android_content_pm_ApplicationInfo::loadDescription(android_content_pm_PackageManager& arg0)
{
