...
{
	LOGV("android_widget_RadioButton::android_widget_RadioButton(const android_widget_RadioButton& cc) invoked");
...
{
	LOGV("android_widget_RadioButton::android_widget_RadioButton(void * proxy) invoked");
...
{
	LOGV("android_widget_RadioButton::~android_widget_RadioButton() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
void android_widget_RadioButton::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
	const char *methodName = "onInitializeAccessibilityEvent";
	const char *methodSignature = "(Landroid/view/accessibility/AccessibilityEvent;)V";
	const char *className = "android_widget_RadioButton";
	...
	LOGV("android_widget_RadioButton jni address %d", javaObject);
...
void android_widget_RadioButton::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
