...
{
	LOGV("android_widget_TabWidget::android_widget_TabWidget(const android_widget_TabWidget& cc) invoked");
...
{
	LOGV("android_widget_TabWidget::android_widget_TabWidget(void * proxy) invoked");
...
{
	LOGV("android_widget_TabWidget::~android_widget_TabWidget() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
