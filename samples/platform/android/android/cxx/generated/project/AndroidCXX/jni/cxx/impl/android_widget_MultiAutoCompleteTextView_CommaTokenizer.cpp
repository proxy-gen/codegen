...
{
	LOGV("android_widget_MultiAutoCompleteTextView_CommaTokenizer::android_widget_MultiAutoCompleteTextView_CommaTokenizer(const android_widget_MultiAutoCompleteTextView_CommaTokenizer& cc) invoked");
...
{
	LOGV("android_widget_MultiAutoCompleteTextView_CommaTokenizer::android_widget_MultiAutoCompleteTextView_CommaTokenizer(void * proxy) invoked");
...
{
	LOGV("android_widget_MultiAutoCompleteTextView_CommaTokenizer::~android_widget_MultiAutoCompleteTextView_CommaTokenizer() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
