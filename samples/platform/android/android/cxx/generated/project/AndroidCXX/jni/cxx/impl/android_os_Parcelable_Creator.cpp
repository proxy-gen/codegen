...
std::vector<long> android_os_Parcelable_Creator::newArray(int& arg0)
{
	const char *methodName = "newArray";
	const char *methodSignature = "(I)[java/lang/Object";
	const char *className = "android_os_Parcelable_Creator";
	...
	LOGV("android_os_Parcelable_Creator jni address %d", javaObject);
...
java_lang_Object *  android_os_Parcelable_Creator::createFromParcel(android_os_Parcel& arg0)
{
