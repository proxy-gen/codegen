...
{
	LOGV("android_widget_HeaderViewListAdapter::android_widget_HeaderViewListAdapter(const android_widget_HeaderViewListAdapter& cc) invoked");
...
{
	LOGV("android_widget_HeaderViewListAdapter::android_widget_HeaderViewListAdapter(void * proxy) invoked");
...
{
	LOGV("android_widget_HeaderViewListAdapter::~android_widget_HeaderViewListAdapter() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
