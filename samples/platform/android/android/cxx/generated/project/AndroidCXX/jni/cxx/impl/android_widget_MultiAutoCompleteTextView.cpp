...
template void convert_proxy<android_widget_MultiAutoCompleteTextView_Tokenizer>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
{
	LOGV("android_widget_MultiAutoCompleteTextView::android_widget_MultiAutoCompleteTextView(const android_widget_MultiAutoCompleteTextView& cc) invoked");
...
{
	LOGV("android_widget_MultiAutoCompleteTextView::android_widget_MultiAutoCompleteTextView(void * proxy) invoked");
...
{
	LOGV("android_widget_MultiAutoCompleteTextView::~android_widget_MultiAutoCompleteTextView() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
void android_widget_MultiAutoCompleteTextView::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
	const char *methodName = "onInitializeAccessibilityEvent";
	const char *methodSignature = "(Landroid/view/accessibility/AccessibilityEvent;)V";
	const char *className = "android_widget_MultiAutoCompleteTextView";
...
void android_widget_MultiAutoCompleteTextView::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
void android_widget_MultiAutoCompleteTextView::setTokenizer(android_widget_MultiAutoCompleteTextView_Tokenizer& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_MultiAutoCompleteTextView_Tokenizer>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
