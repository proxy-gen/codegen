...
// Functions
int android_widget_Scroller::getDuration()
{
	LOGV("int android_widget_Scroller::getDuration() enter");
	...
	LOGV("android_widget_Scroller jni address %d", javaObject);
...
{
	LOGV("bool android_widget_Scroller::isFinished() enter");
...
{
	LOGV("int android_widget_Scroller::getCurrX() enter");
...
int android_widget_Scroller::getCurrY()
{
	LOGV("int android_widget_Scroller::getCurrY() enter");
...
float android_widget_Scroller::getCurrVelocity()
{
	LOGV("float android_widget_Scroller::getCurrVelocity() enter");
...
int android_widget_Scroller::getStartX()
{
	LOGV("int android_widget_Scroller::getStartX() enter");
...
int android_widget_Scroller::getStartY()
{
	LOGV("int android_widget_Scroller::getStartY() enter");
...
int android_widget_Scroller::getFinalX()
{
	LOGV("int android_widget_Scroller::getFinalX() enter");
...
int android_widget_Scroller::getFinalY()
{
	LOGV("int android_widget_Scroller::getFinalY() enter");
...
bool android_widget_Scroller::computeScrollOffset()
{
	LOGV("bool android_widget_Scroller::computeScrollOffset() enter");
...
{
	LOGV("void android_widget_Scroller::abortAnimation() enter");
...
{
	LOGV("int android_widget_Scroller::timePassed() enter");

	const char *methodName = "timePassed";
	const char *methodSignature = "()I";
	const char *className = "android/widget/Scroller";
