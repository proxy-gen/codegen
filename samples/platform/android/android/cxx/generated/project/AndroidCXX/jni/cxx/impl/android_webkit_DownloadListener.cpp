...
#define LOG_TAG "android_webkit_DownloadListener"
...
// Functions
void android_webkit_DownloadListener::onDownloadStart(java_lang_String& arg0,long& arg1)
{
	const char *methodName = "onDownloadStart";
	const char *methodSignature = "(Ljava/lang/String;J)V";
	const char *className = "android_webkit_DownloadListener";
	...
	LOGV("android_webkit_DownloadListener jni address %d", javaObject);
