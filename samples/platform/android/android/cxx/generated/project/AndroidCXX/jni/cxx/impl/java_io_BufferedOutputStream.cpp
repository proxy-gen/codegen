...
{
	LOGV("java_io_BufferedOutputStream::java_io_BufferedOutputStream(const java_io_BufferedOutputStream& cc) invoked");
...
{
	LOGV("java_io_BufferedOutputStream::java_io_BufferedOutputStream(void * proxy) invoked");
...
{
	LOGV("java_io_BufferedOutputStream::~java_io_BufferedOutputStream() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
void java_io_BufferedOutputStream::write(int& arg0,std::vector<char>& arg1)
{
	...
	const char *className = "java_io_BufferedOutputStream";
	...
	LOGV("java_io_BufferedOutputStream jni address %d", javaObject);
