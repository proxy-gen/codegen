...
template void convert_proxy<android_widget_Chronometer>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Functions
void android_widget_Chronometer_OnChronometerTickListener::onChronometerTick(android_widget_Chronometer& arg0)
{
	const char *methodName = "onChronometerTick";
	const char *methodSignature = "(Landroid/widget/Chronometer;)V";
	const char *className = "android_widget_Chronometer_OnChronometerTickListener";
	...
	jobject jarg0;
	{
		...
		convert_proxy<android_widget_Chronometer>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
