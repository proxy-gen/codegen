...
{
	LOGV("android_view_animation_LayoutAnimationController::android_view_animation_LayoutAnimationController(const android_view_animation_LayoutAnimationController& cc) invoked");
...
{
	LOGV("android_view_animation_LayoutAnimationController::android_view_animation_LayoutAnimationController(void * proxy) invoked");
...
{
	LOGV("android_view_animation_LayoutAnimationController::~android_view_animation_LayoutAnimationController() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
void android_view_animation_LayoutAnimationController::start()
{
	...
	const char *className = "android_view_animation_LayoutAnimationController";
...
void android_view_animation_LayoutAnimationController::setInterpolator(android_view_animation_Interpolator& arg0,android_content_Context& arg1,int& arg2)
{
	const char *methodName = "setInterpolator";
	const char *methodSignature = "(Landroid/view/animation/Interpolator;Landroid/content/Context;I)V";
	const char *className = "android_view_animation_LayoutAnimationController";
...
android_view_animation_Animation *  android_view_animation_LayoutAnimationController::getAnimation()
{
...
android_view_animation_Interpolator *  android_view_animation_LayoutAnimationController::getInterpolator()
{
...
void android_view_animation_LayoutAnimationController::setAnimation(android_view_animation_Animation& arg0,android_content_Context& arg1,int& arg2)
{
...
android_view_animation_Animation *  android_view_animation_LayoutAnimationController::getAnimationForView(android_view_View& arg0)
{
