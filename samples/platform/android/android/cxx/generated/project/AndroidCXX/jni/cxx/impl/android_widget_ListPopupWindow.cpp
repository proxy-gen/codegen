...
template void convert_proxy<android_widget_ListView>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
android_widget_ListPopupWindow::android_widget_ListPopupWindow(const android_widget_ListPopupWindow& cc)
{
	LOGV("android_widget_ListPopupWindow::android_widget_ListPopupWindow(const android_widget_ListPopupWindow& cc) invoked");
...
{
	LOGV("android_widget_ListPopupWindow::android_widget_ListPopupWindow(void * proxy) invoked");
...
{
	LOGV("android_widget_ListPopupWindow::~android_widget_ListPopupWindow() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
void android_widget_ListPopupWindow::show()
{
	...
	const char *className = "android_widget_ListPopupWindow";
...
bool android_widget_ListPopupWindow::onKeyDown(int& arg0,android_view_KeyEvent& arg1)
{
...
bool android_widget_ListPopupWindow::onKeyUp(int& arg0,android_view_KeyEvent& arg1)
{
...
bool android_widget_ListPopupWindow::onKeyPreIme(int& arg0,android_view_KeyEvent& arg1)
{
...
void android_widget_ListPopupWindow::setBackgroundDrawable(android_graphics_drawable_Drawable& arg0)
{
...
android_graphics_drawable_Drawable *  android_widget_ListPopupWindow::getBackground()
{
...
void android_widget_ListPopupWindow::setOnDismissListener(android_widget_PopupWindow_OnDismissListener& arg0)
{
...
void android_widget_ListPopupWindow::setAdapter(android_widget_ListAdapter& arg0)
{
...
android_view_View *  android_widget_ListPopupWindow::getSelectedView()
{
...
void android_widget_ListPopupWindow::setOnItemClickListener(android_widget_AdapterView_OnItemClickListener& arg0)
{
...
void android_widget_ListPopupWindow::setOnItemSelectedListener(android_widget_AdapterView_OnItemSelectedListener& arg0)
{
...
java_lang_Object *  android_widget_ListPopupWindow::getSelectedItem()
{
...
void android_widget_ListPopupWindow::setListSelector(android_graphics_drawable_Drawable& arg0)
{
...
android_view_View *  android_widget_ListPopupWindow::getAnchorView()
{
...
void android_widget_ListPopupWindow::setAnchorView(android_view_View& arg0)
{
...
void android_widget_ListPopupWindow::setPromptView(android_view_View& arg0)
{
...
android_widget_ListView *  android_widget_ListPopupWindow::getListView()
{
	...
	android_widget_ListView *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_widget_ListView>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_widget_ListView * ) (*((android_widget_ListView *  *) cxx_value));
