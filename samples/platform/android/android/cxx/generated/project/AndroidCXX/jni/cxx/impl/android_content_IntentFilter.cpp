...
template void convert_proxy<android_util_Printer>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<java_util_Iterator>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_content_IntentFilter_AuthorityEntry>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_os_PatternMatcher>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<org_xmlpull_v1_XmlSerializer>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
{
	LOGV("android_content_IntentFilter::android_content_IntentFilter(const android_content_IntentFilter& cc) invoked");
...
{
	LOGV("android_content_IntentFilter::android_content_IntentFilter(void * proxy) invoked");
...
{
	LOGV("android_content_IntentFilter::~android_content_IntentFilter() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
void android_content_IntentFilter::setPriority(int& arg0)
{
	...
	const char *className = "android_content_IntentFilter";
...
android_content_IntentFilter *  android_content_IntentFilter::create(java_lang_String& arg0)
{
	const char *methodName = "create";
	const char *methodSignature = "(Ljava/lang/String;)Landroid/content/IntentFilter;";
	const char *className = "android_content_IntentFilter";
	...
	android_content_IntentFilter *  result;
	...
	result = (android_content_IntentFilter * ) (*((android_content_IntentFilter *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
int android_content_IntentFilter::match(java_lang_String& arg0,android_net_Uri& arg1,java_util_Set& arg2,android_content_ContentResolver& arg3,android_content_Intent& arg4,bool& arg5)
{
	const char *methodName = "match";
	const char *methodSignature = "(Ljava/lang/String;Landroid/net/Uri;Ljava/util/Set;Landroid/content/ContentResolver;Landroid/content/Intent;Z)I";
	const char *className = "android_content_IntentFilter";
	...
	jboolean jarg5;
	{
		...
		// Convert to JNI
		jarg5 = convert_jni_boolean_to_jni(java_value);
	}
...
void android_content_IntentFilter::dump(android_util_Printer& arg0,java_lang_String& arg1)
{
...
void android_content_IntentFilter::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
...
java_lang_String *  android_content_IntentFilter::getAction(int& arg0)
{
...
bool android_content_IntentFilter::hasCategory(java_lang_String& arg0)
{
...
void android_content_IntentFilter::addCategory(java_lang_String& arg0)
{
...
void android_content_IntentFilter::addAction(java_lang_String& arg0)
{
...
bool android_content_IntentFilter::hasAction(java_lang_String& arg0)
{
...
bool android_content_IntentFilter::matchAction(java_lang_String& arg0)
{
...
java_util_Iterator *  android_content_IntentFilter::actionsIterator()
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<java_util_Iterator>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
...
void android_content_IntentFilter::addDataType(java_lang_String& arg0)
{
...
bool android_content_IntentFilter::hasDataType(java_lang_String& arg0)
{
...
java_lang_String *  android_content_IntentFilter::getDataType(int& arg0)
{
...
java_util_Iterator *  android_content_IntentFilter::typesIterator()
{
...
void android_content_IntentFilter::addDataScheme(java_lang_String& arg0)
{
...
java_lang_String *  android_content_IntentFilter::getDataScheme(int& arg0)
{
...
bool android_content_IntentFilter::hasDataScheme(java_lang_String& arg0)
{
...
java_util_Iterator *  android_content_IntentFilter::schemesIterator()
{
...
void android_content_IntentFilter::addDataAuthority(java_lang_String& arg0)
{
...
android_content_IntentFilter_AuthorityEntry *  android_content_IntentFilter::getDataAuthority(int& arg0)
{
	...
	android_content_IntentFilter_AuthorityEntry *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature,jarg0);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_content_IntentFilter_AuthorityEntry>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_content_IntentFilter_AuthorityEntry * ) (*((android_content_IntentFilter_AuthorityEntry *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
bool android_content_IntentFilter::hasDataAuthority(android_net_Uri& arg0)
{
...
java_util_Iterator *  android_content_IntentFilter::authoritiesIterator()
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<android_content_IntentFilter_AuthorityEntry>);				
...
void android_content_IntentFilter::addDataPath(java_lang_String& arg0,int& arg1)
{
...
android_os_PatternMatcher *  android_content_IntentFilter::getDataPath(int& arg0)
{
	...
	android_os_PatternMatcher *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature,jarg0);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_os_PatternMatcher>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_os_PatternMatcher * ) (*((android_os_PatternMatcher *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
bool android_content_IntentFilter::hasDataPath(java_lang_String& arg0)
{
...
java_util_Iterator *  android_content_IntentFilter::pathsIterator()
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<android_os_PatternMatcher>);				
...
int android_content_IntentFilter::matchDataAuthority(android_net_Uri& arg0)
{
...
int android_content_IntentFilter::matchData(java_lang_String& arg0,android_net_Uri& arg1)
{
	const char *methodName = "matchData";
	const char *methodSignature = "(Ljava/lang/String;Landroid/net/Uri;)I";
	const char *className = "android_content_IntentFilter";
...
java_lang_String *  android_content_IntentFilter::getCategory(int& arg0)
{
...
java_util_Iterator *  android_content_IntentFilter::categoriesIterator()
{
...
java_lang_String *  android_content_IntentFilter::matchCategories(java_util_Set& arg0)
{
...
void android_content_IntentFilter::writeToXml(org_xmlpull_v1_XmlSerializer& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<org_xmlpull_v1_XmlSerializer>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_content_IntentFilter::readFromXml(org_xmlpull_v1_XmlPullParser& arg0)
{
