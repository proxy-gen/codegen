...
// Functions
bool android_widget_ExpandableListView_OnGroupClickListener::onGroupClick(android_widget_ExpandableListView& arg0,android_view_View& arg1,int& arg2,long& arg3)
{
	const char *methodName = "onGroupClick";
	const char *methodSignature = "(Landroid/widget/ExpandableListView;Landroid/view/View;IJ)Z";
	const char *className = "android_widget_ExpandableListView_OnGroupClickListener";
