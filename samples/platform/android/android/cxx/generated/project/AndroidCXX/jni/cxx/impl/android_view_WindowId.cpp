...
{	
	...
	LOGV("android_view_WindowId cxx address %d", cxxAddress);
	long proxiedComponent = (long) ctx->findProxyComponent(cxxAddress);
	LOGV("android_view_WindowId jni address %d", proxiedComponent);
...
bool android_view_WindowId::equals(AndroidCXX::java_lang_Object const& arg0)
{
	...
	LOGV("android_view_WindowId jni address %d", javaObject);
