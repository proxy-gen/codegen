...
// Functions
int android_view_KeyCharacterMap::get(int& arg0)
{
	const char *methodName = "get";
	const char *methodSignature = "(I)I";
	const char *className = "android_view_KeyCharacterMap";
...
android_view_KeyCharacterMap *  android_view_KeyCharacterMap::load(int& arg0)
{
...
void android_view_KeyCharacterMap::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
...
int android_view_KeyCharacterMap::getDeadChar(int& arg0)
{
...
bool android_view_KeyCharacterMap::getKeyData(int& arg0,android_view_KeyCharacterMap_KeyData& arg1)
{
...
std::vector<long> android_view_KeyCharacterMap::getEvents(std::vector<char>& arg0)
{
	const char *methodName = "getEvents";
	const char *methodSignature = "([[C)[android/view/KeyEvent";
	const char *className = "android_view_KeyCharacterMap";
	...
	long java_value = convert_jni__object_array_type_to_java(jni_result);
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<android_view_KeyEvent>);				
