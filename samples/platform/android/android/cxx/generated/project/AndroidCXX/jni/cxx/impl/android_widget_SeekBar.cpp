...
template void convert_proxy<android_widget_SeekBar_OnSeekBarChangeListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
android_widget_SeekBar::android_widget_SeekBar(const android_widget_SeekBar& cc)
{
	LOGV("android_widget_SeekBar::android_widget_SeekBar(const android_widget_SeekBar& cc) invoked");
...
{
	LOGV("android_widget_SeekBar::android_widget_SeekBar(void * proxy) invoked");
...
{
	LOGV("android_widget_SeekBar::~android_widget_SeekBar() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
void android_widget_SeekBar::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
	const char *methodName = "onInitializeAccessibilityEvent";
	const char *methodSignature = "(Landroid/view/accessibility/AccessibilityEvent;)V";
	const char *className = "android_widget_SeekBar";
	...
	LOGV("android_widget_SeekBar jni address %d", javaObject);
...
void android_widget_SeekBar::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
void android_widget_SeekBar::setOnSeekBarChangeListener(android_widget_SeekBar_OnSeekBarChangeListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.widget.SeekBar$OnSeekBarChangeListener");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_SeekBar_OnSeekBarChangeListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
