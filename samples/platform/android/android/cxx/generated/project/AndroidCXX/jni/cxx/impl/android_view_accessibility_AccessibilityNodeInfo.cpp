...
{
	LOGV("android_view_accessibility_AccessibilityNodeInfo::android_view_accessibility_AccessibilityNodeInfo(const android_view_accessibility_AccessibilityNodeInfo& cc) invoked");
...
{
	LOGV("android_view_accessibility_AccessibilityNodeInfo::android_view_accessibility_AccessibilityNodeInfo(void * proxy) invoked");
...
{
	LOGV("android_view_accessibility_AccessibilityNodeInfo::~android_view_accessibility_AccessibilityNodeInfo() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
