...
template void convert_proxy<android_widget_AbsListView_LayoutParams>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_widget_ListAdapter>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_widget_AbsListView_MultiChoiceModeListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_widget_AbsListView_OnScrollListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
android_os_Parcelable *  android_widget_AbsListView::onSaveInstanceState()
{
	...
	const char *className = "android_widget_AbsListView";
...
bool android_widget_AbsListView::onKeyDown(int& arg0,android_view_KeyEvent& arg1)
{
...
void android_widget_AbsListView::onRestoreInstanceState(android_os_Parcelable& arg0)
{
...
bool android_widget_AbsListView::onKeyUp(int& arg0,android_view_KeyEvent& arg1)
{
...
bool android_widget_AbsListView::onTouchEvent(android_view_MotionEvent& arg0)
{
...
bool android_widget_AbsListView::onGenericMotionEvent(android_view_MotionEvent& arg0)
{
...
android_graphics_drawable_Drawable *  android_widget_AbsListView::getSelector()
{
...
void android_widget_AbsListView::setSelector(android_graphics_drawable_Drawable& arg0,int& arg1)
{
	const char *methodName = "setSelector";
	const char *methodSignature = "(Landroid/graphics/drawable/Drawable;I)V";
	const char *className = "android_widget_AbsListView";
...
bool android_widget_AbsListView::showContextMenuForChild(android_view_View& arg0)
{
...
void android_widget_AbsListView::addTouchables(java_util_ArrayList& arg0)
{
...
bool android_widget_AbsListView::onInterceptTouchEvent(android_view_MotionEvent& arg0)
{
...
android_widget_AbsListView_LayoutParams *  android_widget_AbsListView::generateLayoutParams(android_util_AttributeSet& arg0)
{
	...
	android_widget_AbsListView_LayoutParams *  result;
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_widget_AbsListView_LayoutParams>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_widget_AbsListView_LayoutParams * ) (*((android_widget_AbsListView_LayoutParams *  *) cxx_value));
...
void android_widget_AbsListView::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_AbsListView::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
bool android_widget_AbsListView::performAccessibilityAction(int& arg0,android_os_Bundle& arg1)
{
...
android_view_inputmethod_InputConnection *  android_widget_AbsListView::onCreateInputConnection(android_view_inputmethod_EditorInfo& arg0)
{
...
bool android_widget_AbsListView::checkInputConnectionProxy(android_view_View& arg0)
{
...
void android_widget_AbsListView::getFocusedRect(android_graphics_Rect& arg0)
{
...
void android_widget_AbsListView::draw(android_graphics_Canvas& arg0)
{
...
bool android_widget_AbsListView::verifyDrawable(android_graphics_drawable_Drawable& arg0)
{
...
void android_widget_AbsListView::setAdapter(android_widget_ListAdapter& arg0)
{
...
android_util_SparseBooleanArray *  android_widget_AbsListView::getCheckedItemPositions()
{
...
bool android_widget_AbsListView::performItemClick(android_view_View& arg0,int& arg1,long& arg2)
{
...
void android_widget_AbsListView::setMultiChoiceModeListener(android_widget_AbsListView_MultiChoiceModeListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_AbsListView_MultiChoiceModeListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_widget_AbsListView::setOnScrollListener(android_widget_AbsListView_OnScrollListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_AbsListView_OnScrollListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_widget_AbsListView::setFilterText(java_lang_String& arg0)
{
...
java_lang_CharSequence *  android_widget_AbsListView::getTextFilter()
{
...
android_view_View *  android_widget_AbsListView::getSelectedView()
{
...
void android_widget_AbsListView::setScrollIndicators(android_view_View& arg0)
{
...
int android_widget_AbsListView::pointToPosition(int& arg0)
{
...
long android_widget_AbsListView::pointToRowId(int& arg0)
{
...
void android_widget_AbsListView::smoothScrollToPositionFromTop(int& arg0)
{
...
void android_widget_AbsListView::smoothScrollBy(int& arg0)
{
...
void android_widget_AbsListView::beforeTextChanged(java_lang_CharSequence& arg0,int& arg1)
{
...
void android_widget_AbsListView::onTextChanged(java_lang_CharSequence& arg0,int& arg1)
{
...
void android_widget_AbsListView::afterTextChanged(android_text_Editable& arg0)
{
...
void android_widget_AbsListView::reclaimViews(java_util_List& arg0)
{
...
void android_widget_AbsListView::setRemoteViewsAdapter(android_content_Intent& arg0)
{
...
void android_widget_AbsListView::setRecyclerListener(android_widget_AbsListView_RecyclerListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_AbsListView_RecyclerListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
