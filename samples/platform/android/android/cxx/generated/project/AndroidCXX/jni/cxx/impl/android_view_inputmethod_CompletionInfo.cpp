...
{
	LOGV("android_view_inputmethod_CompletionInfo::android_view_inputmethod_CompletionInfo(const android_view_inputmethod_CompletionInfo& cc) invoked");
...
{
	LOGV("android_view_inputmethod_CompletionInfo::android_view_inputmethod_CompletionInfo(void * proxy) invoked");
...
{
	LOGV("android_view_inputmethod_CompletionInfo::~android_view_inputmethod_CompletionInfo() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
