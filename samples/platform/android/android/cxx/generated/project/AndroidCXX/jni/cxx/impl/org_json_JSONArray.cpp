...
{
	LOGV("org_json_JSONArray::org_json_JSONArray(const org_json_JSONArray& cc) invoked");
...
{
	LOGV("org_json_JSONArray::org_json_JSONArray(void * proxy) invoked");
...
{
	LOGV("org_json_JSONArray::~org_json_JSONArray() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
