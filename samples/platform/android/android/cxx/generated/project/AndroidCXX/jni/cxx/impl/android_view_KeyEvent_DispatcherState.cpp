...
{
	LOGV("android_view_KeyEvent_DispatcherState::android_view_KeyEvent_DispatcherState(const android_view_KeyEvent_DispatcherState& cc) invoked");
...
{
	LOGV("android_view_KeyEvent_DispatcherState::android_view_KeyEvent_DispatcherState(void * proxy) invoked");
...
{
	LOGV("android_view_KeyEvent_DispatcherState::~android_view_KeyEvent_DispatcherState() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
void android_view_KeyEvent_DispatcherState::reset(java_lang_Object& arg0)
{
	const char *methodName = "reset";
	const char *methodSignature = "(Ljava/lang/Object;)V";
	const char *className = "android_view_KeyEvent_DispatcherState";
...
void android_view_KeyEvent_DispatcherState::startTracking(android_view_KeyEvent& arg0,java_lang_Object& arg1)
{
...
bool android_view_KeyEvent_DispatcherState::isTracking(android_view_KeyEvent& arg0)
{
...
void android_view_KeyEvent_DispatcherState::performedLongPress(android_view_KeyEvent& arg0)
{
...
void android_view_KeyEvent_DispatcherState::handleUpEvent(android_view_KeyEvent& arg0)
{
