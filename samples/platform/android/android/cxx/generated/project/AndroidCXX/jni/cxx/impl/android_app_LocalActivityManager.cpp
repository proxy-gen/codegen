...
{
	LOGV("android_app_LocalActivityManager::android_app_LocalActivityManager(const android_app_LocalActivityManager& cc) invoked");
...
{
	LOGV("android_app_LocalActivityManager::android_app_LocalActivityManager(void * proxy) invoked");
...
{
	LOGV("android_app_LocalActivityManager::~android_app_LocalActivityManager() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
