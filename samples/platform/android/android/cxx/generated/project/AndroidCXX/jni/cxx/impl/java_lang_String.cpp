...
{
	LOGV("java_lang_String::java_lang_String(const java_lang_String& cc) invoked");
...
{
	LOGV("java_lang_String::java_lang_String(void * proxy) invoked");
...
{
	LOGV("java_lang_String::~java_lang_String() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
int java_lang_String::indexOf(int& arg0,java_lang_String& arg1)
{
...
java_lang_String *  java_lang_String::valueOf(java_lang_Object& arg0,double& arg1,float& arg2,long& arg3,int& arg4,char& arg5,bool& arg6,std::vector<char>& arg7)
{
	const char *methodName = "valueOf";
	const char *methodSignature = "(Ljava/lang/Object;DFJICZ[[C)Ljava/lang/String;";
	const char *className = "java_lang_String";
	...
	jchar jarg5;
	{
		...
		// Convert to JNI
		jarg5 = convert_jni_char_to_jni(java_value);
	}
	jboolean jarg6;
	{
...
int java_lang_String::codePointCount(int& arg0)
{
...
int java_lang_String::offsetByCodePoints(int& arg0)
{
...
void java_lang_String::getChars(int& arg0,std::vector<char>& arg1)
{
	const char *methodName = "getChars";
	const char *methodSignature = "(I[[C)V";
	const char *className = "java_lang_String";
...
std::vector<char> java_lang_String::getBytes(java_lang_String& arg0,int& arg1,std::vector<char>& arg2,java_nio_charset_Charset& arg3)
{
	const char *methodName = "getBytes";
	const char *methodSignature = "(Ljava/lang/String;I[[BLjava/nio/charset/Charset;)[[B";
	const char *className = "java_lang_String";
	...
	jbyteArray jni_result = (jbyteArray) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature,jarg0,jarg1,jarg2,jarg3);
	long cxx_value = (long) 0;
...
bool java_lang_String::contentEquals(java_lang_StringBuffer& arg0,java_lang_CharSequence& arg1)
{
	const char *methodName = "contentEquals";
	const char *methodSignature = "(Ljava/lang/StringBuffer;Ljava/lang/CharSequence;)Z";
	const char *className = "java_lang_String";
...
bool java_lang_String::regionMatches(int& arg0,java_lang_String& arg1,bool& arg2)
{
	const char *methodName = "regionMatches";
	const char *methodSignature = "(ILjava/lang/String;Z)Z";
	const char *className = "java_lang_String";
...
java_lang_CharSequence *  java_lang_String::subSequence(int& arg0)
{
...
java_lang_String *  java_lang_String::replace(java_lang_CharSequence& arg0,char& arg1)
{
	const char *methodName = "replace";
	const char *methodSignature = "(Ljava/lang/CharSequence;C)Ljava/lang/String;";
	const char *className = "java_lang_String";
...
java_lang_String *  java_lang_String::replaceFirst(java_lang_String& arg0)
{
...
java_lang_String *  java_lang_String::replaceAll(java_lang_String& arg0)
{
...
std::vector<long> java_lang_String::split(java_lang_String& arg0,int& arg1)
{
...
java_lang_String *  java_lang_String::format(java_lang_String& arg0,std::vector<long>& arg1,java_util_Locale& arg2)
{
	const char *methodName = "format";
	const char *methodSignature = "(Ljava/lang/String;[java/lang/ObjectLjava/util/Locale;)Ljava/lang/String;";
	const char *className = "java_lang_String";
...
java_lang_String *  java_lang_String::copyValueOf(std::vector<char>& arg0,int& arg1)
{
	const char *methodName = "copyValueOf";
	const char *methodSignature = "([[CI)Ljava/lang/String;";
	const char *className = "java_lang_String";
