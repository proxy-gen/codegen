...
bool android_view_MenuItem_OnActionExpandListener::onMenuItemActionExpand(AndroidCXX::android_view_MenuItem const& arg0)
{
	...
	LOGV("android_view_MenuItem_OnActionExpandListener className %s methodName %s methodSignature %s", className, methodName, methodSignature);
	...
	LOGV("android_view_MenuItem_OnActionExpandListener jni address %d", javaObject);
