...
// Functions
AndroidCXX::android_view_Display android_view_WindowManager::getDefaultDisplay()
{
	LOGV("AndroidCXX::android_view_Display android_view_WindowManager::getDefaultDisplay() enter");

	const char *methodName = "getDefaultDisplay";
	...
	LOGV("android_view_WindowManager jni address %d", javaObject);
