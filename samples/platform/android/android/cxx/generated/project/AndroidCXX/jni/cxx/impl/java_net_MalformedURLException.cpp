...
#define LOG_TAG "java_net_MalformedURLException"
...
java_net_MalformedURLException::java_net_MalformedURLException()
{
	...
	const char *className = "java/net/MalformedURLException";

	LOGV("java_net_MalformedURLException className %d methodName %s methodSignature %s", className, methodName, methodSignature);
