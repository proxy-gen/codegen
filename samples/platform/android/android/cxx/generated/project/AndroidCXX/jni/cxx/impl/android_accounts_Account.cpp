...
#define LOG_TAG "android_accounts_Account"
...
{
	LOGV("android_accounts_Account::android_accounts_Account(const android_accounts_Account& cc) invoked");
...
{
	LOGV("android_accounts_Account::android_accounts_Account(void * proxy) invoked");
...
{
	LOGV("android_accounts_Account::~android_accounts_Account() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
bool android_accounts_Account::equals(java_lang_Object& arg0)
{
	const char *methodName = "equals";
	const char *methodSignature = "(Ljava/lang/Object;)Z";
	const char *className = "android_accounts_Account";
	...
	LOGV("android_accounts_Account jni address %d", javaObject);
...
java_lang_String *  android_accounts_Account::toString()
{
...
int android_accounts_Account::hashCode()
{
...
int android_accounts_Account::describeContents()
{
...
void android_accounts_Account::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
