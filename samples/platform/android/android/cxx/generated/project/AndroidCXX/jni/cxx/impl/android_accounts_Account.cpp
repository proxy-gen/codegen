...
android_accounts_Account::android_accounts_Account(AndroidCXX::java_lang_String const& arg0,AndroidCXX::java_lang_String const& arg1)
{
	...
	LOGV("android_accounts_Account className %s methodName %s methodSignature %s", className, methodName, methodSignature);
...
AndroidCXX::java_lang_String android_accounts_Account::toString()
{
	LOGV("AndroidCXX::java_lang_String android_accounts_Account::toString() enter");
...
{
	LOGV("int android_accounts_Account::hashCode() enter");
...
{
	LOGV("int android_accounts_Account::describeContents() enter");
