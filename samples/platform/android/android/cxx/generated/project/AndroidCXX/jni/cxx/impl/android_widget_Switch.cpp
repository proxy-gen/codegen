...
{
	LOGV("android_widget_Switch::android_widget_Switch(const android_widget_Switch& cc) invoked");
...
{
	LOGV("android_widget_Switch::android_widget_Switch(void * proxy) invoked");
...
{
	LOGV("android_widget_Switch::~android_widget_Switch() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
bool android_widget_Switch::onTouchEvent(android_view_MotionEvent& arg0)
{
	const char *methodName = "onTouchEvent";
	const char *methodSignature = "(Landroid/view/MotionEvent;)Z";
	const char *className = "android_widget_Switch";
...
void android_widget_Switch::onPopulateAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_Switch::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_Switch::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
void android_widget_Switch::onMeasure(int& arg0)
{
...
void android_widget_Switch::setSwitchTextAppearance(android_content_Context& arg0,int& arg1)
{
...
void android_widget_Switch::setSwitchTypeface(android_graphics_Typeface& arg0,int& arg1)
{
...
void android_widget_Switch::setTrackDrawable(android_graphics_drawable_Drawable& arg0)
{
...
android_graphics_drawable_Drawable *  android_widget_Switch::getTrackDrawable()
{
...
void android_widget_Switch::setThumbDrawable(android_graphics_drawable_Drawable& arg0)
{
...
android_graphics_drawable_Drawable *  android_widget_Switch::getThumbDrawable()
{
...
java_lang_CharSequence *  android_widget_Switch::getTextOn()
{
...
void android_widget_Switch::setTextOn(java_lang_CharSequence& arg0)
{
...
java_lang_CharSequence *  android_widget_Switch::getTextOff()
{
...
void android_widget_Switch::setTextOff(java_lang_CharSequence& arg0)
{
