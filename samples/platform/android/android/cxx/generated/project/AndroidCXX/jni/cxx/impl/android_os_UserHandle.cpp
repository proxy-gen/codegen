...
{
	LOGV("android_os_UserHandle::android_os_UserHandle(const android_os_UserHandle& cc) invoked");
...
{
	LOGV("android_os_UserHandle::android_os_UserHandle(void * proxy) invoked");
...
{
	LOGV("android_os_UserHandle::~android_os_UserHandle() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
bool android_os_UserHandle::equals(java_lang_Object& arg0)
{
	const char *methodName = "equals";
	const char *methodSignature = "(Ljava/lang/Object;)Z";
	const char *className = "android_os_UserHandle";
...
java_lang_String *  android_os_UserHandle::toString()
{
...
void android_os_UserHandle::writeToParcel(android_os_Parcel& arg0,int& arg1,android_os_UserHandle& arg2)
{
	const char *methodName = "writeToParcel";
	const char *methodSignature = "(Landroid/os/Parcel;ILandroid/os/UserHandle;)V";
	const char *className = "android_os_UserHandle";
...
android_os_UserHandle *  android_os_UserHandle::readFromParcel(android_os_Parcel& arg0)
{
