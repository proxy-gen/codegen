...
android_widget_QuickContactBadge::android_widget_QuickContactBadge(AndroidCXX::android_content_Context const& arg0)
{
	...
	LOGV("android_widget_QuickContactBadge className %s methodName %s methodSignature %s", className, methodName, methodSignature);
...
void android_widget_QuickContactBadge::setMode(int const& arg0)
{
	...
	LOGV("android_widget_QuickContactBadge jni address %d", javaObject);
...
{
	LOGV("void android_widget_QuickContactBadge::setImageToDefault() enter");

	const char *methodName = "setImageToDefault";
...
void android_widget_QuickContactBadge::assignContactFromEmail(AndroidCXX::java_lang_String const& arg0,bool const& arg1,AndroidCXX::android_os_Bundle const& arg2)
{
	LOGV("void android_widget_QuickContactBadge::assignContactFromEmail(AndroidCXX::java_lang_String const& arg0,bool const& arg1,AndroidCXX::android_os_Bundle const& arg2) enter");
	...
	LOGV("void android_widget_QuickContactBadge::assignContactFromEmail(AndroidCXX::java_lang_String const& arg0,bool const& arg1,AndroidCXX::android_os_Bundle const& arg2) exit");

}
void android_widget_QuickContactBadge::assignContactFromPhone(AndroidCXX::java_lang_String const& arg0,bool const& arg1,AndroidCXX::android_os_Bundle const& arg2)
{
	LOGV("void android_widget_QuickContactBadge::assignContactFromPhone(AndroidCXX::java_lang_String const& arg0,bool const& arg1,AndroidCXX::android_os_Bundle const& arg2) enter");
	...
	LOGV("void android_widget_QuickContactBadge::assignContactFromPhone(AndroidCXX::java_lang_String const& arg0,bool const& arg1,AndroidCXX::android_os_Bundle const& arg2) exit");
