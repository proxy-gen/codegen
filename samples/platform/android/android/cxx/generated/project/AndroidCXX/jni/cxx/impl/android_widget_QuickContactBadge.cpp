...
{
	LOGV("android_widget_QuickContactBadge::android_widget_QuickContactBadge(const android_widget_QuickContactBadge& cc) invoked");
...
{
	LOGV("android_widget_QuickContactBadge::android_widget_QuickContactBadge(void * proxy) invoked");
...
{
	LOGV("android_widget_QuickContactBadge::~android_widget_QuickContactBadge() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
