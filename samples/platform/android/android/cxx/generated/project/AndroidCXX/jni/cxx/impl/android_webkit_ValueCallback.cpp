...
android_webkit_ValueCallback::android_webkit_ValueCallback(void * proxy)
{
	LOGV("android_webkit_ValueCallback::android_webkit_ValueCallback(void * proxy) enter");
...
// Functions
void android_webkit_ValueCallback::onReceiveValue(AndroidCXX::java_lang_Object& arg0)
{
	LOGV("void android_webkit_ValueCallback::onReceiveValue(AndroidCXX::java_lang_Object& arg0) enter");
	...
	LOGV("void android_webkit_ValueCallback::onReceiveValue(AndroidCXX::java_lang_Object& arg0) exit");
