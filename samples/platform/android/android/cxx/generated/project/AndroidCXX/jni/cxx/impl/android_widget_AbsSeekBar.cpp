...
android_widget_AbsSeekBar::android_widget_AbsSeekBar(AndroidCXX::android_content_Context const& arg0)
{
	...
	LOGV("android_widget_AbsSeekBar className %s methodName %s methodSignature %s", className, methodName, methodSignature);
...
{
	LOGV("void android_widget_AbsSeekBar::jumpDrawablesToCurrentState() enter");
...
{
	LOGV("AndroidCXX::android_graphics_drawable_Drawable android_widget_AbsSeekBar::getThumb() enter");
...
{
	LOGV("int android_widget_AbsSeekBar::getThumbOffset() enter");
...
{
	LOGV("int android_widget_AbsSeekBar::getKeyProgressIncrement() enter");
