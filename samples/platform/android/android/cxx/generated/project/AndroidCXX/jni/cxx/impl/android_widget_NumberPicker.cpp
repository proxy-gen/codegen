...
{
	LOGV("int android_widget_NumberPicker::getValue() enter");
...
{
	LOGV("AndroidCXX::android_view_accessibility_AccessibilityNodeProvider android_widget_NumberPicker::getAccessibilityNodeProvider() enter");
...
{
	LOGV("void android_widget_NumberPicker::computeScroll() enter");
...
{
	LOGV("int android_widget_NumberPicker::getSolidColor() enter");
...
void android_widget_NumberPicker::setOnScrollListener(AndroidCXX::android_widget_NumberPicker_OnScrollListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_android_widget_NumberPicker_OnScrollListener(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_widget_NumberPicker::setOnValueChangedListener(AndroidCXX::android_widget_NumberPicker_OnValueChangeListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_android_widget_NumberPicker_OnValueChangeListener(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_widget_NumberPicker::setFormatter(AndroidCXX::android_widget_NumberPicker_Formatter& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_android_widget_NumberPicker_Formatter(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
{
	LOGV("bool android_widget_NumberPicker::getWrapSelectorWheel() enter");
...
{
	LOGV("int android_widget_NumberPicker::getMinValue() enter");
...
{
	LOGV("int android_widget_NumberPicker::getMaxValue() enter");
