...
template void convert_proxy<android_view_SurfaceHolder>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_media_MediaPlayer>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_media_MediaPlayer_OnPreparedListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_media_MediaPlayer_OnCompletionListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_media_MediaPlayer_OnErrorListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_media_MediaPlayer_OnInfoListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_media_MediaPlayer_OnBufferingUpdateListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_media_MediaPlayer_OnSeekCompleteListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_media_MediaPlayer_OnVideoSizeChangedListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_media_MediaPlayer_OnTimedTextListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
void android_media_MediaPlayer::start()
{
	...
	const char *className = "android_media_MediaPlayer";
...
android_media_MediaPlayer *  android_media_MediaPlayer::create(android_content_Context& arg0,int& arg1,android_net_Uri& arg2,android_view_SurfaceHolder& arg3)
{
	const char *methodName = "create";
	const char *methodSignature = "(Landroid/content/Context;ILandroid/net/Uri;Landroid/view/SurfaceHolder;)Landroid/media/MediaPlayer;";
	const char *className = "android_media_MediaPlayer";
	...
	jobject jarg3;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_view_SurfaceHolder>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);

		// Convert to JNI
		jarg3 = convert_jni_java_lang_Object_to_jni(java_value);
	}

	android_media_MediaPlayer *  result;
	...
	result = (android_media_MediaPlayer * ) (*((android_media_MediaPlayer *  *) cxx_value));
...
void android_media_MediaPlayer::setOnPreparedListener(android_media_MediaPlayer_OnPreparedListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_media_MediaPlayer_OnPreparedListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_media_MediaPlayer::setOnCompletionListener(android_media_MediaPlayer_OnCompletionListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_media_MediaPlayer_OnCompletionListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_media_MediaPlayer::setOnErrorListener(android_media_MediaPlayer_OnErrorListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_media_MediaPlayer_OnErrorListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_media_MediaPlayer::setOnInfoListener(android_media_MediaPlayer_OnInfoListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_media_MediaPlayer_OnInfoListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_media_MediaPlayer::setDisplay(android_view_SurfaceHolder& arg0)
{
...
void android_media_MediaPlayer::setSurface(android_view_Surface& arg0)
{
...
void android_media_MediaPlayer::setDataSource(android_content_Context& arg0,android_net_Uri& arg1,java_io_FileDescriptor& arg2,java_lang_String& arg3,java_util_Map& arg4,long& arg5)
{
	const char *methodName = "setDataSource";
	const char *methodSignature = "(Landroid/content/Context;Landroid/net/Uri;Ljava/io/FileDescriptor;Ljava/lang/String;Ljava/util/Map;J)V";
	const char *className = "android_media_MediaPlayer";
...
void android_media_MediaPlayer::setWakeMode(android_content_Context& arg0,int& arg1)
{
...
void android_media_MediaPlayer::setNextMediaPlayer(android_media_MediaPlayer& arg0)
{
...
void android_media_MediaPlayer::setVolume(float& arg0)
{
...
std::vector<long> android_media_MediaPlayer::getTrackInfo()
{
	const char *methodName = "getTrackInfo";
	const char *methodSignature = "()[android/media/MediaPlayer$TrackInfo";
	const char *className = "android_media_MediaPlayer";
	...
	long java_value = convert_jni__object_array_type_to_java(jni_result);
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<android_media_MediaPlayer_TrackInfo>);				
...
void android_media_MediaPlayer::addTimedTextSource(java_io_FileDescriptor& arg0,java_lang_String& arg1,android_content_Context& arg2,android_net_Uri& arg3,long& arg4)
{
	const char *methodName = "addTimedTextSource";
	const char *methodSignature = "(Ljava/io/FileDescriptor;Ljava/lang/String;Landroid/content/Context;Landroid/net/Uri;J)V";
	const char *className = "android_media_MediaPlayer";
...
void android_media_MediaPlayer::setOnBufferingUpdateListener(android_media_MediaPlayer_OnBufferingUpdateListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_media_MediaPlayer_OnBufferingUpdateListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_media_MediaPlayer::setOnSeekCompleteListener(android_media_MediaPlayer_OnSeekCompleteListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_media_MediaPlayer_OnSeekCompleteListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_media_MediaPlayer::setOnVideoSizeChangedListener(android_media_MediaPlayer_OnVideoSizeChangedListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_media_MediaPlayer_OnVideoSizeChangedListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_media_MediaPlayer::setOnTimedTextListener(android_media_MediaPlayer_OnTimedTextListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_media_MediaPlayer_OnTimedTextListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
