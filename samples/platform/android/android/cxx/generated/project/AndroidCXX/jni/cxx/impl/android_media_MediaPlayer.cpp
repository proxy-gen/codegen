...
{
	LOGV("android_media_MediaPlayer::android_media_MediaPlayer(const android_media_MediaPlayer& cc) invoked");
...
{
	LOGV("android_media_MediaPlayer::android_media_MediaPlayer(void * proxy) invoked");
...
{
	LOGV("android_media_MediaPlayer::~android_media_MediaPlayer() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
