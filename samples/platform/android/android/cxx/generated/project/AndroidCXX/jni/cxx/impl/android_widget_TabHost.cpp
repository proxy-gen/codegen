...
template void convert_proxy<android_app_LocalActivityManager>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_widget_TabHost_TabSpec>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_widget_TabWidget>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_widget_FrameLayout>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_widget_TabHost_OnTabChangeListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
android_widget_TabHost::android_widget_TabHost(const android_widget_TabHost& cc)
{
	LOGV("android_widget_TabHost::android_widget_TabHost(const android_widget_TabHost& cc) invoked");
...
{
	LOGV("android_widget_TabHost::android_widget_TabHost(void * proxy) invoked");
...
{
	LOGV("android_widget_TabHost::~android_widget_TabHost() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
void android_widget_TabHost::setup(android_app_LocalActivityManager& arg0)
{
	const char *methodName = "setup";
	const char *methodSignature = "(Landroid/app/LocalActivityManager;)V";
	const char *className = "android_widget_TabHost";
	...
	jobject jarg0;
	{
		...
		convert_proxy<android_app_LocalActivityManager>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
bool android_widget_TabHost::dispatchKeyEvent(android_view_KeyEvent& arg0)
{
...
void android_widget_TabHost::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_TabHost::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
void android_widget_TabHost::addTab(android_widget_TabHost_TabSpec& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_TabHost_TabSpec>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
android_view_View *  android_widget_TabHost::getCurrentView()
{
...
android_widget_TabHost_TabSpec *  android_widget_TabHost::newTabSpec(java_lang_String& arg0)
{
	...
	android_widget_TabHost_TabSpec *  result;
	...
	result = (android_widget_TabHost_TabSpec * ) (*((android_widget_TabHost_TabSpec *  *) cxx_value));
...
android_widget_TabWidget *  android_widget_TabHost::getTabWidget()
{
	...
	android_widget_TabWidget *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_widget_TabWidget>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_widget_TabWidget * ) (*((android_widget_TabWidget *  *) cxx_value));
...
java_lang_String *  android_widget_TabHost::getCurrentTabTag()
{
...
android_view_View *  android_widget_TabHost::getCurrentTabView()
{
...
void android_widget_TabHost::setCurrentTabByTag(java_lang_String& arg0)
{
...
android_widget_FrameLayout *  android_widget_TabHost::getTabContentView()
{
	...
	android_widget_FrameLayout *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_widget_FrameLayout>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_widget_FrameLayout * ) (*((android_widget_FrameLayout *  *) cxx_value));
...
void android_widget_TabHost::setOnTabChangedListener(android_widget_TabHost_OnTabChangeListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_TabHost_OnTabChangeListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
