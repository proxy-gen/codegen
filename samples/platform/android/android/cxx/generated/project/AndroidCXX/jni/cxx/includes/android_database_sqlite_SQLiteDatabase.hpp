...
public:
	...
	// Functions
	 ...
	 int _delete(AndroidCXX::java_lang_String& arg0,AndroidCXX::java_lang_String& arg1,std::vector<java_lang_String >& arg2);
	 ...
	 AndroidCXX::android_database_Cursor query(bool& arg0,AndroidCXX::java_lang_String& arg1,std::vector<java_lang_String >& arg2,AndroidCXX::java_lang_String& arg3,std::vector<java_lang_String >& arg4,AndroidCXX::java_lang_String& arg5,AndroidCXX::java_lang_String& arg6,AndroidCXX::java_lang_String& arg7,AndroidCXX::java_lang_String& arg8);
	 AndroidCXX::android_database_Cursor query(AndroidCXX::java_lang_String& arg0,std::vector<java_lang_String >& arg1,AndroidCXX::java_lang_String& arg2,std::vector<java_lang_String >& arg3,AndroidCXX::java_lang_String& arg4,AndroidCXX::java_lang_String& arg5,AndroidCXX::java_lang_String& arg6,AndroidCXX::java_lang_String& arg7);
	 AndroidCXX::android_database_Cursor query(AndroidCXX::java_lang_String& arg0,std::vector<java_lang_String >& arg1,AndroidCXX::java_lang_String& arg2,std::vector<java_lang_String >& arg3,AndroidCXX::java_lang_String& arg4,AndroidCXX::java_lang_String& arg5,AndroidCXX::java_lang_String& arg6);
	...
	static AndroidCXX::android_database_sqlite_SQLiteDatabase create(AndroidCXX::android_database_sqlite_SQLiteDatabase_CursorFactory& arg0);
	 bool isOpen();
	 int update(AndroidCXX::java_lang_String& arg0,AndroidCXX::android_content_ContentValues& arg1,AndroidCXX::java_lang_String& arg2,std::vector<java_lang_String >& arg3);
	 int getVersion();
	...
	static AndroidCXX::java_lang_String findEditTable(AndroidCXX::java_lang_String& arg0);
	 ...
	 AndroidCXX::android_database_Cursor rawQuery(AndroidCXX::java_lang_String& arg0,std::vector<java_lang_String >& arg1,AndroidCXX::android_os_CancellationSignal& arg2);
	 AndroidCXX::android_database_Cursor rawQuery(AndroidCXX::java_lang_String& arg0,std::vector<java_lang_String >& arg1);
	 AndroidCXX::android_database_Cursor rawQueryWithFactory(AndroidCXX::android_database_sqlite_SQLiteDatabase_CursorFactory& arg0,AndroidCXX::java_lang_String& arg1,std::vector<java_lang_String >& arg2,AndroidCXX::java_lang_String& arg3);
	 AndroidCXX::android_database_Cursor rawQueryWithFactory(AndroidCXX::android_database_sqlite_SQLiteDatabase_CursorFactory& arg0,AndroidCXX::java_lang_String& arg1,std::vector<java_lang_String >& arg2,AndroidCXX::java_lang_String& arg3,AndroidCXX::android_os_CancellationSignal& arg4);
	 ...
	 int updateWithOnConflict(AndroidCXX::java_lang_String& arg0,AndroidCXX::android_content_ContentValues& arg1,AndroidCXX::java_lang_String& arg2,std::vector<java_lang_String >& arg3,int& arg4);
	 void execSQL(AndroidCXX::java_lang_String& arg0,std::vector<java_lang_Object >& arg1);
