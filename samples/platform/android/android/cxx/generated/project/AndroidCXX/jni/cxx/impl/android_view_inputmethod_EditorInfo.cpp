...
{
	LOGV("android_view_inputmethod_EditorInfo::android_view_inputmethod_EditorInfo(const android_view_inputmethod_EditorInfo& cc) invoked");
...
{
	LOGV("android_view_inputmethod_EditorInfo::android_view_inputmethod_EditorInfo(void * proxy) invoked");
...
{
	LOGV("android_view_inputmethod_EditorInfo::~android_view_inputmethod_EditorInfo() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
void android_view_inputmethod_EditorInfo::dump(android_util_Printer& arg0,java_lang_String& arg1)
{
	const char *methodName = "dump";
	const char *methodSignature = "(Landroid/util/Printer;Ljava/lang/String;)V";
	const char *className = "android_view_inputmethod_EditorInfo";
...
void android_view_inputmethod_EditorInfo::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
