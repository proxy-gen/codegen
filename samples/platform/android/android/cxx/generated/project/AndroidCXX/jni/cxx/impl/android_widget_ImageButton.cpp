...
{
	LOGV("android_widget_ImageButton::android_widget_ImageButton(const android_widget_ImageButton& cc) invoked");
...
{
	LOGV("android_widget_ImageButton::android_widget_ImageButton(void * proxy) invoked");
...
{
	LOGV("android_widget_ImageButton::~android_widget_ImageButton() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
