...
java_nio_CharBuffer *  java_nio_CharBuffer::get(std::vector<char>& arg0,int& arg1)
{
	const char *methodName = "get";
	const char *methodSignature = "([[CI)Ljava/nio/CharBuffer;";
	const char *className = "java_nio_CharBuffer";
...
java_nio_CharBuffer *  java_nio_CharBuffer::put(int& arg0,char& arg1,java_lang_String& arg2,std::vector<char>& arg3,java_nio_CharBuffer& arg4)
{
	const char *methodName = "put";
	const char *methodSignature = "(ICLjava/lang/String;[[CLjava/nio/CharBuffer;)Ljava/nio/CharBuffer;";
	const char *className = "java_nio_CharBuffer";
...
java_nio_CharBuffer *  java_nio_CharBuffer::append(java_lang_CharSequence& arg0,int& arg1,char& arg2)
{
	const char *methodName = "append";
	const char *methodSignature = "(Ljava/lang/CharSequence;IC)Ljava/nio/CharBuffer;";
	const char *className = "java_nio_CharBuffer";
...
java_lang_CharSequence *  java_nio_CharBuffer::subSequence(int& arg0)
{
...
java_nio_CharBuffer *  java_nio_CharBuffer::wrap(java_lang_CharSequence& arg0,int& arg1,std::vector<char>& arg2)
{
	const char *methodName = "wrap";
	const char *methodSignature = "(Ljava/lang/CharSequence;I[[C)Ljava/nio/CharBuffer;";
	const char *className = "java_nio_CharBuffer";
