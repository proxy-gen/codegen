...
{
	LOGV("android_net_http_SslCertificate_DName::android_net_http_SslCertificate_DName(const android_net_http_SslCertificate_DName& cc) invoked");
...
{
	LOGV("android_net_http_SslCertificate_DName::android_net_http_SslCertificate_DName(void * proxy) invoked");
...
{
	LOGV("android_net_http_SslCertificate_DName::~android_net_http_SslCertificate_DName() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
