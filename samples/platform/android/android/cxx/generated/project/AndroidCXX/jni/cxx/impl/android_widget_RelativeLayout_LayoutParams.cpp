...
{
	LOGV("android_widget_RelativeLayout_LayoutParams::android_widget_RelativeLayout_LayoutParams(const android_widget_RelativeLayout_LayoutParams& cc) invoked");
...
{
	LOGV("android_widget_RelativeLayout_LayoutParams::android_widget_RelativeLayout_LayoutParams(void * proxy) invoked");
...
{
	LOGV("android_widget_RelativeLayout_LayoutParams::~android_widget_RelativeLayout_LayoutParams() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
java_lang_String *  android_widget_RelativeLayout_LayoutParams::debug(java_lang_String& arg0)
{
	const char *methodName = "debug";
	const char *methodSignature = "(Ljava/lang/String;)Ljava/lang/String;";
	const char *className = "android_widget_RelativeLayout_LayoutParams";
