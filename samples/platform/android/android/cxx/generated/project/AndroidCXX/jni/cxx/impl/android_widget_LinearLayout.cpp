...
template void convert_proxy<android_widget_LinearLayout_LayoutParams>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
{
	LOGV("android_widget_LinearLayout::android_widget_LinearLayout(const android_widget_LinearLayout& cc) invoked");
...
{
	LOGV("android_widget_LinearLayout::android_widget_LinearLayout(void * proxy) invoked");
...
{
	LOGV("android_widget_LinearLayout::~android_widget_LinearLayout() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
android_widget_LinearLayout_LayoutParams *  android_widget_LinearLayout::generateLayoutParams(android_util_AttributeSet& arg0)
{
	...
	const char *className = "android_widget_LinearLayout";
	...
	android_widget_LinearLayout_LayoutParams *  result;
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		convert_proxy<android_widget_LinearLayout_LayoutParams>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_widget_LinearLayout_LayoutParams * ) (*((android_widget_LinearLayout_LayoutParams *  *) cxx_value));
...
void android_widget_LinearLayout::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_LinearLayout::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
android_graphics_drawable_Drawable *  android_widget_LinearLayout::getDividerDrawable()
{
...
void android_widget_LinearLayout::setDividerDrawable(android_graphics_drawable_Drawable& arg0)
{
