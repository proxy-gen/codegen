...
{
	LOGV("android_widget_TwoLineListItem::android_widget_TwoLineListItem(const android_widget_TwoLineListItem& cc) invoked");
...
{
	LOGV("android_widget_TwoLineListItem::android_widget_TwoLineListItem(void * proxy) invoked");
...
{
	LOGV("android_widget_TwoLineListItem::~android_widget_TwoLineListItem() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
