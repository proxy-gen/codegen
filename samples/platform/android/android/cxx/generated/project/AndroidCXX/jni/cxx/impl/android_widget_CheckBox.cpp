...
{
	LOGV("android_widget_CheckBox::android_widget_CheckBox(const android_widget_CheckBox& cc) invoked");
...
{
	LOGV("android_widget_CheckBox::android_widget_CheckBox(void * proxy) invoked");
...
{
	LOGV("android_widget_CheckBox::~android_widget_CheckBox() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
void android_widget_CheckBox::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
	...
	const char *className = "android_widget_CheckBox";
