...
java_lang_String *  android_app_FragmentManager_BackStackEntry::getName()
{
	const char *methodName = "getName";
	const char *methodSignature = "()Ljava/lang/String;";
	const char *className = "android_app_FragmentManager_BackStackEntry";
...
java_lang_CharSequence *  android_app_FragmentManager_BackStackEntry::getBreadCrumbTitle()
{
...
java_lang_CharSequence *  android_app_FragmentManager_BackStackEntry::getBreadCrumbShortTitle()
{
