...
void android_widget_DatePicker::init(int const& arg0,int const& arg1,int const& arg2,AndroidCXX::android_widget_DatePicker_OnDateChangedListener const& arg3)
{
	...
	jobject jarg3;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_android_widget_DatePicker_OnDateChangedListener(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
{
	LOGV("int android_widget_DatePicker::getYear() enter");
...
{
	LOGV("int android_widget_DatePicker::getMonth() enter");
...
{
	LOGV("int android_widget_DatePicker::getDayOfMonth() enter");
...
{
	LOGV("bool android_widget_DatePicker::isEnabled() enter");
...
{
	LOGV("long android_widget_DatePicker::getMinDate() enter");
...
{
	LOGV("long android_widget_DatePicker::getMaxDate() enter");
...
{
	LOGV("bool android_widget_DatePicker::getCalendarViewShown() enter");
...
AndroidCXX::android_widget_CalendarView android_widget_DatePicker::getCalendarView()
{
	LOGV("AndroidCXX::android_widget_CalendarView android_widget_DatePicker::getCalendarView() enter");
...
{
	LOGV("bool android_widget_DatePicker::getSpinnersShown() enter");
