...
template void convert_proxy<android_widget_DatePicker_OnDateChangedListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_widget_CalendarView>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
android_widget_DatePicker::android_widget_DatePicker(const android_widget_DatePicker& cc)
{
	LOGV("android_widget_DatePicker::android_widget_DatePicker(const android_widget_DatePicker& cc) invoked");
...
{
	LOGV("android_widget_DatePicker::android_widget_DatePicker(void * proxy) invoked");
...
{
	LOGV("android_widget_DatePicker::~android_widget_DatePicker() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
void android_widget_DatePicker::init(int& arg0,android_widget_DatePicker_OnDateChangedListener& arg1)
{
	const char *methodName = "init";
	const char *methodSignature = "(ILandroid/widget/DatePicker$OnDateChangedListener;)V";
	const char *className = "android_widget_DatePicker";
	...
	jobject jarg1;
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.widget.DatePicker$OnDateChangedListener");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_DatePicker_OnDateChangedListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
int android_widget_DatePicker::getMonth()
{
...
int android_widget_DatePicker::getDayOfMonth()
{
	const char *methodName = "getDayOfMonth";
	const char *methodSignature = "()I";
	const char *className = "android_widget_DatePicker";
...
bool android_widget_DatePicker::isEnabled()
{
...
bool android_widget_DatePicker::dispatchPopulateAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_DatePicker::onPopulateAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_DatePicker::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_DatePicker::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
{
	const char *methodName = "getCalendarViewShown";
	const char *methodSignature = "()Z";
	const char *className = "android_widget_DatePicker";
...
android_widget_CalendarView *  android_widget_DatePicker::getCalendarView()
{
	const char *methodName = "getCalendarView";
	...
	android_widget_CalendarView *  result;
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.widget.CalendarView");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_widget_CalendarView>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_widget_CalendarView * ) (*((android_widget_CalendarView *  *) cxx_value));
...
{
	const char *methodName = "getSpinnersShown";
	const char *methodSignature = "()Z";
	const char *className = "android_widget_DatePicker";
...
void android_widget_DatePicker::updateDate(int& arg0)
{
