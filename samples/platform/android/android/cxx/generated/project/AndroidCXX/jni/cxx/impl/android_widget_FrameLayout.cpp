...
template void convert_proxy<android_widget_FrameLayout_LayoutParams>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
{
	LOGV("android_widget_FrameLayout::android_widget_FrameLayout(const android_widget_FrameLayout& cc) invoked");
...
{
	LOGV("android_widget_FrameLayout::android_widget_FrameLayout(void * proxy) invoked");
...
{
	LOGV("android_widget_FrameLayout::~android_widget_FrameLayout() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
android_widget_FrameLayout_LayoutParams *  android_widget_FrameLayout::generateLayoutParams(android_util_AttributeSet& arg0)
{
	...
	const char *className = "android_widget_FrameLayout";
	...
	android_widget_FrameLayout_LayoutParams *  result;
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		convert_proxy<android_widget_FrameLayout_LayoutParams>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_widget_FrameLayout_LayoutParams * ) (*((android_widget_FrameLayout_LayoutParams *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
bool android_widget_FrameLayout::gatherTransparentRegion(android_graphics_Region& arg0)
{
...
void android_widget_FrameLayout::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_FrameLayout::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
void android_widget_FrameLayout::draw(android_graphics_Canvas& arg0)
{
...
void android_widget_FrameLayout::setForeground(android_graphics_drawable_Drawable& arg0)
{
...
android_graphics_drawable_Drawable *  android_widget_FrameLayout::getForeground()
{
