...
template void convert_proxy<java_io_Reader>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
void org_xmlpull_v1_XmlPullParser::setProperty(java_lang_String& arg0,java_lang_Object& arg1)
{
	...
	const char *className = "org_xmlpull_v1_XmlPullParser";
...
void org_xmlpull_v1_XmlPullParser::setInput(java_io_InputStream& arg0,java_lang_String& arg1,java_io_Reader& arg2)
{
	...
	const char *methodSignature = "(Ljava/io/InputStream;Ljava/lang/String;Ljava/io/Reader;)V";
	const char *className = "org_xmlpull_v1_XmlPullParser";
	...
	jobject jarg2;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<java_io_Reader>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
