...
void java_io_Reader::close()
{
	...
	const char *className = "java_io_Reader";
...
int java_io_Reader::read(std::vector<char>& arg0,int& arg1,java_nio_CharBuffer& arg2)
{
	const char *methodName = "read";
	const char *methodSignature = "([[CILjava/nio/CharBuffer;)I";
	const char *className = "java_io_Reader";
