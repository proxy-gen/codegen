...
public:
	...
	static AndroidCXX::java_math_BigDecimal valueOf(long& arg0,int& arg1);
	 ...
	 std::vector<java_math_BigDecimal > divideAndRemainder(AndroidCXX::java_math_BigDecimal& arg0,AndroidCXX::java_math_MathContext& arg1);
	 std::vector<java_math_BigDecimal > divideAndRemainder(AndroidCXX::java_math_BigDecimal& arg0);
