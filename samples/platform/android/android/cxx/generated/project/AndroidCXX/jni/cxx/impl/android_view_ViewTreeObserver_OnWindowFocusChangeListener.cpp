...
{	
	...
	LOGV("android_view_ViewTreeObserver_OnWindowFocusChangeListener cxx address %d", cxxAddress);
	long proxiedComponent = (long) ctx->findProxyComponent(cxxAddress);
	LOGV("android_view_ViewTreeObserver_OnWindowFocusChangeListener jni address %d", proxiedComponent);
...
void android_view_ViewTreeObserver_OnWindowFocusChangeListener::onWindowFocusChanged(bool const& arg0)
{
	...
	LOGV("android_view_ViewTreeObserver_OnWindowFocusChangeListener jni address %d", javaObject);
