...
template void convert_proxy<android_content_Loader_OnLoadCompleteListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_content_Loader_OnLoadCanceledListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);


java_lang_String *  android_content_Loader::toString()
{
	const char *methodName = "toString";
	const char *methodSignature = "()Ljava/lang/String;";
	const char *className = "android_content_Loader";
...
android_content_Context *  android_content_Loader::getContext()
{
...
void android_content_Loader::dump(java_lang_String& arg0,java_io_FileDescriptor& arg1,java_io_PrintWriter& arg2,std::vector<long>& arg3)
{
...
void android_content_Loader::deliverResult(java_lang_Object& arg0)
{
...
void android_content_Loader::registerListener(int& arg0,android_content_Loader_OnLoadCompleteListener& arg1)
{
	...
	jobject jarg1;
	{
		...
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_content_Loader_OnLoadCompleteListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_content_Loader::unregisterListener(android_content_Loader_OnLoadCompleteListener& arg0)
{
...
java_lang_String *  android_content_Loader::dataToString(java_lang_Object& arg0)
{
...
void android_content_Loader::registerOnLoadCanceledListener(android_content_Loader_OnLoadCanceledListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_content_Loader_OnLoadCanceledListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_content_Loader::unregisterOnLoadCanceledListener(android_content_Loader_OnLoadCanceledListener& arg0)
{
