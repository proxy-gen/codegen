...
{
	LOGV("android_content_Loader::android_content_Loader(const android_content_Loader& cc) invoked");
...
{
	LOGV("android_content_Loader::android_content_Loader(void * proxy) invoked");
...
{
	LOGV("android_content_Loader::~android_content_Loader() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
