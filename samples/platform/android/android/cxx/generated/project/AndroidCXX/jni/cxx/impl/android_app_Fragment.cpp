...
{
	LOGV("android_app_Fragment::android_app_Fragment(const android_app_Fragment& cc) invoked");
...
{
	LOGV("android_app_Fragment::android_app_Fragment(void * proxy) invoked");
...
{
	LOGV("android_app_Fragment::~android_app_Fragment() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
