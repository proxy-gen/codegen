...
template void convert_proxy<android_graphics_SurfaceTexture_OnFrameAvailableListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
android_graphics_SurfaceTexture::android_graphics_SurfaceTexture(const android_graphics_SurfaceTexture& cc)
{
	LOGV("android_graphics_SurfaceTexture::android_graphics_SurfaceTexture(const android_graphics_SurfaceTexture& cc) invoked");
...
{
	LOGV("android_graphics_SurfaceTexture::android_graphics_SurfaceTexture(void * proxy) invoked");
...
{
	LOGV("android_graphics_SurfaceTexture::~android_graphics_SurfaceTexture() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
void android_graphics_SurfaceTexture::release()
{
	...
	const char *className = "android_graphics_SurfaceTexture";
...
void android_graphics_SurfaceTexture::setOnFrameAvailableListener(android_graphics_SurfaceTexture_OnFrameAvailableListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		convert_proxy<android_graphics_SurfaceTexture_OnFrameAvailableListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_graphics_SurfaceTexture::setDefaultBufferSize(int& arg0)
{
