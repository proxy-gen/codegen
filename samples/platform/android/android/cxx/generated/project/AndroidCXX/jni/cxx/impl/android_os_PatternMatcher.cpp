...
{
	LOGV("android_os_PatternMatcher::android_os_PatternMatcher(const android_os_PatternMatcher& cc) invoked");
...
{
	LOGV("android_os_PatternMatcher::android_os_PatternMatcher(void * proxy) invoked");
...
{
	LOGV("android_os_PatternMatcher::~android_os_PatternMatcher() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
java_lang_String *  android_os_PatternMatcher::toString()
{
	const char *methodName = "toString";
	const char *methodSignature = "()Ljava/lang/String;";
	const char *className = "android_os_PatternMatcher";
	...
	LOGV("android_os_PatternMatcher jni address %d", javaObject);
...
int android_os_PatternMatcher::getType()
{
...
java_lang_String *  android_os_PatternMatcher::getPath()
{
...
bool android_os_PatternMatcher::match(java_lang_String& arg0)
{
...
int android_os_PatternMatcher::describeContents()
{
...
void android_os_PatternMatcher::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
