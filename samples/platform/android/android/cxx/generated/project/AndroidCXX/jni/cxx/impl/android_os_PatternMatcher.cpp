...
// Functions
AndroidCXX::java_lang_String android_os_PatternMatcher::toString()
{
	LOGV("AndroidCXX::java_lang_String android_os_PatternMatcher::toString() enter");
...
{
	LOGV("int android_os_PatternMatcher::getType() enter");
...
AndroidCXX::java_lang_String android_os_PatternMatcher::getPath()
{
	LOGV("AndroidCXX::java_lang_String android_os_PatternMatcher::getPath() enter");
...
{
	LOGV("int android_os_PatternMatcher::describeContents() enter");
