...
{
	LOGV("android_content_Intent::android_content_Intent(const android_content_Intent& cc) invoked");
...
{
	LOGV("android_content_Intent::android_content_Intent(void * proxy) invoked");
...
{
	LOGV("android_content_Intent::~android_content_Intent() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
