...
{
	LOGV("android_widget_Button::android_widget_Button(const android_widget_Button& cc) invoked");
...
{
	LOGV("android_widget_Button::android_widget_Button(void * proxy) invoked");
...
{
	LOGV("android_widget_Button::~android_widget_Button() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
void android_widget_Button::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
	const char *methodName = "onInitializeAccessibilityEvent";
	const char *methodSignature = "(Landroid/view/accessibility/AccessibilityEvent;)V";
	const char *className = "android_widget_Button";
...
void android_widget_Button::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
