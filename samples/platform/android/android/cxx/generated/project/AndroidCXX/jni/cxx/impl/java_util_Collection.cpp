...
bool java_util_Collection::add(AndroidCXX::java_lang_Object const& arg0)
{
	...
	LOGV("java_util_Collection className %s methodName %s methodSignature %s", className, methodName, methodSignature);
...
std::vector<AndroidCXX::java_lang_Object > java_util_Collection::toArray()
{
	LOGV("std::vector<AndroidCXX::java_lang_Object > java_util_Collection::toArray() enter");
