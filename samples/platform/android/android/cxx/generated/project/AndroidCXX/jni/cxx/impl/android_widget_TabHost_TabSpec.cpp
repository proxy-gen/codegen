...
template void convert_proxy<android_widget_TabHost_TabContentFactory>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
// Functions
java_lang_String *  android_widget_TabHost_TabSpec::getTag()
{
	const char *methodName = "getTag";
	const char *methodSignature = "()Ljava/lang/String;";
	const char *className = "android_widget_TabHost_TabSpec";
...
android_widget_TabHost_TabSpec *  android_widget_TabHost_TabSpec::setIndicator(java_lang_CharSequence& arg0,android_graphics_drawable_Drawable& arg1,android_view_View& arg2)
{
	const char *methodName = "setIndicator";
	const char *methodSignature = "(Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;Landroid/view/View;)Landroid/widget/TabHost$TabSpec;";
	const char *className = "android_widget_TabHost_TabSpec";
...
android_widget_TabHost_TabSpec *  android_widget_TabHost_TabSpec::setContent(int& arg0,android_widget_TabHost_TabContentFactory& arg1,android_content_Intent& arg2)
{
	const char *methodName = "setContent";
	const char *methodSignature = "(ILandroid/widget/TabHost$TabContentFactory;Landroid/content/Intent;)Landroid/widget/TabHost$TabSpec;";
	const char *className = "android_widget_TabHost_TabSpec";
	...
	jobject jarg1;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_TabHost_TabContentFactory>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
