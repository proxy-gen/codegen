...
{
	LOGV("android_content_pm_Signature::android_content_pm_Signature(const android_content_pm_Signature& cc) invoked");
...
{
	LOGV("android_content_pm_Signature::android_content_pm_Signature(void * proxy) invoked");
...
{
	LOGV("android_content_pm_Signature::~android_content_pm_Signature() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
bool android_content_pm_Signature::equals(java_lang_Object& arg0)
{
	const char *methodName = "equals";
	const char *methodSignature = "(Ljava/lang/Object;)Z";
	const char *className = "android_content_pm_Signature";
...
std::vector<char> android_content_pm_Signature::toByteArray()
{
...
void android_content_pm_Signature::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
...
java_lang_String *  android_content_pm_Signature::toCharsString()
{
