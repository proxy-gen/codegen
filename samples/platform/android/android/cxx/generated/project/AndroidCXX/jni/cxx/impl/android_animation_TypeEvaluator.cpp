...
AndroidCXX::java_lang_Object android_animation_TypeEvaluator::evaluate(float const& arg0,AndroidCXX::java_lang_Object const& arg1,AndroidCXX::java_lang_Object const& arg2)
{
	...
	LOGV("android_animation_TypeEvaluator className %s methodName %s methodSignature %s", className, methodName, methodSignature);
	...
	LOGV("android_animation_TypeEvaluator jni address %d", javaObject);
