...
template void convert_proxy<android_app_ActionBar_LayoutParams>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_app_ActionBar_OnNavigationListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_app_ActionBar_OnMenuVisibilityListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
void android_app_ActionBar::show()
{
	...
	const char *className = "android_app_ActionBar";
...
void android_app_ActionBar::setTitle(java_lang_CharSequence& arg0,int& arg1)
{
...
java_lang_CharSequence *  android_app_ActionBar::getTitle()
{
...
void android_app_ActionBar::setBackgroundDrawable(android_graphics_drawable_Drawable& arg0)
{
...
void android_app_ActionBar::setIcon(android_graphics_drawable_Drawable& arg0,int& arg1)
{
...
void android_app_ActionBar::setSubtitle(int& arg0,java_lang_CharSequence& arg1)
{
...
void android_app_ActionBar::setCustomView(android_view_View& arg0,android_app_ActionBar_LayoutParams& arg1,int& arg2)
{
	const char *methodName = "setCustomView";
	const char *methodSignature = "(Landroid/view/View;Landroid/app/ActionBar$LayoutParams;I)V";
	const char *className = "android_app_ActionBar";
	...
	jobject jarg1;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_app_ActionBar_LayoutParams>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
java_lang_CharSequence *  android_app_ActionBar::getSubtitle()
{
...
android_view_View *  android_app_ActionBar::getCustomView()
{
...
void android_app_ActionBar::setLogo(int& arg0,android_graphics_drawable_Drawable& arg1)
{
...
void android_app_ActionBar::setListNavigationCallbacks(android_widget_SpinnerAdapter& arg0,android_app_ActionBar_OnNavigationListener& arg1)
{
	...
	jobject jarg1;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_app_ActionBar_OnNavigationListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_app_ActionBar::setStackedBackgroundDrawable(android_graphics_drawable_Drawable& arg0)
{
...
void android_app_ActionBar::setSplitBackgroundDrawable(android_graphics_drawable_Drawable& arg0)
{
...
android_app_ActionBar_Tab *  android_app_ActionBar::newTab()
{
	...
	android_app_ActionBar_Tab *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
	...
	result = (android_app_ActionBar_Tab * ) (*((android_app_ActionBar_Tab *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
void android_app_ActionBar::addTab(android_app_ActionBar_Tab& arg0,int& arg1,bool& arg2)
{
...
void android_app_ActionBar::removeTab(android_app_ActionBar_Tab& arg0)
{
...
void android_app_ActionBar::selectTab(android_app_ActionBar_Tab& arg0)
{
...
android_app_ActionBar_Tab *  android_app_ActionBar::getSelectedTab()
{
...
android_app_ActionBar_Tab *  android_app_ActionBar::getTabAt(int& arg0)
{
...
void android_app_ActionBar::addOnMenuVisibilityListener(android_app_ActionBar_OnMenuVisibilityListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_app_ActionBar_OnMenuVisibilityListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_app_ActionBar::removeOnMenuVisibilityListener(android_app_ActionBar_OnMenuVisibilityListener& arg0)
{
...
android_content_Context *  android_app_ActionBar::getThemedContext()
{
