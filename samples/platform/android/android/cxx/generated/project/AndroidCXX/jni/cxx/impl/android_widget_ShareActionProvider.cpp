...
template void convert_proxy<android_view_SubMenu>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_widget_ShareActionProvider_OnShareTargetSelectedListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
{
	LOGV("android_widget_ShareActionProvider::android_widget_ShareActionProvider(const android_widget_ShareActionProvider& cc) invoked");
...
{
	LOGV("android_widget_ShareActionProvider::android_widget_ShareActionProvider(void * proxy) invoked");
...
{
	LOGV("android_widget_ShareActionProvider::~android_widget_ShareActionProvider() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
bool android_widget_ShareActionProvider::hasSubMenu()
{
	...
	const char *className = "android_widget_ShareActionProvider";
...
android_view_View *  android_widget_ShareActionProvider::onCreateActionView()
{
...
void android_widget_ShareActionProvider::onPrepareSubMenu(android_view_SubMenu& arg0)
{
...
void android_widget_ShareActionProvider::setOnShareTargetSelectedListener(android_widget_ShareActionProvider_OnShareTargetSelectedListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_ShareActionProvider_OnShareTargetSelectedListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_widget_ShareActionProvider::setShareHistoryFileName(java_lang_String& arg0)
{
...
void android_widget_ShareActionProvider::setShareIntent(android_content_Intent& arg0)
{
