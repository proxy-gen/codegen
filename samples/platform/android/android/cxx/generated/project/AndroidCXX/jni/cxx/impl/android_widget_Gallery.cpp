...
{
	LOGV("android_widget_Gallery::android_widget_Gallery(const android_widget_Gallery& cc) invoked");
...
{
	LOGV("android_widget_Gallery::android_widget_Gallery(void * proxy) invoked");
...
{
	LOGV("android_widget_Gallery::~android_widget_Gallery() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
bool android_widget_Gallery::onKeyDown(int& arg0,android_view_KeyEvent& arg1)
{
	const char *methodName = "onKeyDown";
	const char *methodSignature = "(ILandroid/view/KeyEvent;)Z";
	const char *className = "android_widget_Gallery";
...
bool android_widget_Gallery::onKeyUp(int& arg0,android_view_KeyEvent& arg1)
{
...
bool android_widget_Gallery::onTouchEvent(android_view_MotionEvent& arg0)
{
...
bool android_widget_Gallery::dispatchKeyEvent(android_view_KeyEvent& arg0)
{
...
bool android_widget_Gallery::showContextMenuForChild(android_view_View& arg0)
{
...
android_view_ViewGroup_LayoutParams *  android_widget_Gallery::generateLayoutParams(android_util_AttributeSet& arg0)
{
...
void android_widget_Gallery::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_Gallery::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
bool android_widget_Gallery::performAccessibilityAction(int& arg0,android_os_Bundle& arg1)
{
...
bool android_widget_Gallery::onScroll(android_view_MotionEvent& arg0,float& arg1)
{
	const char *methodName = "onScroll";
	const char *methodSignature = "(Landroid/view/MotionEvent;F)Z";
	const char *className = "android_widget_Gallery";
...
bool android_widget_Gallery::onSingleTapUp(android_view_MotionEvent& arg0)
{
...
bool android_widget_Gallery::onFling(android_view_MotionEvent& arg0,float& arg1)
{
...
bool android_widget_Gallery::onDown(android_view_MotionEvent& arg0)
{
...
void android_widget_Gallery::onLongPress(android_view_MotionEvent& arg0)
{
...
void android_widget_Gallery::onShowPress(android_view_MotionEvent& arg0)
{
