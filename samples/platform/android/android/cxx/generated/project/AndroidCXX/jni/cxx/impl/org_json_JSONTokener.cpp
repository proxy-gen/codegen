...
template void convert_proxy<org_json_JSONException>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
org_json_JSONTokener::org_json_JSONTokener(const org_json_JSONTokener& cc)
{
	LOGV("org_json_JSONTokener::org_json_JSONTokener(const org_json_JSONTokener& cc) invoked");
...
{
	LOGV("org_json_JSONTokener::org_json_JSONTokener(void * proxy) invoked");
...
{
	LOGV("org_json_JSONTokener::~org_json_JSONTokener() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
java_lang_String *  org_json_JSONTokener::toString()
{
	const char *methodName = "toString";
	const char *methodSignature = "()Ljava/lang/String;";
	const char *className = "org_json_JSONTokener";
...
char org_json_JSONTokener::next(char& arg0,int& arg1)
{
...
java_lang_Object *  org_json_JSONTokener::nextValue()
{
...
java_lang_String *  org_json_JSONTokener::nextString(char& arg0)
{
...
org_json_JSONException *  org_json_JSONTokener::syntaxError(java_lang_String& arg0)
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<org_json_JSONException>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (org_json_JSONException * ) (*((org_json_JSONException *  *) cxx_value));
...
java_lang_String *  org_json_JSONTokener::nextTo(java_lang_String& arg0,char& arg1)
{
	const char *methodName = "nextTo";
	const char *methodSignature = "(Ljava/lang/String;C)Ljava/lang/String;";
	const char *className = "org_json_JSONTokener";
...
void org_json_JSONTokener::skipPast(java_lang_String& arg0)
{
