...
template void convert_proxy<android_widget_ExpandableListView>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
// Functions
bool android_widget_ExpandableListView_OnChildClickListener::onChildClick(android_widget_ExpandableListView& arg0,android_view_View& arg1,int& arg2,long& arg3)
{
	const char *methodName = "onChildClick";
	const char *methodSignature = "(Landroid/widget/ExpandableListView;Landroid/view/View;IJ)Z";
	const char *className = "android_widget_ExpandableListView_OnChildClickListener";
	...
	LOGV("android_widget_ExpandableListView_OnChildClickListener jni address %d", javaObject);
	...
	jobject jarg0;
	{
		...
		convert_proxy<android_widget_ExpandableListView>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
