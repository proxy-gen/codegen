...
std::vector<java_lang_Object > android_widget_AlphabetIndexer::getSections()
{
	LOGV("std::vector<java_lang_Object > android_widget_AlphabetIndexer::getSections() enter");
	...
	LOGV("std::vector<java_lang_Object > android_widget_AlphabetIndexer::getSections() exit");
