...
{
	LOGV("android_widget_AlphabetIndexer::android_widget_AlphabetIndexer(const android_widget_AlphabetIndexer& cc) invoked");
...
{
	LOGV("android_widget_AlphabetIndexer::android_widget_AlphabetIndexer(void * proxy) invoked");
...
{
	LOGV("android_widget_AlphabetIndexer::~android_widget_AlphabetIndexer() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
