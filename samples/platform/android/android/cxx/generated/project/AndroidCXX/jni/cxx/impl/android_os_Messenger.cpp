...
template void convert_proxy<android_os_Messenger>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
android_os_Messenger::android_os_Messenger(const android_os_Messenger& cc)
{
	LOGV("android_os_Messenger::android_os_Messenger(const android_os_Messenger& cc) invoked");
...
{
	LOGV("android_os_Messenger::android_os_Messenger(void * proxy) invoked");
...
{
	LOGV("android_os_Messenger::~android_os_Messenger() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
bool android_os_Messenger::equals(java_lang_Object& arg0)
{
	const char *methodName = "equals";
	const char *methodSignature = "(Ljava/lang/Object;)Z";
	const char *className = "android_os_Messenger";
...
void android_os_Messenger::send(android_os_Message& arg0)
{
...
void android_os_Messenger::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
...
android_os_IBinder *  android_os_Messenger::getBinder()
{
...
void android_os_Messenger::writeMessengerOrNullToParcel(android_os_Messenger& arg0,android_os_Parcel& arg1)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_os_Messenger>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
android_os_Messenger *  android_os_Messenger::readMessengerOrNullFromParcel(android_os_Parcel& arg0)
{
	...
	result = (android_os_Messenger * ) (*((android_os_Messenger *  *) cxx_value));
