...
AndroidCXX::java_lang_String android_util_AttributeSet::getPositionDescription()
{
	LOGV("AndroidCXX::java_lang_String android_util_AttributeSet::getPositionDescription() enter");
...
{
	LOGV("int android_util_AttributeSet::getAttributeCount() enter");
...
AndroidCXX::java_lang_String android_util_AttributeSet::getIdAttribute()
{
	LOGV("AndroidCXX::java_lang_String android_util_AttributeSet::getIdAttribute() enter");
...
AndroidCXX::java_lang_String android_util_AttributeSet::getClassAttribute()
{
	LOGV("AndroidCXX::java_lang_String android_util_AttributeSet::getClassAttribute() enter");
...
{
	LOGV("int android_util_AttributeSet::getStyleAttribute() enter");
