...
{
	LOGV("android_widget_EdgeEffect::android_widget_EdgeEffect(const android_widget_EdgeEffect& cc) invoked");
...
{
	LOGV("android_widget_EdgeEffect::android_widget_EdgeEffect(void * proxy) invoked");
...
{
	LOGV("android_widget_EdgeEffect::~android_widget_EdgeEffect() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
void android_widget_EdgeEffect::setSize(int& arg0)
{
	const char *methodName = "setSize";
	const char *methodSignature = "(I)V";
	const char *className = "android_widget_EdgeEffect";
...
bool android_widget_EdgeEffect::draw(android_graphics_Canvas& arg0)
{
