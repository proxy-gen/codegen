...
{
	LOGV("android_text_TextPaint::android_text_TextPaint(const android_text_TextPaint& cc) invoked");
...
{
	LOGV("android_text_TextPaint::android_text_TextPaint(void * proxy) invoked");
...
{
	LOGV("android_text_TextPaint::~android_text_TextPaint() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
