...
void android_content_Loader_OnLoadCompleteListener::onLoadComplete(android_content_Loader& arg0,java_lang_Object& arg1)
{
	const char *methodName = "onLoadComplete";
	const char *methodSignature = "(Landroid/content/Loader;Ljava/lang/Object;)V";
	const char *className = "android_content_Loader_OnLoadCompleteListener";
