...
template void convert_proxy<android_content_Loader>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_app_LoaderManager_LoaderCallbacks>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);


android_content_Loader *  android_app_LoaderManager::getLoader(int& arg0)
{
	const char *methodName = "getLoader";
	const char *methodSignature = "(I)Landroid/content/Loader;";
	const char *className = "android_app_LoaderManager";

	LOGV("android_app_LoaderManager className %d methodName %s methodSignature %s", className, methodName, methodSignature);
	...
	LOGV("android_app_LoaderManager jni address %d", javaObject);
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		convert_proxy<android_content_Loader>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_content_Loader * ) (*((android_content_Loader *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
void android_app_LoaderManager::dump(java_lang_String& arg0,java_io_FileDescriptor& arg1,java_io_PrintWriter& arg2,std::vector<long>& arg3)
{
...
android_content_Loader *  android_app_LoaderManager::initLoader(int& arg0,android_os_Bundle& arg1,android_app_LoaderManager_LoaderCallbacks& arg2)
{
	...
	jobject jarg2;
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.app.LoaderManager$LoaderCallbacks");
			{
				CXXTypeHierarchy child_cxx_type_hierarchy;
				cxx_type_hierarchy.child_types.push_back(child_cxx_type_hierarchy);
				cxx_type_hierarchy_stack.push(child_cxx_type_hierarchy);
		...
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_app_LoaderManager_LoaderCallbacks>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
android_content_Loader *  android_app_LoaderManager::restartLoader(int& arg0,android_os_Bundle& arg1,android_app_LoaderManager_LoaderCallbacks& arg2)
{
