...
// Functions
void android_widget_NumberPicker_OnScrollListener::onScrollStateChange(android_widget_NumberPicker& arg0,int& arg1)
{
	const char *methodName = "onScrollStateChange";
	const char *methodSignature = "(Landroid/widget/NumberPicker;I)V";
	const char *className = "android_widget_NumberPicker_OnScrollListener";
