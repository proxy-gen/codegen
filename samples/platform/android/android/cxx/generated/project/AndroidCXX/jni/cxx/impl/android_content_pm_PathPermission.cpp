...
{
	LOGV("android_content_pm_PathPermission::android_content_pm_PathPermission(const android_content_pm_PathPermission& cc) invoked");
...
{
	LOGV("android_content_pm_PathPermission::android_content_pm_PathPermission(void * proxy) invoked");
...
{
	LOGV("android_content_pm_PathPermission::~android_content_pm_PathPermission() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
void android_content_pm_PathPermission::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
	const char *methodName = "writeToParcel";
	const char *methodSignature = "(Landroid/os/Parcel;I)V";
	const char *className = "android_content_pm_PathPermission";
...
java_lang_String *  android_content_pm_PathPermission::getReadPermission()
{
...
java_lang_String *  android_content_pm_PathPermission::getWritePermission()
{
