...
template void convert_proxy<android_os_CancellationSignal_OnCancelListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
android_os_CancellationSignal::android_os_CancellationSignal(const android_os_CancellationSignal& cc)
{
	LOGV("android_os_CancellationSignal::android_os_CancellationSignal(const android_os_CancellationSignal& cc) invoked");
...
{
	LOGV("android_os_CancellationSignal::android_os_CancellationSignal(void * proxy) invoked");
...
{
	LOGV("android_os_CancellationSignal::~android_os_CancellationSignal() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
void android_os_CancellationSignal::cancel()
{
	...
	const char *className = "android_os_CancellationSignal";
...
void android_os_CancellationSignal::setOnCancelListener(android_os_CancellationSignal_OnCancelListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		convert_proxy<android_os_CancellationSignal_OnCancelListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
