...
{
	LOGV("android_graphics_Paint_FontMetricsInt::android_graphics_Paint_FontMetricsInt(const android_graphics_Paint_FontMetricsInt& cc) invoked");
...
{
	LOGV("android_graphics_Paint_FontMetricsInt::android_graphics_Paint_FontMetricsInt(void * proxy) invoked");
...
{
	LOGV("android_graphics_Paint_FontMetricsInt::~android_graphics_Paint_FontMetricsInt() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
