...
{
	LOGV("android_widget_SimpleExpandableListAdapter::android_widget_SimpleExpandableListAdapter(const android_widget_SimpleExpandableListAdapter& cc) invoked");
...
{
	LOGV("android_widget_SimpleExpandableListAdapter::android_widget_SimpleExpandableListAdapter(void * proxy) invoked");
...
{
	LOGV("android_widget_SimpleExpandableListAdapter::~android_widget_SimpleExpandableListAdapter() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
