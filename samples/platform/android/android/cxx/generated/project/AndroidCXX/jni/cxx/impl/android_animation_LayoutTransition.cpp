...
template void convert_proxy<android_animation_LayoutTransition_TransitionListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
void android_animation_LayoutTransition::setInterpolator(int& arg0,android_animation_TimeInterpolator& arg1)
{
	const char *methodName = "setInterpolator";
	const char *methodSignature = "(ILandroid/animation/TimeInterpolator;)V";
	const char *className = "android_animation_LayoutTransition";
...
android_animation_TimeInterpolator *  android_animation_LayoutTransition::getInterpolator(int& arg0)
{
	...
	android_animation_TimeInterpolator *  result;
	...
	result = (android_animation_TimeInterpolator * ) (*((android_animation_TimeInterpolator *  *) cxx_value));
...
void android_animation_LayoutTransition::addChild(android_view_ViewGroup& arg0,android_view_View& arg1)
{
...
void android_animation_LayoutTransition::setAnimator(int& arg0,android_animation_Animator& arg1)
{
...
android_animation_Animator *  android_animation_LayoutTransition::getAnimator(int& arg0)
{
...
void android_animation_LayoutTransition::showChild(android_view_ViewGroup& arg0,android_view_View& arg1,int& arg2)
{
...
void android_animation_LayoutTransition::removeChild(android_view_ViewGroup& arg0,android_view_View& arg1)
{
...
void android_animation_LayoutTransition::hideChild(android_view_ViewGroup& arg0,android_view_View& arg1,int& arg2)
{
...
void android_animation_LayoutTransition::addTransitionListener(android_animation_LayoutTransition_TransitionListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_animation_LayoutTransition_TransitionListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_animation_LayoutTransition::removeTransitionListener(android_animation_LayoutTransition_TransitionListener& arg0)
{
...
java_util_List *  android_animation_LayoutTransition::getTransitionListeners()
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<android_animation_LayoutTransition_TransitionListener>);				
