...
{
	LOGV("android_animation_LayoutTransition::android_animation_LayoutTransition(const android_animation_LayoutTransition& cc) invoked");
...
{
	LOGV("android_animation_LayoutTransition::android_animation_LayoutTransition(void * proxy) invoked");
...
{
	LOGV("android_animation_LayoutTransition::~android_animation_LayoutTransition() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
