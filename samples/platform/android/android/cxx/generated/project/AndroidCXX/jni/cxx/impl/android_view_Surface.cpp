...
{
	LOGV("android_view_Surface::android_view_Surface(const android_view_Surface& cc) invoked");
...
{
	LOGV("android_view_Surface::android_view_Surface(void * proxy) invoked");
...
{
	LOGV("android_view_Surface::~android_view_Surface() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
