...
template void convert_proxy<android_widget_TimePicker_OnTimeChangedListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
{
	LOGV("android_widget_TimePicker::android_widget_TimePicker(const android_widget_TimePicker& cc) invoked");
...
{
	LOGV("android_widget_TimePicker::android_widget_TimePicker(void * proxy) invoked");
...
{
	LOGV("android_widget_TimePicker::~android_widget_TimePicker() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
bool android_widget_TimePicker::isEnabled()
{
	const char *methodName = "isEnabled";
	const char *methodSignature = "()Z";
	const char *className = "android_widget_TimePicker";
...
bool android_widget_TimePicker::dispatchPopulateAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_TimePicker::onPopulateAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_TimePicker::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_TimePicker::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
void android_widget_TimePicker::setOnTimeChangedListener(android_widget_TimePicker_OnTimeChangedListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.widget.TimePicker$OnTimeChangedListener");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_TimePicker_OnTimeChangedListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
java_lang_Integer *  android_widget_TimePicker::getCurrentHour()
{
	const char *methodName = "getCurrentHour";
...
void android_widget_TimePicker::setCurrentHour(java_lang_Integer& arg0)
{
...
void android_widget_TimePicker::setIs24HourView(java_lang_Boolean& arg0)
{
...
{
	const char *methodName = "is24HourView";
	const char *methodSignature = "()Z";
	const char *className = "android_widget_TimePicker";
...
java_lang_Integer *  android_widget_TimePicker::getCurrentMinute()
{
	const char *methodName = "getCurrentMinute";
	const char *methodSignature = "()Ljava/lang/Integer;";
	const char *className = "android_widget_TimePicker";
...
void android_widget_TimePicker::setCurrentMinute(java_lang_Integer& arg0)
{
