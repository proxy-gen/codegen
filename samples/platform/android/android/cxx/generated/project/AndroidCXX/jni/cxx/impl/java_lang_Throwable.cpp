...
{
	LOGV("java_lang_Throwable::java_lang_Throwable(const java_lang_Throwable& cc) invoked");
...
{
	LOGV("java_lang_Throwable::java_lang_Throwable(void * proxy) invoked");
...
{
	LOGV("java_lang_Throwable::~java_lang_Throwable() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
