...
{
	LOGV("android_view_ViewGroup_MarginLayoutParams::android_view_ViewGroup_MarginLayoutParams(const android_view_ViewGroup_MarginLayoutParams& cc) invoked");
...
{
	LOGV("android_view_ViewGroup_MarginLayoutParams::android_view_ViewGroup_MarginLayoutParams(void * proxy) invoked");
...
{
	LOGV("android_view_ViewGroup_MarginLayoutParams::~android_view_ViewGroup_MarginLayoutParams() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
void android_view_ViewGroup_MarginLayoutParams::setLayoutDirection(int& arg0)
{
	...
	const char *className = "android_view_ViewGroup_MarginLayoutParams";
...
void android_view_ViewGroup_MarginLayoutParams::setMargins(int& arg0)
{
