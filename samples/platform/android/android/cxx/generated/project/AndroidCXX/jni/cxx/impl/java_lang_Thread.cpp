...
template void convert_proxy<java_lang_Thread_UncaughtExceptionHandler>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
java_lang_Thread::java_lang_Thread(const java_lang_Thread& cc)
{
	LOGV("java_lang_Thread::java_lang_Thread(const java_lang_Thread& cc) invoked");
...
{
	LOGV("java_lang_Thread::java_lang_Thread(void * proxy) invoked");
...
{
	LOGV("java_lang_Thread::~java_lang_Thread() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
void java_lang_Thread::run()
{
	...
	const char *className = "java_lang_Thread";
...
java_lang_String *  java_lang_Thread::toString()
{
...
java_lang_String *  java_lang_Thread::getName()
{
...
java_lang_ThreadGroup *  java_lang_Thread::getThreadGroup()
{
...
std::vector<long> java_lang_Thread::getStackTrace()
{
...
void java_lang_Thread::stop(java_lang_Throwable& arg0)
{
...
void java_lang_Thread::setName(java_lang_String& arg0)
{
...
int java_lang_Thread::enumerate(std::vector<long>& arg0)
{
	const char *methodName = "enumerate";
	const char *methodSignature = "([java/lang/Thread)I";
	const char *className = "java_lang_Thread";
...
java_lang_ClassLoader *  java_lang_Thread::getContextClassLoader()
{
...
void java_lang_Thread::setContextClassLoader(java_lang_ClassLoader& arg0)
{
...
bool java_lang_Thread::holdsLock(java_lang_Object& arg0)
{
...
java_util_Map *  java_lang_Thread::getAllStackTraces()
{
...
java_lang_Thread_State *  java_lang_Thread::getState()
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<java_lang_Thread_State>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
...
void java_lang_Thread::setDefaultUncaughtExceptionHandler(java_lang_Thread_UncaughtExceptionHandler& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<java_lang_Thread_UncaughtExceptionHandler>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
java_lang_Thread_UncaughtExceptionHandler *  java_lang_Thread::getDefaultUncaughtExceptionHandler()
{
	...
	java_lang_Thread_UncaughtExceptionHandler *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
	...
	result = (java_lang_Thread_UncaughtExceptionHandler * ) (*((java_lang_Thread_UncaughtExceptionHandler *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
java_lang_Thread_UncaughtExceptionHandler *  java_lang_Thread::getUncaughtExceptionHandler()
{
...
void java_lang_Thread::setUncaughtExceptionHandler(java_lang_Thread_UncaughtExceptionHandler& arg0)
{
