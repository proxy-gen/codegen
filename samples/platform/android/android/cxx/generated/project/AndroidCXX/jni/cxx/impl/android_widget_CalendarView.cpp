...
template void convert_proxy<android_widget_CalendarView_OnDateChangeListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
android_widget_CalendarView::android_widget_CalendarView(const android_widget_CalendarView& cc)
{
	LOGV("android_widget_CalendarView::android_widget_CalendarView(const android_widget_CalendarView& cc) invoked");
...
{
	LOGV("android_widget_CalendarView::android_widget_CalendarView(void * proxy) invoked");
...
{
	LOGV("android_widget_CalendarView::~android_widget_CalendarView() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
long android_widget_CalendarView::getDate()
{
	...
	const char *className = "android_widget_CalendarView";
...
void android_widget_CalendarView::setDate(long& arg0,bool& arg1)
{
	const char *methodName = "setDate";
	const char *methodSignature = "(JZ)V";
	const char *className = "android_widget_CalendarView";
...
void android_widget_CalendarView::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_CalendarView::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
void android_widget_CalendarView::setSelectedDateVerticalBar(android_graphics_drawable_Drawable& arg0,int& arg1)
{
...
android_graphics_drawable_Drawable *  android_widget_CalendarView::getSelectedDateVerticalBar()
{
...
void android_widget_CalendarView::setOnDateChangeListener(android_widget_CalendarView_OnDateChangeListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_CalendarView_OnDateChangeListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
