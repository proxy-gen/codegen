...
template void convert_proxy<java_net_FileNameMap>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
java_lang_Object *  java_net_URLConnection::getContent(std::vector<long>& arg0)
{
...
void java_net_URLConnection::setRequestProperty(java_lang_String& arg0)
{
...
java_lang_String *  java_net_URLConnection::getHeaderField(java_lang_String& arg0,int& arg1)
{
...
java_net_FileNameMap *  java_net_URLConnection::getFileNameMap()
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<java_net_FileNameMap>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
...
void java_net_URLConnection::addRequestProperty(java_lang_String& arg0)
{
...
void java_net_URLConnection::setDefaultRequestProperty(java_lang_String& arg0)
{
...
void java_net_URLConnection::setContentHandlerFactory(java_net_ContentHandlerFactory& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<java_net_ContentHandlerFactory>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
