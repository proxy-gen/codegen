...
template void convert_proxy<java_lang_reflect_Type>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<java_lang_Package>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<java_lang_reflect_Method>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<java_lang_reflect_Constructor>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<java_lang_reflect_Field>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<java_security_ProtectionDomain>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<java_lang_annotation_Annotation>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
std::vector<long> java_lang_Class::getTypeParameters()
{
	...
	long java_value = convert_jni__object_array_type_to_java(jni_result);
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<java_lang_reflect_TypeVariable>);				
		...
		{
			{
				converter_stack.push((long) &convert_proxy<java_lang_Class>);				
...
java_lang_Package *  java_lang_Class::getPackage()
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<java_lang_Package>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
...
std::vector<long> java_lang_Class::getInterfaces()
{
...
std::vector<long> java_lang_Class::getGenericInterfaces()
{
...
std::vector<long> java_lang_Class::getSigners()
{
...
java_lang_reflect_Method *  java_lang_Class::getEnclosingMethod()
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<java_lang_reflect_Method>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
...
java_lang_reflect_Constructor *  java_lang_Class::getEnclosingConstructor()
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<java_lang_reflect_Constructor>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
...
std::vector<long> java_lang_Class::getClasses()
{
...
std::vector<long> java_lang_Class::getFields()
{
	...
	long java_value = convert_jni__object_array_type_to_java(jni_result);
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<java_lang_reflect_Field>);				
...
std::vector<long> java_lang_Class::getMethods()
{
	...
	long java_value = convert_jni__object_array_type_to_java(jni_result);
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<java_lang_reflect_Method>);				
...
std::vector<long> java_lang_Class::getConstructors()
{
	...
	long java_value = convert_jni__object_array_type_to_java(jni_result);
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<java_lang_reflect_Constructor>);				
...
java_lang_reflect_Field *  java_lang_Class::getField(java_lang_String& arg0)
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<java_lang_reflect_Field>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
...
java_lang_reflect_Method *  java_lang_Class::getMethod(java_lang_String& arg0,std::vector<long>& arg1)
{
...
java_lang_reflect_Constructor *  java_lang_Class::getConstructor(std::vector<long>& arg0)
{
...
std::vector<long> java_lang_Class::getDeclaredClasses()
{
...
std::vector<long> java_lang_Class::getDeclaredFields()
{
...
std::vector<long> java_lang_Class::getDeclaredMethods()
{
...
std::vector<long> java_lang_Class::getDeclaredConstructors()
{
...
java_lang_reflect_Method *  java_lang_Class::getDeclaredMethod(java_lang_String& arg0,std::vector<long>& arg1)
{
...
java_lang_reflect_Constructor *  java_lang_Class::getDeclaredConstructor(std::vector<long>& arg0)
{
...
java_security_ProtectionDomain *  java_lang_Class::getProtectionDomain()
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<java_security_ProtectionDomain>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
...
std::vector<long> java_lang_Class::getEnumConstants()
{
...
std::vector<long> java_lang_Class::getAnnotations()
{
...
std::vector<long> java_lang_Class::getDeclaredAnnotations()
{
