...
{
	LOGV("android_widget_AbsoluteLayout::android_widget_AbsoluteLayout(const android_widget_AbsoluteLayout& cc) invoked");
...
{
	LOGV("android_widget_AbsoluteLayout::android_widget_AbsoluteLayout(void * proxy) invoked");
...
{
	LOGV("android_widget_AbsoluteLayout::~android_widget_AbsoluteLayout() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
android_view_ViewGroup_LayoutParams *  android_widget_AbsoluteLayout::generateLayoutParams(android_util_AttributeSet& arg0)
{
	...
	const char *className = "android_widget_AbsoluteLayout";
...
bool android_widget_AbsoluteLayout::shouldDelayChildPressedState()
{
