...
android_widget_AbsoluteLayout::android_widget_AbsoluteLayout(AndroidCXX::android_content_Context const& arg0)
{
	...
	LOGV("android_widget_AbsoluteLayout className %s methodName %s methodSignature %s", className, methodName, methodSignature);
...
{
	LOGV("bool android_widget_AbsoluteLayout::shouldDelayChildPressedState() enter");
