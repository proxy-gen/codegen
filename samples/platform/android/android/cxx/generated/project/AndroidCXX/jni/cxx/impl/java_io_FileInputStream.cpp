...
java_io_FileInputStream::java_io_FileInputStream(AndroidCXX::java_lang_String const& arg0)
{
	...
	LOGV("java_io_FileInputStream className %s methodName %s methodSignature %s", className, methodName, methodSignature);
...
// Functions
void java_io_FileInputStream::close()
{
	LOGV("void java_io_FileInputStream::close() enter");
...
int java_io_FileInputStream::read()
{
	LOGV("int java_io_FileInputStream::read() enter");
...
int java_io_FileInputStream::available()
{
	LOGV("int java_io_FileInputStream::available() enter");
...
AndroidCXX::java_io_FileDescriptor java_io_FileInputStream::getFD()
{
	LOGV("AndroidCXX::java_io_FileDescriptor java_io_FileInputStream::getFD() enter");
...
AndroidCXX::java_nio_channels_FileChannel java_io_FileInputStream::getChannel()
{
	LOGV("AndroidCXX::java_nio_channels_FileChannel java_io_FileInputStream::getChannel() enter");
