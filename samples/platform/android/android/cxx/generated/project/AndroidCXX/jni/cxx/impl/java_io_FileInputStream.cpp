...
{
	LOGV("java_io_FileInputStream::java_io_FileInputStream(const java_io_FileInputStream& cc) invoked");
...
{
	LOGV("java_io_FileInputStream::java_io_FileInputStream(void * proxy) invoked");
...
{
	LOGV("java_io_FileInputStream::~java_io_FileInputStream() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
