...
{
	LOGV("android_text_Editable_Factory::android_text_Editable_Factory(const android_text_Editable_Factory& cc) invoked");
...
{
	LOGV("android_text_Editable_Factory::android_text_Editable_Factory(void * proxy) invoked");
...
{
	LOGV("android_text_Editable_Factory::~android_text_Editable_Factory() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
