...
template void convert_proxy<android_database_sqlite_SQLiteCursorDriver>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_database_sqlite_SQLiteQuery>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
android_database_Cursor *  android_database_sqlite_SQLiteDatabase_CursorFactory::newCursor(android_database_sqlite_SQLiteDatabase& arg0,android_database_sqlite_SQLiteCursorDriver& arg1,java_lang_String& arg2,android_database_sqlite_SQLiteQuery& arg3)
{
	...
	const char *className = "android_database_sqlite_SQLiteDatabase_CursorFactory";
	...
	jobject jarg1;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_database_sqlite_SQLiteCursorDriver>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	...
	jobject jarg3;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_database_sqlite_SQLiteQuery>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
