...
// Functions
bool android_widget_SimpleCursorAdapter_ViewBinder::setViewValue(android_view_View& arg0,android_database_Cursor& arg1,int& arg2)
{
	const char *methodName = "setViewValue";
	const char *methodSignature = "(Landroid/view/View;Landroid/database/Cursor;I)Z";
	const char *className = "android_widget_SimpleCursorAdapter_ViewBinder";
