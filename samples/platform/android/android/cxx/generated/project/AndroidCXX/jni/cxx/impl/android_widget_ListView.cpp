...
android_widget_ListView::android_widget_ListView(AndroidCXX::android_content_Context const& arg0,AndroidCXX::android_util_AttributeSet const& arg1)
{
	...
	LOGV("android_widget_ListView className %s methodName %s methodSignature %s", className, methodName, methodSignature);
...
{
	LOGV("bool android_widget_ListView::isOpaque() enter");
...
{
	LOGV("AndroidCXX::android_widget_ListAdapter android_widget_ListView::getAdapter() enter");
...
{
	LOGV("int android_widget_ListView::getMaxScrollAmount() enter");
...
{
	LOGV("int android_widget_ListView::getHeaderViewsCount() enter");
...
{
	LOGV("int android_widget_ListView::getFooterViewsCount() enter");
...
{
	LOGV("void android_widget_ListView::setSelectionAfterHeaderView() enter");
...
{
	LOGV("bool android_widget_ListView::getItemsCanFocus() enter");
...
AndroidCXX::android_graphics_drawable_Drawable android_widget_ListView::getDivider()
{
	LOGV("AndroidCXX::android_graphics_drawable_Drawable android_widget_ListView::getDivider() enter");
...
{
	LOGV("int android_widget_ListView::getDividerHeight() enter");
...
{
	LOGV("AndroidCXX::android_graphics_drawable_Drawable android_widget_ListView::getOverscrollHeader() enter");
...
{
	LOGV("AndroidCXX::android_graphics_drawable_Drawable android_widget_ListView::getOverscrollFooter() enter");
...
{
	LOGV("std::vector<long> android_widget_ListView::getCheckItemIds() enter");
