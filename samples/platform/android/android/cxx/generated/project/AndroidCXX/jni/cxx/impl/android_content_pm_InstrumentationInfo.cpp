...
{
	LOGV("android_content_pm_InstrumentationInfo::android_content_pm_InstrumentationInfo(const android_content_pm_InstrumentationInfo& cc) invoked");
...
{
	LOGV("android_content_pm_InstrumentationInfo::android_content_pm_InstrumentationInfo(void * proxy) invoked");
...
{
	LOGV("android_content_pm_InstrumentationInfo::~android_content_pm_InstrumentationInfo() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
java_lang_String *  android_content_pm_InstrumentationInfo::toString()
{
	const char *methodName = "toString";
	const char *methodSignature = "()Ljava/lang/String;";
	const char *className = "android_content_pm_InstrumentationInfo";
...
void android_content_pm_InstrumentationInfo::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
