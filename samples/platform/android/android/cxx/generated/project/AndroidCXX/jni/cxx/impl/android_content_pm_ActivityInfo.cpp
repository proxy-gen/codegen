...
{
	LOGV("android_content_pm_ActivityInfo::android_content_pm_ActivityInfo(const android_content_pm_ActivityInfo& cc) invoked");
...
{
	LOGV("android_content_pm_ActivityInfo::android_content_pm_ActivityInfo(void * proxy) invoked");
...
{
	LOGV("android_content_pm_ActivityInfo::~android_content_pm_ActivityInfo() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
java_lang_String *  android_content_pm_ActivityInfo::toString()
{
	const char *methodName = "toString";
	const char *methodSignature = "()Ljava/lang/String;";
	const char *className = "android_content_pm_ActivityInfo";
...
void android_content_pm_ActivityInfo::dump(android_util_Printer& arg0,java_lang_String& arg1)
{
...
void android_content_pm_ActivityInfo::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
