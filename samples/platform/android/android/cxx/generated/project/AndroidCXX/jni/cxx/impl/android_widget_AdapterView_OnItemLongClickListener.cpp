...
#define LOG_TAG "android_widget_AdapterView_OnItemLongClickListener"
...
bool android_widget_AdapterView_OnItemLongClickListener::onItemLongClick(android_widget_AdapterView& arg0,android_view_View& arg1,int& arg2,long& arg3)
{
	const char *methodName = "onItemLongClick";
	const char *methodSignature = "(Landroid/widget/AdapterView;Landroid/view/View;IJ)Z";
	const char *className = "android_widget_AdapterView_OnItemLongClickListener";
	...
	LOGV("android_widget_AdapterView_OnItemLongClickListener jni address %d", javaObject);
	...
	jobject jarg0;
	{
		...
		convert_proxy<android_widget_AdapterView>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
