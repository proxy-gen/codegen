...
{
	LOGV("bool android_view_inputmethod_InputConnection::finishComposingText() enter");
...
{
	LOGV("bool android_view_inputmethod_InputConnection::beginBatchEdit() enter");
...
{
	LOGV("bool android_view_inputmethod_InputConnection::endBatchEdit() enter");
