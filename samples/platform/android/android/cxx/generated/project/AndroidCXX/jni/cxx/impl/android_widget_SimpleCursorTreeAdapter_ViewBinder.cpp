...
android_widget_SimpleCursorTreeAdapter_ViewBinder::android_widget_SimpleCursorTreeAdapter_ViewBinder(Proxy proxy)
{
	LOGV("android_widget_SimpleCursorTreeAdapter_ViewBinder::android_widget_SimpleCursorTreeAdapter_ViewBinder(Proxy proxy) enter");
	...
	LOGV("android_widget_SimpleCursorTreeAdapter_ViewBinder::android_widget_SimpleCursorTreeAdapter_ViewBinder(Proxy proxy) exit");
}
Proxy android_widget_SimpleCursorTreeAdapter_ViewBinder::proxy() const
{	
	LOGV("android_widget_SimpleCursorTreeAdapter_ViewBinder::proxy() enter");	
	CXXContext *ctx = CXXContext::sharedInstance();
	...
	LOGV("android_widget_SimpleCursorTreeAdapter_ViewBinder::proxy() exit");	
...
// Functions
bool android_widget_SimpleCursorTreeAdapter_ViewBinder::setViewValue(AndroidCXX::android_view_View const& arg0,AndroidCXX::android_database_Cursor const& arg1,int const& arg2)
{
	LOGV("bool android_widget_SimpleCursorTreeAdapter_ViewBinder::setViewValue(AndroidCXX::android_view_View const& arg0,AndroidCXX::android_database_Cursor const& arg1,int const& arg2) enter");
	...
	LOGV("android_widget_SimpleCursorTreeAdapter_ViewBinder className %s methodName %s methodSignature %s", className, methodName, methodSignature);
	...
	LOGV("bool android_widget_SimpleCursorTreeAdapter_ViewBinder::setViewValue(AndroidCXX::android_view_View const& arg0,AndroidCXX::android_database_Cursor const& arg1,int const& arg2) exit");
