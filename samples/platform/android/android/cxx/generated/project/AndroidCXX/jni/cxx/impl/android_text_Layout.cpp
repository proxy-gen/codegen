...
java_lang_CharSequence *  android_text_Layout::getText()
{
	...
	const char *className = "android_text_Layout";
	...
	LOGV("android_text_Layout jni address %d", javaObject);
...
int android_text_Layout::getWidth()
{
...
int android_text_Layout::getHeight()
{
...
void android_text_Layout::draw(android_graphics_Canvas& arg0,android_graphics_Path& arg1,android_graphics_Paint& arg2,int& arg3)
{
...
android_text_TextPaint *  android_text_Layout::getPaint()
{
...
int android_text_Layout::getLineCount()
{
...
int android_text_Layout::getLineBounds(int& arg0,android_graphics_Rect& arg1)
{
...
float android_text_Layout::getDesiredWidth(java_lang_CharSequence& arg0,int& arg1,android_text_TextPaint& arg2)
{
	const char *methodName = "getDesiredWidth";
	const char *methodSignature = "(Ljava/lang/CharSequence;ILandroid/text/TextPaint;)F";
	const char *className = "android_text_Layout";
...
int android_text_Layout::getEllipsizedWidth()
{
	const char *methodName = "getEllipsizedWidth";
	const char *methodSignature = "()I";
	const char *className = "android_text_Layout";
...
android_text_Layout_Alignment *  android_text_Layout::getAlignment()
{
	...
	android_text_Layout_Alignment *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.text.Layout$Alignment");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_text_Layout_Alignment>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_text_Layout_Alignment * ) (*((android_text_Layout_Alignment *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
float android_text_Layout::getSpacingMultiplier()
{
	const char *methodName = "getSpacingMultiplier";
...
float android_text_Layout::getSpacingAdd()
{
	const char *methodName = "getSpacingAdd";
	const char *methodSignature = "()F";
	const char *className = "android_text_Layout";
...
android_text_Layout_Directions *  android_text_Layout::getLineDirections(int& arg0)
{
	...
	android_text_Layout_Directions *  result;
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.text.Layout$Directions");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_text_Layout_Directions>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_text_Layout_Directions * ) (*((android_text_Layout_Directions *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
int android_text_Layout::getTopPadding()
{
	const char *methodName = "getTopPadding";
	const char *methodSignature = "()I";
	const char *className = "android_text_Layout";
...
int android_text_Layout::getBottomPadding()
{
	const char *methodName = "getBottomPadding";
	const char *methodSignature = "()I";
	const char *className = "android_text_Layout";
...
void android_text_Layout::getCursorPath(int& arg0,android_graphics_Path& arg1,java_lang_CharSequence& arg2)
{
...
void android_text_Layout::getSelectionPath(int& arg0,android_graphics_Path& arg1)
{
	const char *methodName = "getSelectionPath";
	const char *methodSignature = "(ILandroid/graphics/Path;)V";
	const char *className = "android_text_Layout";
...
android_text_Layout_Alignment *  android_text_Layout::getParagraphAlignment(int& arg0)
{
