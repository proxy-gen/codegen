...
// Functions
AndroidCXX::java_lang_CharSequence android_text_Layout::getText()
{
	LOGV("AndroidCXX::java_lang_CharSequence android_text_Layout::getText() enter");
...
{
	LOGV("int android_text_Layout::getWidth() enter");
...
{
	LOGV("int android_text_Layout::getHeight() enter");
...
{
	LOGV("AndroidCXX::android_text_TextPaint android_text_Layout::getPaint() enter");
...
{
	LOGV("int android_text_Layout::getLineCount() enter");
...
{
	LOGV("int android_text_Layout::getEllipsizedWidth() enter");
...
ANDROID_TEXT_LAYOUT_ALIGNMENT::android_text_Layout_Alignment android_text_Layout::getAlignment()
{
	...
	ANDROID_TEXT_LAYOUT_ALIGNMENT::android_text_Layout_Alignment result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
...
{
	LOGV("float android_text_Layout::getSpacingMultiplier() enter");
...
{
	LOGV("float android_text_Layout::getSpacingAdd() enter");
...
AndroidCXX::android_text_Layout_Directions android_text_Layout::getLineDirections(int& arg0)
{
	...
	AndroidCXX::android_text_Layout_Directions result;
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_android_text_Layout_Directions(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (AndroidCXX::android_text_Layout_Directions) (AndroidCXX::android_text_Layout_Directions((AndroidCXX::android_text_Layout_Directions *) cxx_value));
...
{
	LOGV("int android_text_Layout::getTopPadding() enter");
...
{
	LOGV("int android_text_Layout::getBottomPadding() enter");
