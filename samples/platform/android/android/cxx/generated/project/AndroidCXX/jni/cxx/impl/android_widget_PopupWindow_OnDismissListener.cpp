...
android_widget_PopupWindow_OnDismissListener::android_widget_PopupWindow_OnDismissListener(Proxy proxy)
{
	LOGV("android_widget_PopupWindow_OnDismissListener::android_widget_PopupWindow_OnDismissListener(Proxy proxy) enter");
	...
	LOGV("android_widget_PopupWindow_OnDismissListener::android_widget_PopupWindow_OnDismissListener(Proxy proxy) exit");
}
Proxy android_widget_PopupWindow_OnDismissListener::proxy() const
{	
	LOGV("android_widget_PopupWindow_OnDismissListener::proxy() enter");	
	CXXContext *ctx = CXXContext::sharedInstance();
	...
	LOGV("android_widget_PopupWindow_OnDismissListener::proxy() exit");	
...
void android_widget_PopupWindow_OnDismissListener::onDismiss()
{
	...
	LOGV("android_widget_PopupWindow_OnDismissListener className %s methodName %s methodSignature %s", className, methodName, methodSignature);
