...
{
	LOGV("android_view_animation_Transformation::android_view_animation_Transformation(const android_view_animation_Transformation& cc) invoked");
...
{
	LOGV("android_view_animation_Transformation::android_view_animation_Transformation(void * proxy) invoked");
...
{
	LOGV("android_view_animation_Transformation::~android_view_animation_Transformation() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
java_lang_String *  android_view_animation_Transformation::toString()
{
	const char *methodName = "toString";
	const char *methodSignature = "()Ljava/lang/String;";
	const char *className = "android_view_animation_Transformation";
...
void android_view_animation_Transformation::set(android_view_animation_Transformation& arg0)
{
...
void android_view_animation_Transformation::compose(android_view_animation_Transformation& arg0)
{
...
android_graphics_Matrix *  android_view_animation_Transformation::getMatrix()
{
...
java_lang_String *  android_view_animation_Transformation::toShortString()
{
