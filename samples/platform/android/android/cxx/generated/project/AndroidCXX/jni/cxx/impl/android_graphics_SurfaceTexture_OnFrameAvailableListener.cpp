...
android_graphics_SurfaceTexture_OnFrameAvailableListener::android_graphics_SurfaceTexture_OnFrameAvailableListener(Proxy proxy)
{
	LOGV("android_graphics_SurfaceTexture_OnFrameAvailableListener::android_graphics_SurfaceTexture_OnFrameAvailableListener(Proxy proxy) enter");
	...
	LOGV("android_graphics_SurfaceTexture_OnFrameAvailableListener::android_graphics_SurfaceTexture_OnFrameAvailableListener(Proxy proxy) exit");
}
Proxy android_graphics_SurfaceTexture_OnFrameAvailableListener::proxy() const
{	
	LOGV("android_graphics_SurfaceTexture_OnFrameAvailableListener::proxy() enter");	
	CXXContext *ctx = CXXContext::sharedInstance();
	...
	LOGV("android_graphics_SurfaceTexture_OnFrameAvailableListener::proxy() exit");	
...
// Functions
void android_graphics_SurfaceTexture_OnFrameAvailableListener::onFrameAvailable(AndroidCXX::android_graphics_SurfaceTexture const& arg0)
{
	LOGV("void android_graphics_SurfaceTexture_OnFrameAvailableListener::onFrameAvailable(AndroidCXX::android_graphics_SurfaceTexture const& arg0) enter");
	...
	LOGV("android_graphics_SurfaceTexture_OnFrameAvailableListener className %s methodName %s methodSignature %s", className, methodName, methodSignature);
	...
	LOGV("void android_graphics_SurfaceTexture_OnFrameAvailableListener::onFrameAvailable(AndroidCXX::android_graphics_SurfaceTexture const& arg0) exit");
