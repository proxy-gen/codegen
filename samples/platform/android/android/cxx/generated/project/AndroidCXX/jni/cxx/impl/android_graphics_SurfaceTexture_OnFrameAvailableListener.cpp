...
template void convert_proxy<android_graphics_SurfaceTexture>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
void android_graphics_SurfaceTexture_OnFrameAvailableListener::onFrameAvailable(android_graphics_SurfaceTexture& arg0)
{
	...
	const char *className = "android_graphics_SurfaceTexture_OnFrameAvailableListener";
	...
	jobject jarg0;
	{
		...
		convert_proxy<android_graphics_SurfaceTexture>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
