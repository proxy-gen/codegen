...
template void convert_proxy<android_content_SharedPreferences_Editor>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_content_SharedPreferences_OnSharedPreferenceChangeListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Functions
bool android_content_SharedPreferences::getBoolean(java_lang_String& arg0,bool& arg1)
{
	const char *methodName = "getBoolean";
	const char *methodSignature = "(Ljava/lang/String;Z)Z";
	const char *className = "android_content_SharedPreferences";
...
int android_content_SharedPreferences::getInt(java_lang_String& arg0,int& arg1)
{
...
long android_content_SharedPreferences::getLong(java_lang_String& arg0,long& arg1)
{
...
float android_content_SharedPreferences::getFloat(java_lang_String& arg0,float& arg1)
{
...
bool android_content_SharedPreferences::contains(java_lang_String& arg0)
{
...
java_lang_String *  android_content_SharedPreferences::getString(java_lang_String& arg0)
{
...
java_util_Map *  android_content_SharedPreferences::getAll()
{
	const char *methodName = "getAll";
...
java_util_Set *  android_content_SharedPreferences::getStringSet(java_lang_String& arg0,java_util_Set& arg1)
{
...
android_content_SharedPreferences_Editor *  android_content_SharedPreferences::edit()
{
	const char *methodName = "edit";
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_content_SharedPreferences_Editor>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_content_SharedPreferences_Editor * ) (*((android_content_SharedPreferences_Editor *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
void android_content_SharedPreferences::registerOnSharedPreferenceChangeListener(android_content_SharedPreferences_OnSharedPreferenceChangeListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.content.SharedPreferences$OnSharedPreferenceChangeListener");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_content_SharedPreferences_OnSharedPreferenceChangeListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_content_SharedPreferences::unregisterOnSharedPreferenceChangeListener(android_content_SharedPreferences_OnSharedPreferenceChangeListener& arg0)
{
