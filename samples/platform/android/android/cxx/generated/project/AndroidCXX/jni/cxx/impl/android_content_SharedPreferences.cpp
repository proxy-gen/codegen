...
bool android_content_SharedPreferences::getBoolean(AndroidCXX::java_lang_String const& arg0,bool const& arg1)
{
	...
	LOGV("android_content_SharedPreferences className %s methodName %s methodSignature %s", className, methodName, methodSignature);
...
AndroidCXX::java_util_Map android_content_SharedPreferences::getAll()
{
	LOGV("AndroidCXX::java_util_Map android_content_SharedPreferences::getAll() enter");
...
AndroidCXX::android_content_SharedPreferences_Editor android_content_SharedPreferences::edit()
{
	LOGV("AndroidCXX::android_content_SharedPreferences_Editor android_content_SharedPreferences::edit() enter");
...
void android_content_SharedPreferences::registerOnSharedPreferenceChangeListener(AndroidCXX::android_content_SharedPreferences_OnSharedPreferenceChangeListener const& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_android_content_SharedPreferences_OnSharedPreferenceChangeListener(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
