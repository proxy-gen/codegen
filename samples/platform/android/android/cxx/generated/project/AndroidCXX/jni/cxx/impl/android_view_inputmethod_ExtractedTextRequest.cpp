...
{
	LOGV("android_view_inputmethod_ExtractedTextRequest::android_view_inputmethod_ExtractedTextRequest(const android_view_inputmethod_ExtractedTextRequest& cc) invoked");
...
{
	LOGV("android_view_inputmethod_ExtractedTextRequest::android_view_inputmethod_ExtractedTextRequest(void * proxy) invoked");
...
{
	LOGV("android_view_inputmethod_ExtractedTextRequest::~android_view_inputmethod_ExtractedTextRequest() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
int android_view_inputmethod_ExtractedTextRequest::describeContents()
{
	...
	const char *className = "android_view_inputmethod_ExtractedTextRequest";
...
void android_view_inputmethod_ExtractedTextRequest::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
