...
{
	LOGV("android_view_MenuInflater::android_view_MenuInflater(const android_view_MenuInflater& cc) invoked");
...
{
	LOGV("android_view_MenuInflater::android_view_MenuInflater(void * proxy) invoked");
...
{
	LOGV("android_view_MenuInflater::~android_view_MenuInflater() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
void android_view_MenuInflater::inflate(int& arg0,android_view_Menu& arg1)
{
	...
	const char *className = "android_view_MenuInflater";
