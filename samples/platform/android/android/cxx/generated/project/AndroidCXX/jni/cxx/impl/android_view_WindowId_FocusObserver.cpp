...
{	
	...
	LOGV("android_view_WindowId_FocusObserver cxx address %d", cxxAddress);
	long proxiedComponent = (long) ctx->findProxyComponent(cxxAddress);
	LOGV("android_view_WindowId_FocusObserver jni address %d", proxiedComponent);
...
void android_view_WindowId_FocusObserver::onFocusGained(AndroidCXX::android_view_WindowId const& arg0)
{
	...
	LOGV("android_view_WindowId_FocusObserver jni address %d", javaObject);
