...
template void convert_proxy<android_graphics_ColorFilter>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_graphics_Shader>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_graphics_Xfermode>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_graphics_PathEffect>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_graphics_MaskFilter>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_graphics_Rasterizer>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_graphics_Paint_FontMetrics>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_graphics_Paint_FontMetricsInt>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
{
	LOGV("android_graphics_Paint::android_graphics_Paint(const android_graphics_Paint& cc) invoked");
...
{
	LOGV("android_graphics_Paint::android_graphics_Paint(void * proxy) invoked");
...
{
	LOGV("android_graphics_Paint::~android_graphics_Paint() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
void android_graphics_Paint::set(android_graphics_Paint& arg0)
{
	const char *methodName = "set";
	const char *methodSignature = "(Landroid/graphics/Paint;)V";
	const char *className = "android_graphics_Paint";
...
android_graphics_ColorFilter *  android_graphics_Paint::setColorFilter(android_graphics_ColorFilter& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_graphics_ColorFilter>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);

		// Convert to JNI
		jarg0 = convert_jni_java_lang_Object_to_jni(java_value);
	}

	android_graphics_ColorFilter *  result;
	...
	result = (android_graphics_ColorFilter * ) (*((android_graphics_ColorFilter *  *) cxx_value));
...
android_graphics_Paint_Style *  android_graphics_Paint::getStyle()
{
	...
	android_graphics_Paint_Style *  result;
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_graphics_Paint_Style>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
...
void android_graphics_Paint::setStyle(android_graphics_Paint_Style& arg0)
{
...
void android_graphics_Paint::setARGB(int& arg0)
{
...
android_graphics_Paint_Cap *  android_graphics_Paint::getStrokeCap()
{
	...
	android_graphics_Paint_Cap *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_graphics_Paint_Cap>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
...
void android_graphics_Paint::setStrokeCap(android_graphics_Paint_Cap& arg0)
{
...
android_graphics_Paint_Join *  android_graphics_Paint::getStrokeJoin()
{
	...
	android_graphics_Paint_Join *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_graphics_Paint_Join>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
...
void android_graphics_Paint::setStrokeJoin(android_graphics_Paint_Join& arg0)
{
...
bool android_graphics_Paint::getFillPath(android_graphics_Path& arg0)
{
...
android_graphics_Shader *  android_graphics_Paint::getShader()
{
	...
	android_graphics_Shader *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_graphics_Shader>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_graphics_Shader * ) (*((android_graphics_Shader *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
android_graphics_Shader *  android_graphics_Paint::setShader(android_graphics_Shader& arg0)
{
...
android_graphics_ColorFilter *  android_graphics_Paint::getColorFilter()
{
...
android_graphics_Xfermode *  android_graphics_Paint::getXfermode()
{
	...
	android_graphics_Xfermode *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_graphics_Xfermode>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_graphics_Xfermode * ) (*((android_graphics_Xfermode *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
android_graphics_Xfermode *  android_graphics_Paint::setXfermode(android_graphics_Xfermode& arg0)
{
...
android_graphics_PathEffect *  android_graphics_Paint::getPathEffect()
{
	...
	android_graphics_PathEffect *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_graphics_PathEffect>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_graphics_PathEffect * ) (*((android_graphics_PathEffect *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
android_graphics_PathEffect *  android_graphics_Paint::setPathEffect(android_graphics_PathEffect& arg0)
{
...
android_graphics_MaskFilter *  android_graphics_Paint::getMaskFilter()
{
	...
	android_graphics_MaskFilter *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_graphics_MaskFilter>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_graphics_MaskFilter * ) (*((android_graphics_MaskFilter *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
android_graphics_MaskFilter *  android_graphics_Paint::setMaskFilter(android_graphics_MaskFilter& arg0)
{
...
android_graphics_Typeface *  android_graphics_Paint::getTypeface()
{
...
android_graphics_Typeface *  android_graphics_Paint::setTypeface(android_graphics_Typeface& arg0)
{
...
android_graphics_Rasterizer *  android_graphics_Paint::getRasterizer()
{
	...
	android_graphics_Rasterizer *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_graphics_Rasterizer>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_graphics_Rasterizer * ) (*((android_graphics_Rasterizer *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
android_graphics_Rasterizer *  android_graphics_Paint::setRasterizer(android_graphics_Rasterizer& arg0)
{
...
void android_graphics_Paint::setShadowLayer(float& arg0,int& arg1)
{
...
android_graphics_Paint_Align *  android_graphics_Paint::getTextAlign()
{
	...
	android_graphics_Paint_Align *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_graphics_Paint_Align>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
...
void android_graphics_Paint::setTextAlign(android_graphics_Paint_Align& arg0)
{
...
java_util_Locale *  android_graphics_Paint::getTextLocale()
{
...
void android_graphics_Paint::setTextLocale(java_util_Locale& arg0)
{
...
android_graphics_Paint_FontMetrics *  android_graphics_Paint::getFontMetrics(android_graphics_Paint_FontMetrics& arg0)
{
	const char *methodName = "getFontMetrics";
	const char *methodSignature = "(Landroid/graphics/Paint$FontMetrics;)Landroid/graphics/Paint$FontMetrics;";
	const char *className = "android_graphics_Paint";
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_graphics_Paint_FontMetrics>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);

		// Convert to JNI
		jarg0 = convert_jni_java_lang_Object_to_jni(java_value);
	}

	android_graphics_Paint_FontMetrics *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature,jarg0);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
	...
	result = (android_graphics_Paint_FontMetrics * ) (*((android_graphics_Paint_FontMetrics *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
android_graphics_Paint_FontMetricsInt *  android_graphics_Paint::getFontMetricsInt(android_graphics_Paint_FontMetricsInt& arg0)
{
	const char *methodName = "getFontMetricsInt";
	const char *methodSignature = "(Landroid/graphics/Paint$FontMetricsInt;)Landroid/graphics/Paint$FontMetricsInt;";
	const char *className = "android_graphics_Paint";
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_graphics_Paint_FontMetricsInt>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);

		// Convert to JNI
		jarg0 = convert_jni_java_lang_Object_to_jni(java_value);
	}

	android_graphics_Paint_FontMetricsInt *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature,jarg0);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
	...
	result = (android_graphics_Paint_FontMetricsInt * ) (*((android_graphics_Paint_FontMetricsInt *  *) cxx_value));
...
float android_graphics_Paint::measureText(java_lang_String& arg0,int& arg1,java_lang_CharSequence& arg2,std::vector<char>& arg3)
{
	const char *methodName = "measureText";
	const char *methodSignature = "(Ljava/lang/String;ILjava/lang/CharSequence;[[C)F";
	const char *className = "android_graphics_Paint";
...
int android_graphics_Paint::breakText(java_lang_CharSequence& arg0,int& arg1,bool& arg2,float& arg3,std::vector<float>& arg4,java_lang_String& arg5,std::vector<char>& arg6)
{
	const char *methodName = "breakText";
	const char *methodSignature = "(Ljava/lang/CharSequence;IZF[[FLjava/lang/String;[[C)I";
	const char *className = "android_graphics_Paint";
	...
	jcharArray jarg6;
	{
		...
		// Convert to JNI
		jarg6 = convert_jni__char_array_type_to_jni(java_value);
	}

	int result;
	jint jni_result = (jint) jni->invokeIntMethod(javaObject,className,methodName,methodSignature,jarg0,jarg1,jarg2,jarg3,jarg4,jarg5,jarg6);
	long cxx_value = (long) 0;
	long java_value = convert_jni_int_to_java(jni_result);
	{
		CXXTypeHierarchy cxx_type_hierarchy;
...
int android_graphics_Paint::getTextWidths(java_lang_CharSequence& arg0,int& arg1,std::vector<float>& arg2,java_lang_String& arg3,std::vector<char>& arg4)
{
	const char *methodName = "getTextWidths";
	const char *methodSignature = "(Ljava/lang/CharSequence;I[[FLjava/lang/String;[[C)I";
	const char *className = "android_graphics_Paint";
	...
	jcharArray jarg4;
	{
		...
		// Convert to JNI
		jarg4 = convert_jni__char_array_type_to_jni(java_value);
	}
...
void android_graphics_Paint::getTextPath(java_lang_String& arg0,int& arg1,float& arg2,android_graphics_Path& arg3,std::vector<char>& arg4)
{
	const char *methodName = "getTextPath";
	const char *methodSignature = "(Ljava/lang/String;IFLandroid/graphics/Path;[[C)V";
	const char *className = "android_graphics_Paint";
...
void android_graphics_Paint::getTextBounds(java_lang_String& arg0,int& arg1,android_graphics_Rect& arg2,std::vector<char>& arg3)
{
	const char *methodName = "getTextBounds";
	const char *methodSignature = "(Ljava/lang/String;ILandroid/graphics/Rect;[[C)V";
	const char *className = "android_graphics_Paint";
