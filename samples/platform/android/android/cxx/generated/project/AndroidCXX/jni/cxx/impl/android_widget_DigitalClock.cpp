...
{
	LOGV("android_widget_DigitalClock::android_widget_DigitalClock(const android_widget_DigitalClock& cc) invoked");
...
{
	LOGV("android_widget_DigitalClock::android_widget_DigitalClock(void * proxy) invoked");
...
{
	LOGV("android_widget_DigitalClock::~android_widget_DigitalClock() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
void android_widget_DigitalClock::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
	const char *methodName = "onInitializeAccessibilityEvent";
	const char *methodSignature = "(Landroid/view/accessibility/AccessibilityEvent;)V";
	const char *className = "android_widget_DigitalClock";
	...
	LOGV("android_widget_DigitalClock jni address %d", javaObject);
...
void android_widget_DigitalClock::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
