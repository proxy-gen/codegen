...
{
	LOGV("android_widget_GridLayout_LayoutParams::android_widget_GridLayout_LayoutParams(const android_widget_GridLayout_LayoutParams& cc) invoked");
...
{
	LOGV("android_widget_GridLayout_LayoutParams::android_widget_GridLayout_LayoutParams(void * proxy) invoked");
...
{
	LOGV("android_widget_GridLayout_LayoutParams::~android_widget_GridLayout_LayoutParams() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
