...
public:
	...
	// Functions
	 ...
	 bool getBoolean(AndroidCXX::java_lang_String& arg0);
	 bool getBoolean(AndroidCXX::java_lang_String& arg0,bool& arg1);
	 void putBoolean(AndroidCXX::java_lang_String& arg0,bool& arg1);
	 AndroidCXX::java_lang_Byte getByte(AndroidCXX::java_lang_String& arg0,byte& arg1);
	 byte getByte(AndroidCXX::java_lang_String& arg0);
	 void putByte(AndroidCXX::java_lang_String& arg0,byte& arg1);
	 short getShort(AndroidCXX::java_lang_String& arg0,short& arg1);
	 short getShort(AndroidCXX::java_lang_String& arg0);
	 void putShort(AndroidCXX::java_lang_String& arg0,short& arg1);
	 char getChar(AndroidCXX::java_lang_String& arg0,char& arg1);
	 char getChar(AndroidCXX::java_lang_String& arg0);
	 void putChar(AndroidCXX::java_lang_String& arg0,char& arg1);
	 int getInt(AndroidCXX::java_lang_String& arg0);
	 int getInt(AndroidCXX::java_lang_String& arg0,int& arg1);
	 void putInt(AndroidCXX::java_lang_String& arg0,int& arg1);
	 long getLong(AndroidCXX::java_lang_String& arg0,long& arg1);
	 long getLong(AndroidCXX::java_lang_String& arg0);
	 void putLong(AndroidCXX::java_lang_String& arg0,long& arg1);
	 float getFloat(AndroidCXX::java_lang_String& arg0,float& arg1);
	 float getFloat(AndroidCXX::java_lang_String& arg0);
	 void putFloat(AndroidCXX::java_lang_String& arg0,float& arg1);
	 double getDouble(AndroidCXX::java_lang_String& arg0);
	 double getDouble(AndroidCXX::java_lang_String& arg0,double& arg1);
	 void putDouble(AndroidCXX::java_lang_String& arg0,double& arg1);
	 void clear();
	 bool isEmpty();
	 AndroidCXX::java_lang_ClassLoader getClassLoader();
	 int size();
	 void putAll(AndroidCXX::android_os_Bundle& arg0);
	 ...
	 void putStringArrayList(AndroidCXX::java_lang_String& arg0,AndroidCXX::java_util_ArrayList& arg1);
	 void putCharSequenceArrayList(AndroidCXX::java_lang_String& arg0,AndroidCXX::java_util_ArrayList& arg1);
	 void putSerializable(AndroidCXX::java_lang_String& arg0,AndroidCXX::java_io_Serializable& arg1);
	 void putBooleanArray(AndroidCXX::java_lang_String& arg0,std::vector<bool>& arg1);
	 void putByteArray(AndroidCXX::java_lang_String& arg0,std::vector<byte>& arg1);
	 void putShortArray(AndroidCXX::java_lang_String& arg0,std::vector<short>& arg1);
	 void putCharArray(AndroidCXX::java_lang_String& arg0,std::vector<char>& arg1);
	 void putIntArray(AndroidCXX::java_lang_String& arg0,std::vector<int>& arg1);
	 ...
	 AndroidCXX::java_util_ArrayList getIntegerArrayList(AndroidCXX::java_lang_String& arg0);
	 AndroidCXX::java_util_ArrayList getStringArrayList(AndroidCXX::java_lang_String& arg0);
	 AndroidCXX::java_util_ArrayList getCharSequenceArrayList(AndroidCXX::java_lang_String& arg0);
	 std::vector<bool> getBooleanArray(AndroidCXX::java_lang_String& arg0);
	 std::vector<byte> getByteArray(AndroidCXX::java_lang_String& arg0);
	 std::vector<short> getShortArray(AndroidCXX::java_lang_String& arg0);
	 std::vector<char> getCharArray(AndroidCXX::java_lang_String& arg0);
	 std::vector<int> getIntArray(AndroidCXX::java_lang_String& arg0);
