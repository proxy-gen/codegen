...
{
	LOGV("android_view_inputmethod_CorrectionInfo::android_view_inputmethod_CorrectionInfo(const android_view_inputmethod_CorrectionInfo& cc) invoked");
...
{
	LOGV("android_view_inputmethod_CorrectionInfo::android_view_inputmethod_CorrectionInfo(void * proxy) invoked");
...
{
	LOGV("android_view_inputmethod_CorrectionInfo::~android_view_inputmethod_CorrectionInfo() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
java_lang_String *  android_view_inputmethod_CorrectionInfo::toString()
{
	const char *methodName = "toString";
	const char *methodSignature = "()Ljava/lang/String;";
	const char *className = "android_view_inputmethod_CorrectionInfo";
...
void android_view_inputmethod_CorrectionInfo::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
...
java_lang_CharSequence *  android_view_inputmethod_CorrectionInfo::getOldText()
{
...
java_lang_CharSequence *  android_view_inputmethod_CorrectionInfo::getNewText()
{
