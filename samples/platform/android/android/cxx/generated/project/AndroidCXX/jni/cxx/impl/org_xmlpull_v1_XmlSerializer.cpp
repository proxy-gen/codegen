...
template void convert_proxy<java_io_Writer>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
void org_xmlpull_v1_XmlSerializer::setProperty(java_lang_String& arg0,java_lang_Object& arg1)
{
	...
	const char *className = "org_xmlpull_v1_XmlSerializer";
...
org_xmlpull_v1_XmlSerializer *  org_xmlpull_v1_XmlSerializer::text(java_lang_String& arg0,std::vector<char>& arg1,int& arg2)
{
	...
	const char *methodSignature = "(Ljava/lang/String;[[CI)Lorg/xmlpull/v1/XmlSerializer;";
	const char *className = "org_xmlpull_v1_XmlSerializer";
	...
	result = (org_xmlpull_v1_XmlSerializer * ) (*((org_xmlpull_v1_XmlSerializer *  *) cxx_value));
...
void org_xmlpull_v1_XmlSerializer::setOutput(java_io_OutputStream& arg0,java_lang_String& arg1,java_io_Writer& arg2)
{
	...
	const char *methodSignature = "(Ljava/io/OutputStream;Ljava/lang/String;Ljava/io/Writer;)V";
	const char *className = "org_xmlpull_v1_XmlSerializer";
	...
	jobject jarg2;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<java_io_Writer>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
