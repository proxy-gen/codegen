...
#define LOG_TAG "android_widget_ZoomButtonsController_OnZoomListener"
...
void android_widget_ZoomButtonsController_OnZoomListener::onVisibilityChanged(bool const& arg0)
{
	...
	LOGV("android_widget_ZoomButtonsController_OnZoomListener className %s methodName %s methodSignature %s", className, methodName, methodSignature);
	...
	LOGV("android_widget_ZoomButtonsController_OnZoomListener jni address %d", javaObject);
