...
{
	LOGV("android_widget_ViewFlipper::android_widget_ViewFlipper(const android_widget_ViewFlipper& cc) invoked");
...
{
	LOGV("android_widget_ViewFlipper::android_widget_ViewFlipper(void * proxy) invoked");
...
{
	LOGV("android_widget_ViewFlipper::~android_widget_ViewFlipper() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
