...
template void convert_proxy<java_nio_ShortBuffer>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<java_nio_LongBuffer>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<java_nio_FloatBuffer>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<java_nio_DoubleBuffer>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);


unsigned char java_nio_ByteBuffer::get(std::vector<char>& arg0,int& arg1)
{
	const char *methodName = "get";
	const char *methodSignature = "([[BI)B";
...
java_nio_ByteBuffer *  java_nio_ByteBuffer::put(java_nio_ByteBuffer& arg0,std::vector<char>& arg1,unsigned char& arg2,int& arg3)
{
	const char *methodName = "put";
	const char *methodSignature = "(Ljava/nio/ByteBuffer;[[BBI)Ljava/nio/ByteBuffer;";
	const char *className = "java_nio_ByteBuffer";
...
java_nio_ByteBuffer *  java_nio_ByteBuffer::putLong(long& arg0,int& arg1)
{
	const char *methodName = "putLong";
	const char *methodSignature = "(JI)Ljava/nio/ByteBuffer;";
	const char *className = "java_nio_ByteBuffer";
...
java_nio_ByteBuffer *  java_nio_ByteBuffer::putFloat(float& arg0,int& arg1)
{
	const char *methodName = "putFloat";
	const char *methodSignature = "(FI)Ljava/nio/ByteBuffer;";
	const char *className = "java_nio_ByteBuffer";
...
std::vector<char> java_nio_ByteBuffer::array()
{
...
java_nio_ByteBuffer *  java_nio_ByteBuffer::wrap(std::vector<char>& arg0,int& arg1)
{
	const char *methodName = "wrap";
	const char *methodSignature = "([[BI)Ljava/nio/ByteBuffer;";
	const char *className = "java_nio_ByteBuffer";
...
java_nio_ShortBuffer *  java_nio_ByteBuffer::asShortBuffer()
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<java_nio_ShortBuffer>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
...
java_nio_IntBuffer *  java_nio_ByteBuffer::asIntBuffer()
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<java_nio_IntBuffer>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
...
java_nio_FloatBuffer *  java_nio_ByteBuffer::asFloatBuffer()
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<java_nio_FloatBuffer>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
...
java_nio_DoubleBuffer *  java_nio_ByteBuffer::asDoubleBuffer()
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<java_nio_DoubleBuffer>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
