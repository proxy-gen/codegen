...
template void convert_proxy<android_animation_PropertyValuesHolder>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
void android_animation_PropertyValuesHolder::setProperty(android_util_Property& arg0)
{
	...
	const char *className = "android_animation_PropertyValuesHolder";
...
java_lang_String *  android_animation_PropertyValuesHolder::toString()
{
...
android_animation_PropertyValuesHolder *  android_animation_PropertyValuesHolder::clone()
{
	...
	android_animation_PropertyValuesHolder *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_animation_PropertyValuesHolder>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_animation_PropertyValuesHolder * ) (*((android_animation_PropertyValuesHolder *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
void android_animation_PropertyValuesHolder::setPropertyName(java_lang_String& arg0)
{
...
java_lang_String *  android_animation_PropertyValuesHolder::getPropertyName()
{
...
android_animation_PropertyValuesHolder *  android_animation_PropertyValuesHolder::ofInt(java_lang_String& arg0,std::vector<int>& arg1,android_util_Property& arg2)
{
	const char *methodName = "ofInt";
	const char *methodSignature = "(Ljava/lang/String;[[ILandroid/util/Property;)Landroid/animation/PropertyValuesHolder;";
	const char *className = "android_animation_PropertyValuesHolder";
...
android_animation_PropertyValuesHolder *  android_animation_PropertyValuesHolder::ofFloat(android_util_Property& arg0,std::vector<float>& arg1,java_lang_String& arg2)
{
	const char *methodName = "ofFloat";
	const char *methodSignature = "(Landroid/util/Property;[[FLjava/lang/String;)Landroid/animation/PropertyValuesHolder;";
	const char *className = "android_animation_PropertyValuesHolder";
...
android_animation_PropertyValuesHolder *  android_animation_PropertyValuesHolder::ofObject(java_lang_String& arg0,android_animation_TypeEvaluator& arg1,std::vector<long>& arg2,android_util_Property& arg3,android_animation_TypeEvaluator& arg4)
{
	const char *methodName = "ofObject";
	const char *methodSignature = "(Ljava/lang/String;Landroid/animation/TypeEvaluator;[java/lang/ObjectLandroid/util/Property;Landroid/animation/TypeEvaluator;)Landroid/animation/PropertyValuesHolder;";
	const char *className = "android_animation_PropertyValuesHolder";
...
void android_animation_PropertyValuesHolder::setObjectValues(std::vector<long>& arg0)
{
...
void android_animation_PropertyValuesHolder::setEvaluator(android_animation_TypeEvaluator& arg0)
{
...
android_animation_PropertyValuesHolder *  android_animation_PropertyValuesHolder::ofKeyframe(android_util_Property& arg0,std::vector<long>& arg1,java_lang_String& arg2)
{
	const char *methodName = "ofKeyframe";
	const char *methodSignature = "(Landroid/util/Property;[android/animation/KeyframeLjava/lang/String;)Landroid/animation/PropertyValuesHolder;";
	const char *className = "android_animation_PropertyValuesHolder";
	...
	jobjectArray jarg1;
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<android_animation_Keyframe>);				
...
void android_animation_PropertyValuesHolder::setKeyframes(std::vector<long>& arg0)
{
	const char *methodName = "setKeyframes";
	const char *methodSignature = "([android/animation/Keyframe)V";
	const char *className = "android_animation_PropertyValuesHolder";
