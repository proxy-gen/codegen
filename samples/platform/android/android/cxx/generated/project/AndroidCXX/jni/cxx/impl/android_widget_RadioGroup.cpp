...
template void convert_proxy<android_widget_RadioGroup_LayoutParams>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_widget_RadioGroup_OnCheckedChangeListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
android_widget_RadioGroup::android_widget_RadioGroup(const android_widget_RadioGroup& cc)
{
	LOGV("android_widget_RadioGroup::android_widget_RadioGroup(const android_widget_RadioGroup& cc) invoked");
...
{
	LOGV("android_widget_RadioGroup::android_widget_RadioGroup(void * proxy) invoked");
...
{
	LOGV("android_widget_RadioGroup::~android_widget_RadioGroup() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
void android_widget_RadioGroup::check(int& arg0)
{
	...
	const char *className = "android_widget_RadioGroup";
...
void android_widget_RadioGroup::addView(android_view_View& arg0,int& arg1,android_view_ViewGroup_LayoutParams& arg2)
{
...
void android_widget_RadioGroup::setOnHierarchyChangeListener(android_view_ViewGroup_OnHierarchyChangeListener& arg0)
{
...
android_widget_RadioGroup_LayoutParams *  android_widget_RadioGroup::generateLayoutParams(android_util_AttributeSet& arg0)
{
	...
	android_widget_RadioGroup_LayoutParams *  result;
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.widget.RadioGroup$LayoutParams");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_widget_RadioGroup_LayoutParams>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_widget_RadioGroup_LayoutParams * ) (*((android_widget_RadioGroup_LayoutParams *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
void android_widget_RadioGroup::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_RadioGroup::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
void android_widget_RadioGroup::setOnCheckedChangeListener(android_widget_RadioGroup_OnCheckedChangeListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.widget.RadioGroup$OnCheckedChangeListener");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_RadioGroup_OnCheckedChangeListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
{
	const char *methodName = "getCheckedRadioButtonId";
...
void android_widget_RadioGroup::clearCheck()
{
	const char *methodName = "clearCheck";
