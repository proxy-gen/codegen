...
android_widget_RadioGroup::android_widget_RadioGroup(AndroidCXX::android_content_Context const& arg0,AndroidCXX::android_util_AttributeSet const& arg1)
{
	...
	LOGV("android_widget_RadioGroup className %s methodName %s methodSignature %s", className, methodName, methodSignature);
...
void android_widget_RadioGroup::setOnCheckedChangeListener(AndroidCXX::android_widget_RadioGroup_OnCheckedChangeListener const& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_android_widget_RadioGroup_OnCheckedChangeListener(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
{
	LOGV("int android_widget_RadioGroup::getCheckedRadioButtonId() enter");
...
{
	LOGV("void android_widget_RadioGroup::clearCheck() enter");
