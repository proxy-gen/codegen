...
{
	LOGV("android_graphics_Matrix::android_graphics_Matrix(const android_graphics_Matrix& cc) invoked");
...
{
	LOGV("android_graphics_Matrix::android_graphics_Matrix(void * proxy) invoked");
...
{
	LOGV("android_graphics_Matrix::~android_graphics_Matrix() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
