...
AndroidCXX::java_lang_String android_graphics_Matrix::toString()
{
	LOGV("AndroidCXX::java_lang_String android_graphics_Matrix::toString() enter");
...
{
	LOGV("void android_graphics_Matrix::reset() enter");
...
{
	LOGV("AndroidCXX::java_lang_String android_graphics_Matrix::toShortString() enter");
...
{
	LOGV("bool android_graphics_Matrix::isIdentity() enter");
...
{
	LOGV("bool android_graphics_Matrix::rectStaysRect() enter");
...
bool android_graphics_Matrix::setRectToRect(AndroidCXX::android_graphics_RectF& arg0,AndroidCXX::android_graphics_RectF& arg1,ANDROID_GRAPHICS_MATRIX_SCALETOFIT::android_graphics_Matrix_ScaleToFit& arg2)
{
	...
	jobject jarg2;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_android_graphics_Matrix_ScaleToFit(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
