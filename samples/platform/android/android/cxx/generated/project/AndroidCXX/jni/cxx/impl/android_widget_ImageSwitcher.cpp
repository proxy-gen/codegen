...
{
	LOGV("android_widget_ImageSwitcher::android_widget_ImageSwitcher(const android_widget_ImageSwitcher& cc) invoked");
...
{
	LOGV("android_widget_ImageSwitcher::android_widget_ImageSwitcher(void * proxy) invoked");
...
{
	LOGV("android_widget_ImageSwitcher::~android_widget_ImageSwitcher() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
