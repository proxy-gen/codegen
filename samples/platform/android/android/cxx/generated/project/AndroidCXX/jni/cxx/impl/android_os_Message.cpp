...
{
	LOGV("android_os_Message::android_os_Message(const android_os_Message& cc) invoked");
...
{
	LOGV("android_os_Message::android_os_Message(void * proxy) invoked");
...
{
	LOGV("android_os_Message::~android_os_Message() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
java_lang_String *  android_os_Message::toString()
{
	const char *methodName = "toString";
	const char *methodSignature = "()Ljava/lang/String;";
	const char *className = "android_os_Message";
...
android_os_Bundle *  android_os_Message::getData()
{
...
void android_os_Message::copyFrom(android_os_Message& arg0)
{
...
void android_os_Message::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
...
android_os_Message *  android_os_Message::obtain(android_os_Handler& arg0,int& arg1,java_lang_Object& arg2,android_os_Message& arg3,java_lang_Runnable& arg4)
{
	const char *methodName = "obtain";
	const char *methodSignature = "(Landroid/os/Handler;ILjava/lang/Object;Landroid/os/Message;Ljava/lang/Runnable;)Landroid/os/Message;";
	const char *className = "android_os_Message";
...
android_os_Bundle *  android_os_Message::peekData()
{
...
void android_os_Message::setData(android_os_Bundle& arg0)
{
...
java_lang_Runnable *  android_os_Message::getCallback()
{
	...
	result = (java_lang_Runnable * ) (*((java_lang_Runnable *  *) cxx_value));
...
void android_os_Message::setTarget(android_os_Handler& arg0)
{
...
android_os_Handler *  android_os_Message::getTarget()
{
