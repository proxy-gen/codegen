...
void android_support_v4_app_FragmentManager_OnBackStackChangedListener::onBackStackChanged()
{
	...
	LOGV("android_support_v4_app_FragmentManager_OnBackStackChangedListener className %s methodName %s methodSignature %s", className, methodName, methodSignature);
