...
template void convert_proxy<android_widget_AutoCompleteTextView_OnDismissListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_widget_AutoCompleteTextView_Validator>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
{
	LOGV("android_widget_AutoCompleteTextView::android_widget_AutoCompleteTextView(const android_widget_AutoCompleteTextView& cc) invoked");
...
{
	LOGV("android_widget_AutoCompleteTextView::android_widget_AutoCompleteTextView(void * proxy) invoked");
...
{
	LOGV("android_widget_AutoCompleteTextView::~android_widget_AutoCompleteTextView() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
