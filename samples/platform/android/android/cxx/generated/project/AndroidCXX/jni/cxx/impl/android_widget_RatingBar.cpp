...
{
	LOGV("AndroidCXX::android_widget_RatingBar_OnRatingBarChangeListener android_widget_RatingBar::getOnRatingBarChangeListener() enter");
...
{
	LOGV("bool android_widget_RatingBar::isIndicator() enter");
...
{
	LOGV("int android_widget_RatingBar::getNumStars() enter");
...
{
	LOGV("float android_widget_RatingBar::getRating() enter");
...
{
	LOGV("float android_widget_RatingBar::getStepSize() enter");
