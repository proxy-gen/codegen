...
template void convert_proxy<android_widget_RatingBar_OnRatingBarChangeListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
android_widget_RatingBar::android_widget_RatingBar(const android_widget_RatingBar& cc)
{
	LOGV("android_widget_RatingBar::android_widget_RatingBar(const android_widget_RatingBar& cc) invoked");
...
{
	LOGV("android_widget_RatingBar::android_widget_RatingBar(void * proxy) invoked");
...
{
	LOGV("android_widget_RatingBar::~android_widget_RatingBar() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
void android_widget_RatingBar::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
	const char *methodName = "onInitializeAccessibilityEvent";
	const char *methodSignature = "(Landroid/view/accessibility/AccessibilityEvent;)V";
	const char *className = "android_widget_RatingBar";
...
void android_widget_RatingBar::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
void android_widget_RatingBar::setOnRatingBarChangeListener(android_widget_RatingBar_OnRatingBarChangeListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.widget.RatingBar$OnRatingBarChangeListener");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_RatingBar_OnRatingBarChangeListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
android_widget_RatingBar_OnRatingBarChangeListener *  android_widget_RatingBar::getOnRatingBarChangeListener()
{
	const char *methodName = "getOnRatingBarChangeListener";
	...
	android_widget_RatingBar_OnRatingBarChangeListener *  result;
	...
	result = (android_widget_RatingBar_OnRatingBarChangeListener * ) (*((android_widget_RatingBar_OnRatingBarChangeListener *  *) cxx_value));
...
{
	const char *methodName = "isIndicator";
...
{
	const char *methodName = "getNumStars";
...
{
	const char *methodName = "getRating";
...
{
	const char *methodName = "getStepSize";
	const char *methodSignature = "()F";
	const char *className = "android_widget_RatingBar";
