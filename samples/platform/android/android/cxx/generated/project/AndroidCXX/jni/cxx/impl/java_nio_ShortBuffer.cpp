...
// Functions
short java_nio_ShortBuffer::get(std::vector<short>& arg0,int& arg1)
{
	const char *methodName = "get";
	const char *methodSignature = "([[SI)S";
...
java_nio_ShortBuffer *  java_nio_ShortBuffer::put(java_nio_ShortBuffer& arg0,short& arg1,int& arg2,std::vector<short>& arg3)
{
	const char *methodName = "put";
	const char *methodSignature = "(Ljava/nio/ShortBuffer;SI[[S)Ljava/nio/ShortBuffer;";
	const char *className = "java_nio_ShortBuffer";
	...
	jshortArray jarg3;
	{
		...
		// Convert to JNI
		jarg3 = convert_jni__short_array_type_to_jni(java_value);
	}
...
java_nio_ShortBuffer *  java_nio_ShortBuffer::wrap(std::vector<short>& arg0,int& arg1)
{
	const char *methodName = "wrap";
	const char *methodSignature = "([[SI)Ljava/nio/ShortBuffer;";
	const char *className = "java_nio_ShortBuffer";
