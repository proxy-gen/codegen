...
{
	LOGV("java_lang_StackTraceElement::java_lang_StackTraceElement(const java_lang_StackTraceElement& cc) invoked");
...
{
	LOGV("java_lang_StackTraceElement::java_lang_StackTraceElement(void * proxy) invoked");
...
{
	LOGV("java_lang_StackTraceElement::~java_lang_StackTraceElement() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
bool java_lang_StackTraceElement::equals(java_lang_Object& arg0)
{
	const char *methodName = "equals";
	const char *methodSignature = "(Ljava/lang/Object;)Z";
	const char *className = "java_lang_StackTraceElement";
...
java_lang_String *  java_lang_StackTraceElement::toString()
{
...
java_lang_String *  java_lang_StackTraceElement::getFileName()
{
...
java_lang_String *  java_lang_StackTraceElement::getClassName()
{
...
java_lang_String *  java_lang_StackTraceElement::getMethodName()
{
