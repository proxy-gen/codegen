...
template void convert_proxy<java_io_PrintWriter>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_app_FragmentManager>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_app_LoaderManager>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_view_LayoutInflater>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_view_Window>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_app_Application>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_view_WindowManager>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_app_ActionBar>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_view_WindowManager_LayoutParams>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_app_TaskStackBuilder>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_app_PendingIntent>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_content_SharedPreferences>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
{
	LOGV("android_app_Activity::android_app_Activity(const android_app_Activity& cc) invoked");
...
{
	LOGV("android_app_Activity::android_app_Activity(void * proxy) invoked");
...
{
	LOGV("android_app_Activity::~android_app_Activity() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
android_app_Activity *  android_app_Activity::getParent()
{
	const char *methodName = "getParent";
	const char *methodSignature = "()Landroid/app/Activity;";
	const char *className = "android_app_Activity";
...
void android_app_Activity::dump(java_lang_String& arg0,java_io_FileDescriptor& arg1,java_io_PrintWriter& arg2,std::vector<long>& arg3)
{
	const char *methodName = "dump";
	const char *methodSignature = "(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[java/lang/String)V";
	const char *className = "android_app_Activity";
...
android_app_FragmentManager *  android_app_Activity::getFragmentManager()
{
	...
	android_app_FragmentManager *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_app_FragmentManager>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_app_FragmentManager * ) (*((android_app_FragmentManager *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
android_app_LoaderManager *  android_app_Activity::getLoaderManager()
{
	...
	android_app_LoaderManager *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_app_LoaderManager>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_app_LoaderManager * ) (*((android_app_LoaderManager *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
void android_app_Activity::startActivity(android_content_Intent& arg0,android_os_Bundle& arg1)
{
...
void android_app_Activity::startActivityForResult(android_content_Intent& arg0,int& arg1,android_os_Bundle& arg2)
{
...
android_view_LayoutInflater *  android_app_Activity::getLayoutInflater()
{
	...
	android_view_LayoutInflater *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_view_LayoutInflater>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_view_LayoutInflater * ) (*((android_view_LayoutInflater *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
android_view_View *  android_app_Activity::onCreateView(android_view_View& arg0,java_lang_String& arg1,android_content_Context& arg2,android_util_AttributeSet& arg3)
{
...
void android_app_Activity::onConfigurationChanged(android_content_res_Configuration& arg0)
{
...
bool android_app_Activity::onCreateOptionsMenu(android_view_Menu& arg0)
{
...
bool android_app_Activity::onPrepareOptionsMenu(android_view_Menu& arg0)
{
...
bool android_app_Activity::onOptionsItemSelected(android_view_MenuItem& arg0)
{
...
void android_app_Activity::onOptionsMenuClosed(android_view_Menu& arg0)
{
...
void android_app_Activity::onCreateContextMenu(android_view_ContextMenu& arg0,android_view_View& arg1,android_view_ContextMenu_ContextMenuInfo& arg2)
{
...
void android_app_Activity::registerForContextMenu(android_view_View& arg0)
{
...
void android_app_Activity::unregisterForContextMenu(android_view_View& arg0)
{
...
bool android_app_Activity::onContextItemSelected(android_view_MenuItem& arg0)
{
...
void android_app_Activity::startActivityFromFragment(android_app_Fragment& arg0,android_content_Intent& arg1,int& arg2,android_os_Bundle& arg3)
{
...
android_view_View *  android_app_Activity::findViewById(int& arg0)
{
...
android_view_Window *  android_app_Activity::getWindow()
{
...
void android_app_Activity::onAttachFragment(android_app_Fragment& arg0)
{
...
void android_app_Activity::startActivities(std::vector<long>& arg0,android_os_Bundle& arg1)
{
...
void android_app_Activity::startIntentSender(android_content_IntentSender& arg0,android_content_Intent& arg1,int& arg2,android_os_Bundle& arg3)
{
...
java_lang_Object *  android_app_Activity::getSystemService(java_lang_String& arg0)
{
...
bool android_app_Activity::onCreatePanelMenu(int& arg0,android_view_Menu& arg1)
{
...
bool android_app_Activity::onKeyDown(int& arg0,android_view_KeyEvent& arg1)
{
...
bool android_app_Activity::onMenuItemSelected(int& arg0,android_view_MenuItem& arg1)
{
...
void android_app_Activity::onPanelClosed(int& arg0,android_view_Menu& arg1)
{
...
bool android_app_Activity::onPreparePanel(int& arg0,android_view_View& arg1,android_view_Menu& arg2)
{
...
java_lang_Object *  android_app_Activity::onRetainNonConfigurationInstance()
{
...
java_lang_Object *  android_app_Activity::getLastNonConfigurationInstance()
{
...
android_view_MenuInflater *  android_app_Activity::getMenuInflater()
{
...
android_content_Intent *  android_app_Activity::getIntent()
{
...
void android_app_Activity::setIntent(android_content_Intent& arg0)
{
...
android_app_Application *  android_app_Activity::getApplication()
{
	...
	android_app_Application *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_app_Application>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_app_Application * ) (*((android_app_Application *  *) cxx_value));
...
android_view_WindowManager *  android_app_Activity::getWindowManager()
{
	...
	android_view_WindowManager *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_view_WindowManager>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_view_WindowManager * ) (*((android_view_WindowManager *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
android_view_View *  android_app_Activity::getCurrentFocus()
{
...
bool android_app_Activity::onCreateThumbnail(android_graphics_Bitmap& arg0,android_graphics_Canvas& arg1)
{
...
java_lang_CharSequence *  android_app_Activity::onCreateDescription()
{
...
android_database_Cursor *  android_app_Activity::managedQuery(android_net_Uri& arg0,std::vector<long>& arg1,java_lang_String& arg2)
{
	const char *methodName = "managedQuery";
	const char *methodSignature = "(Landroid/net/Uri;[java/lang/StringLjava/lang/String;)Landroid/database/Cursor;";
	const char *className = "android_app_Activity";
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_database_Cursor>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_database_Cursor * ) (*((android_database_Cursor *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
void android_app_Activity::startManagingCursor(android_database_Cursor& arg0)
{
...
void android_app_Activity::stopManagingCursor(android_database_Cursor& arg0)
{
...
android_app_ActionBar *  android_app_Activity::getActionBar()
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_app_ActionBar>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_app_ActionBar * ) (*((android_app_ActionBar *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
void android_app_Activity::setContentView(android_view_View& arg0,int& arg1,android_view_ViewGroup_LayoutParams& arg2)
{
...
void android_app_Activity::addContentView(android_view_View& arg0,android_view_ViewGroup_LayoutParams& arg1)
{
...
bool android_app_Activity::onKeyLongPress(int& arg0,android_view_KeyEvent& arg1)
{
...
bool android_app_Activity::onKeyUp(int& arg0,android_view_KeyEvent& arg1)
{
...
bool android_app_Activity::onKeyMultiple(int& arg0,android_view_KeyEvent& arg1)
{
...
bool android_app_Activity::onKeyShortcut(int& arg0,android_view_KeyEvent& arg1)
{
...
bool android_app_Activity::onTouchEvent(android_view_MotionEvent& arg0)
{
...
bool android_app_Activity::onTrackballEvent(android_view_MotionEvent& arg0)
{
...
bool android_app_Activity::onGenericMotionEvent(android_view_MotionEvent& arg0)
{
...
void android_app_Activity::onWindowAttributesChanged(android_view_WindowManager_LayoutParams& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_view_WindowManager_LayoutParams>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
bool android_app_Activity::dispatchKeyEvent(android_view_KeyEvent& arg0)
{
...
bool android_app_Activity::dispatchKeyShortcutEvent(android_view_KeyEvent& arg0)
{
...
bool android_app_Activity::dispatchTouchEvent(android_view_MotionEvent& arg0)
{
...
bool android_app_Activity::dispatchTrackballEvent(android_view_MotionEvent& arg0)
{
...
bool android_app_Activity::dispatchGenericMotionEvent(android_view_MotionEvent& arg0)
{
...
bool android_app_Activity::dispatchPopulateAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
android_view_View *  android_app_Activity::onCreatePanelView(int& arg0)
{
...
bool android_app_Activity::onMenuOpened(int& arg0,android_view_Menu& arg1)
{
...
bool android_app_Activity::onNavigateUpFromChild(android_app_Activity& arg0)
{
...
void android_app_Activity::onCreateNavigateUpTaskStack(android_app_TaskStackBuilder& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_app_TaskStackBuilder>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_app_Activity::onPrepareNavigateUpTaskStack(android_app_TaskStackBuilder& arg0)
{
...
void android_app_Activity::openContextMenu(android_view_View& arg0)
{
...
void android_app_Activity::onContextMenuClosed(android_view_Menu& arg0)
{
...
bool android_app_Activity::showDialog(int& arg0,android_os_Bundle& arg1)
{
...
void android_app_Activity::startSearch(java_lang_String& arg0,bool& arg1,android_os_Bundle& arg2)
{
	const char *methodName = "startSearch";
	const char *methodSignature = "(Ljava/lang/String;ZLandroid/os/Bundle;)V";
	const char *className = "android_app_Activity";
...
void android_app_Activity::triggerSearch(java_lang_String& arg0,android_os_Bundle& arg1)
{
...
void android_app_Activity::setFeatureDrawableResource(int& arg0)
{
...
void android_app_Activity::setFeatureDrawableUri(int& arg0,android_net_Uri& arg1)
{
...
void android_app_Activity::setFeatureDrawable(int& arg0,android_graphics_drawable_Drawable& arg1)
{
...
void android_app_Activity::setFeatureDrawableAlpha(int& arg0)
{
...
void android_app_Activity::startIntentSenderForResult(android_content_IntentSender& arg0,int& arg1,android_content_Intent& arg2,android_os_Bundle& arg3)
{
	const char *methodName = "startIntentSenderForResult";
	const char *methodSignature = "(Landroid/content/IntentSender;ILandroid/content/Intent;Landroid/os/Bundle;)V";
	const char *className = "android_app_Activity";
...
bool android_app_Activity::startActivityIfNeeded(android_content_Intent& arg0,int& arg1,android_os_Bundle& arg2)
{
...
bool android_app_Activity::startNextMatchingActivity(android_content_Intent& arg0,android_os_Bundle& arg1)
{
...
void android_app_Activity::startActivityFromChild(android_app_Activity& arg0,android_content_Intent& arg1,int& arg2,android_os_Bundle& arg3)
{
...
void android_app_Activity::startIntentSenderFromChild(android_app_Activity& arg0,android_content_IntentSender& arg1,int& arg2,android_content_Intent& arg3,android_os_Bundle& arg4)
{
	const char *methodName = "startIntentSenderFromChild";
	const char *methodSignature = "(Landroid/app/Activity;Landroid/content/IntentSender;ILandroid/content/Intent;Landroid/os/Bundle;)V";
	const char *className = "android_app_Activity";
...
void android_app_Activity::overridePendingTransition(int& arg0)
{
...
void android_app_Activity::setResult(int& arg0,android_content_Intent& arg1)
{
...
java_lang_String *  android_app_Activity::getCallingPackage()
{
...
android_content_ComponentName *  android_app_Activity::getCallingActivity()
{
...
void android_app_Activity::finishFromChild(android_app_Activity& arg0)
{
...
void android_app_Activity::finishActivityFromChild(android_app_Activity& arg0,int& arg1)
{
...
android_app_PendingIntent *  android_app_Activity::createPendingResult(int& arg0,android_content_Intent& arg1)
{
	const char *methodName = "createPendingResult";
	const char *methodSignature = "(ILandroid/content/Intent;)Landroid/app/PendingIntent;";
	const char *className = "android_app_Activity";
	...
	android_app_PendingIntent *  result;
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_app_PendingIntent>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_app_PendingIntent * ) (*((android_app_PendingIntent *  *) cxx_value));
...
java_lang_String *  android_app_Activity::getLocalClassName()
{
...
android_content_ComponentName *  android_app_Activity::getComponentName()
{
...
android_content_SharedPreferences *  android_app_Activity::getPreferences(int& arg0)
{
...
void android_app_Activity::setTitle(java_lang_CharSequence& arg0,int& arg1)
{
...
java_lang_CharSequence *  android_app_Activity::getTitle()
{
...
void android_app_Activity::runOnUiThread(java_lang_Runnable& arg0)
{
...
android_view_ActionMode *  android_app_Activity::startActionMode(android_view_ActionMode_Callback& arg0)
{
...
android_view_ActionMode *  android_app_Activity::onWindowStartingActionMode(android_view_ActionMode_Callback& arg0)
{
...
void android_app_Activity::onActionModeStarted(android_view_ActionMode& arg0)
{
...
void android_app_Activity::onActionModeFinished(android_view_ActionMode& arg0)
{
...
bool android_app_Activity::shouldUpRecreateTask(android_content_Intent& arg0)
{
...
bool android_app_Activity::navigateUpTo(android_content_Intent& arg0)
{
...
bool android_app_Activity::navigateUpToFromChild(android_app_Activity& arg0,android_content_Intent& arg1)
{
...
android_content_Intent *  android_app_Activity::getParentActivityIntent()
{
