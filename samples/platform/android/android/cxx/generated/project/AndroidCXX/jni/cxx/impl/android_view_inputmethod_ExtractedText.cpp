...
{
	LOGV("android_view_inputmethod_ExtractedText::android_view_inputmethod_ExtractedText(const android_view_inputmethod_ExtractedText& cc) invoked");
...
{
	LOGV("android_view_inputmethod_ExtractedText::android_view_inputmethod_ExtractedText(void * proxy) invoked");
...
{
	LOGV("android_view_inputmethod_ExtractedText::~android_view_inputmethod_ExtractedText() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
int android_view_inputmethod_ExtractedText::describeContents()
{
	...
	const char *className = "android_view_inputmethod_ExtractedText";
...
void android_view_inputmethod_ExtractedText::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
