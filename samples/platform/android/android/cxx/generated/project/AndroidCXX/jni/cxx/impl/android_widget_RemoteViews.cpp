...
// Functions
AndroidCXX::android_widget_RemoteViews android_widget_RemoteViews::clone()
{
	LOGV("AndroidCXX::android_widget_RemoteViews android_widget_RemoteViews::clone() enter");
...
AndroidCXX::java_lang_String android_widget_RemoteViews::getPackage()
{
	LOGV("AndroidCXX::java_lang_String android_widget_RemoteViews::getPackage() enter");
...
{
	LOGV("int android_widget_RemoteViews::describeContents() enter");
...
{
	LOGV("int android_widget_RemoteViews::getLayoutId() enter");
