...
{
	LOGV("android_widget_CheckedTextView::android_widget_CheckedTextView(const android_widget_CheckedTextView& cc) invoked");
...
{
	LOGV("android_widget_CheckedTextView::android_widget_CheckedTextView(void * proxy) invoked");
...
{
	LOGV("android_widget_CheckedTextView::~android_widget_CheckedTextView() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
