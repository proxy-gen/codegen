...
{
	LOGV("bool android_widget_CheckedTextView::isChecked() enter");
...
{
	LOGV("void android_widget_CheckedTextView::toggle() enter");
...
{
	LOGV("AndroidCXX::android_graphics_drawable_Drawable android_widget_CheckedTextView::getCheckMarkDrawable() enter");
