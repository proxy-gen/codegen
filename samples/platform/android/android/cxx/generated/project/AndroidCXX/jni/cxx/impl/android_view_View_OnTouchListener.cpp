...
// Functions
bool android_view_View_OnTouchListener::onTouch(android_view_View& arg0,android_view_MotionEvent& arg1)
{
	const char *methodName = "onTouch";
	const char *methodSignature = "(Landroid/view/View;Landroid/view/MotionEvent;)Z";
	const char *className = "android_view_View_OnTouchListener";
