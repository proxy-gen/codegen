...
template void convert_proxy<android_content_ContentProviderOperation_Builder>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_content_ContentProviderResult>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
java_lang_String *  android_content_ContentProviderOperation::toString()
{
	...
	const char *className = "android_content_ContentProviderOperation";
...
void android_content_ContentProviderOperation::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
...
android_content_ContentProviderOperation_Builder *  android_content_ContentProviderOperation::newInsert(android_net_Uri& arg0)
{
...
android_content_ContentProviderOperation_Builder *  android_content_ContentProviderOperation::newUpdate(android_net_Uri& arg0)
{
...
android_content_ContentProviderOperation_Builder *  android_content_ContentProviderOperation::newDelete(android_net_Uri& arg0)
{
...
android_content_ContentProviderOperation_Builder *  android_content_ContentProviderOperation::newAssertQuery(android_net_Uri& arg0)
{
...
android_net_Uri *  android_content_ContentProviderOperation::getUri()
{
...
android_content_ContentProviderResult *  android_content_ContentProviderOperation::apply(android_content_ContentProvider& arg0,std::vector<long>& arg1,int& arg2)
{
	const char *methodName = "apply";
	const char *methodSignature = "(Landroid/content/ContentProvider;[android/content/ContentProviderResultI)Landroid/content/ContentProviderResult;";
	const char *className = "android_content_ContentProviderOperation";
	...
	android_content_ContentProviderResult *  result;
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_content_ContentProviderResult>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_content_ContentProviderResult * ) (*((android_content_ContentProviderResult *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
android_content_ContentValues *  android_content_ContentProviderOperation::resolveValueBackReferences(std::vector<long>& arg0,int& arg1)
{
	const char *methodName = "resolveValueBackReferences";
	const char *methodSignature = "([android/content/ContentProviderResultI)Landroid/content/ContentValues;";
	const char *className = "android_content_ContentProviderOperation";
	...
	android_content_ContentValues *  result;
	...
	result = (android_content_ContentValues * ) (*((android_content_ContentValues *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
std::vector<long> android_content_ContentProviderOperation::resolveSelectionArgsBackReferences(std::vector<long>& arg0,int& arg1)
{
	const char *methodName = "resolveSelectionArgsBackReferences";
	const char *methodSignature = "([android/content/ContentProviderResultI)[java/lang/String";
	const char *className = "android_content_ContentProviderOperation";
