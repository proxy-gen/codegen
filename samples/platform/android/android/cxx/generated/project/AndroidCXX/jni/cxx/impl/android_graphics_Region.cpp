...
bool android_graphics_Region::equals(java_lang_Object& arg0)
{
	const char *methodName = "equals";
	const char *methodSignature = "(Ljava/lang/Object;)Z";
	const char *className = "android_graphics_Region";
...
java_lang_String *  android_graphics_Region::toString()
{
...
bool android_graphics_Region::isEmpty()
{
...
bool android_graphics_Region::contains(int& arg0)
{
...
bool android_graphics_Region::set(int& arg0,android_graphics_Rect& arg1,android_graphics_Region& arg2)
{
	const char *methodName = "set";
	const char *methodSignature = "(ILandroid/graphics/Rect;Landroid/graphics/Region;)Z";
	const char *className = "android_graphics_Region";
...
bool android_graphics_Region::_union(android_graphics_Rect& arg0)
{
...
bool android_graphics_Region::getBounds(android_graphics_Rect& arg0)
{
...
int android_graphics_Region::describeContents()
{
...
void android_graphics_Region::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
...
void android_graphics_Region::translate(int& arg0,android_graphics_Region& arg1)
{
	const char *methodName = "translate";
	const char *methodSignature = "(ILandroid/graphics/Region;)V";
	const char *className = "android_graphics_Region";
...
bool android_graphics_Region::op(android_graphics_Rect& arg0,android_graphics_Region& arg1,android_graphics_Region_Op& arg2,int& arg3)
{
	const char *methodName = "op";
	const char *methodSignature = "(Landroid/graphics/Rect;Landroid/graphics/Region;Landroid/graphics/Region$Op;I)Z";
	const char *className = "android_graphics_Region";
...
bool android_graphics_Region::quickReject(android_graphics_Rect& arg0,int& arg1,android_graphics_Region& arg2)
{
	const char *methodName = "quickReject";
	const char *methodSignature = "(Landroid/graphics/Rect;ILandroid/graphics/Region;)Z";
	const char *className = "android_graphics_Region";
...
bool android_graphics_Region::setPath(android_graphics_Path& arg0,android_graphics_Region& arg1)
{
...
bool android_graphics_Region::isRect()
{
...
bool android_graphics_Region::isComplex()
{
	const char *methodName = "isComplex";
	const char *methodSignature = "()Z";
	const char *className = "android_graphics_Region";
...
android_graphics_Path *  android_graphics_Region::getBoundaryPath(android_graphics_Path& arg0)
{
	const char *methodName = "getBoundaryPath";
	const char *methodSignature = "(Landroid/graphics/Path;)Landroid/graphics/Path;";
	const char *className = "android_graphics_Region";
	...
	result = (android_graphics_Path * ) (*((android_graphics_Path *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
bool android_graphics_Region::quickContains(int& arg0,android_graphics_Rect& arg1)
{
