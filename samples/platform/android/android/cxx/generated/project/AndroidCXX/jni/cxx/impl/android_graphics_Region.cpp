...
{
	LOGV("android_graphics_Region::android_graphics_Region(const android_graphics_Region& cc) invoked");
...
{
	LOGV("android_graphics_Region::android_graphics_Region(void * proxy) invoked");
...
{
	LOGV("android_graphics_Region::~android_graphics_Region() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
