...
{
	LOGV("android_widget_VideoView::android_widget_VideoView(const android_widget_VideoView& cc) invoked");
...
{
	LOGV("android_widget_VideoView::android_widget_VideoView(void * proxy) invoked");
...
{
	LOGV("android_widget_VideoView::~android_widget_VideoView() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
