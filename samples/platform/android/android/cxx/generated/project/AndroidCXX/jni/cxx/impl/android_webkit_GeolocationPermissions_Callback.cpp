...
// Functions
void android_webkit_GeolocationPermissions_Callback::invoke(java_lang_String& arg0,bool& arg1)
{
	const char *methodName = "invoke";
	const char *methodSignature = "(Ljava/lang/String;Z)V";
	const char *className = "android_webkit_GeolocationPermissions_Callback";
