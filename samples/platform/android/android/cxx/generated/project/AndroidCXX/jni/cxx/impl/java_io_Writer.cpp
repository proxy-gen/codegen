...
java_io_Writer *  java_io_Writer::append(java_lang_CharSequence& arg0,int& arg1,char& arg2)
{
	...
	const char *methodSignature = "(Ljava/lang/CharSequence;IC)Ljava/io/Writer;";
	const char *className = "java_io_Writer";
	...
	result = (java_io_Writer * ) (*((java_io_Writer *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
void java_io_Writer::write(std::vector<char>& arg0,int& arg1,java_lang_String& arg2)
{
