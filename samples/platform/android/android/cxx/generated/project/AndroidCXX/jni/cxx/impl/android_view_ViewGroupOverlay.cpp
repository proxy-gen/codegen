...
{	
	...
	LOGV("android_view_ViewGroupOverlay cxx address %d", cxxAddress);
	long proxiedComponent = (long) ctx->findProxyComponent(cxxAddress);
	LOGV("android_view_ViewGroupOverlay jni address %d", proxiedComponent);
...
void android_view_ViewGroupOverlay::add(AndroidCXX::android_view_View const& arg0)
{
	...
	LOGV("android_view_ViewGroupOverlay jni address %d", javaObject);
