...
void android_widget_AbsListView_MultiChoiceModeListener::onItemCheckedStateChanged(android_view_ActionMode& arg0,int& arg1,long& arg2,bool& arg3)
{
	const char *methodName = "onItemCheckedStateChanged";
	const char *methodSignature = "(Landroid/view/ActionMode;IJZ)V";
	const char *className = "android_widget_AbsListView_MultiChoiceModeListener";
