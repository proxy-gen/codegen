...
template void convert_proxy<android_app_FragmentManager_BackStackEntry>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_app_FragmentManager_OnBackStackChangedListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
bool android_app_FragmentManager::isDestroyed()
{
	...
	const char *className = "android_app_FragmentManager";
...
android_app_Fragment *  android_app_FragmentManager::getFragment(android_os_Bundle& arg0,java_lang_String& arg1)
{
...
void android_app_FragmentManager::dump(java_lang_String& arg0,java_io_FileDescriptor& arg1,java_io_PrintWriter& arg2,std::vector<long>& arg3)
{
...
android_app_FragmentTransaction *  android_app_FragmentManager::beginTransaction()
{
...
android_app_Fragment *  android_app_FragmentManager::findFragmentById(int& arg0)
{
...
android_app_Fragment *  android_app_FragmentManager::findFragmentByTag(java_lang_String& arg0)
{
...
void android_app_FragmentManager::popBackStack(int& arg0,java_lang_String& arg1)
{
...
bool android_app_FragmentManager::popBackStackImmediate(int& arg0,java_lang_String& arg1)
{
...
android_app_FragmentManager_BackStackEntry *  android_app_FragmentManager::getBackStackEntryAt(int& arg0)
{
	...
	android_app_FragmentManager_BackStackEntry *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature,jarg0);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_app_FragmentManager_BackStackEntry>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_app_FragmentManager_BackStackEntry * ) (*((android_app_FragmentManager_BackStackEntry *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
void android_app_FragmentManager::addOnBackStackChangedListener(android_app_FragmentManager_OnBackStackChangedListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_app_FragmentManager_OnBackStackChangedListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_app_FragmentManager::removeOnBackStackChangedListener(android_app_FragmentManager_OnBackStackChangedListener& arg0)
{
...
void android_app_FragmentManager::putFragment(android_os_Bundle& arg0,java_lang_String& arg1,android_app_Fragment& arg2)
{
...
android_app_Fragment_SavedState *  android_app_FragmentManager::saveFragmentInstanceState(android_app_Fragment& arg0)
{
	...
	android_app_Fragment_SavedState *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature,jarg0);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
	...
	result = (android_app_Fragment_SavedState * ) (*((android_app_Fragment_SavedState *  *) cxx_value));
