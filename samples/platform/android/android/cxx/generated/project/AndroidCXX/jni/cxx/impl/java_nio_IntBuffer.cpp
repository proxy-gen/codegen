...
java_nio_IntBuffer *  java_nio_IntBuffer::put(java_nio_IntBuffer& arg0,int& arg1,std::vector<int>& arg2)
{
	const char *methodName = "put";
	const char *methodSignature = "(Ljava/nio/IntBuffer;I[[I)Ljava/nio/IntBuffer;";
	const char *className = "java_nio_IntBuffer";
...
java_nio_IntBuffer *  java_nio_IntBuffer::wrap(std::vector<int>& arg0,int& arg1)
{
