...
void android_view_View_OnLayoutChangeListener::onLayoutChange(android_view_View& arg0,int& arg1)
{
	const char *methodName = "onLayoutChange";
	const char *methodSignature = "(Landroid/view/View;I)V";
	const char *className = "android_view_View_OnLayoutChangeListener";
	...
	LOGV("android_view_View_OnLayoutChangeListener jni address %d", javaObject);
