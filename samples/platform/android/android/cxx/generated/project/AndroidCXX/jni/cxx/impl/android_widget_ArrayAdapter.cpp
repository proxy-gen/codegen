...
template void convert_proxy<android_widget_ArrayAdapter>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
android_widget_ArrayAdapter::android_widget_ArrayAdapter(const android_widget_ArrayAdapter& cc)
{
	LOGV("android_widget_ArrayAdapter::android_widget_ArrayAdapter(const android_widget_ArrayAdapter& cc) invoked");
...
{
	LOGV("android_widget_ArrayAdapter::android_widget_ArrayAdapter(void * proxy) invoked");
...
{
	LOGV("android_widget_ArrayAdapter::~android_widget_ArrayAdapter() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
void android_widget_ArrayAdapter::add(java_lang_Object& arg0)
{
	const char *methodName = "add";
	const char *methodSignature = "(Ljava/lang/Object;)V";
	const char *className = "android_widget_ArrayAdapter";
...
void android_widget_ArrayAdapter::addAll(java_util_Collection& arg0,std::vector<long>& arg1)
{
	const char *methodName = "addAll";
	const char *methodSignature = "(Ljava/util/Collection;[java/lang/Object)V";
	const char *className = "android_widget_ArrayAdapter";
...
void android_widget_ArrayAdapter::remove(java_lang_Object& arg0)
{
...
android_content_Context *  android_widget_ArrayAdapter::getContext()
{
...
void android_widget_ArrayAdapter::insert(java_lang_Object& arg0,int& arg1)
{
...
void android_widget_ArrayAdapter::sort(java_util_Comparator& arg0)
{
...
int android_widget_ArrayAdapter::getPosition(java_lang_Object& arg0)
{
...
android_view_View *  android_widget_ArrayAdapter::getView(int& arg0,android_view_View& arg1,android_view_ViewGroup& arg2)
{
...
android_widget_Filter *  android_widget_ArrayAdapter::getFilter()
{
...
java_lang_Object *  android_widget_ArrayAdapter::getItem(int& arg0)
{
...
int android_widget_ArrayAdapter::getCount()
{
...
android_view_View *  android_widget_ArrayAdapter::getDropDownView(int& arg0,android_view_View& arg1,android_view_ViewGroup& arg2)
{
...
void android_widget_ArrayAdapter::notifyDataSetChanged()
{
...
android_widget_ArrayAdapter *  android_widget_ArrayAdapter::createFromResource(android_content_Context& arg0,int& arg1)
{
	const char *methodName = "createFromResource";
	const char *methodSignature = "(Landroid/content/Context;I)Landroid/widget/ArrayAdapter;";
	const char *className = "android_widget_ArrayAdapter";
	...
	android_widget_ArrayAdapter *  result;
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.widget.ArrayAdapter");
			{
				CXXTypeHierarchy child_cxx_type_hierarchy;
				cxx_type_hierarchy.child_types.push_back(child_cxx_type_hierarchy);
				cxx_type_hierarchy_stack.push(child_cxx_type_hierarchy);
		...
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_widget_ArrayAdapter>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_widget_ArrayAdapter * ) (*((android_widget_ArrayAdapter *  *) cxx_value));
