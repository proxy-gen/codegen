...
android_widget_ArrayAdapter::android_widget_ArrayAdapter(AndroidCXX::android_content_Context const& arg0,int const& arg1)
{
	...
	LOGV("android_widget_ArrayAdapter className %s methodName %s methodSignature %s", className, methodName, methodSignature);
...
{
	LOGV("void android_widget_ArrayAdapter::clear() enter");
...
{
	LOGV("AndroidCXX::android_content_Context android_widget_ArrayAdapter::getContext() enter");
...
AndroidCXX::android_widget_Filter android_widget_ArrayAdapter::getFilter()
{
	LOGV("AndroidCXX::android_widget_Filter android_widget_ArrayAdapter::getFilter() enter");
...
{
	LOGV("int android_widget_ArrayAdapter::getCount() enter");
...
{
	LOGV("void android_widget_ArrayAdapter::notifyDataSetChanged() enter");
