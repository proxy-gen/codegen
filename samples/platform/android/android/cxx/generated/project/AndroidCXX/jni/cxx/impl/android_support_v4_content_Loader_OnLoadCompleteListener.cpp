...
#define LOG_TAG "android_support_v4_content_Loader_OnLoadCompleteListener"
...
void android_support_v4_content_Loader_OnLoadCompleteListener::onLoadComplete(android_support_v4_content_Loader& arg0,java_lang_Object& arg1)
{
	const char *methodName = "onLoadComplete";
	const char *methodSignature = "(Landroid/support/v4/content/Loader;Ljava/lang/Object;)V";
	const char *className = "android_support_v4_content_Loader_OnLoadCompleteListener";
	...
	LOGV("android_support_v4_content_Loader_OnLoadCompleteListener jni address %d", javaObject);
