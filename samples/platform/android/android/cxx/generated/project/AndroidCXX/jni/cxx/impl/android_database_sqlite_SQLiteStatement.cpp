...
// Functions
java_lang_String *  android_database_sqlite_SQLiteStatement::toString()
{
	const char *methodName = "toString";
	const char *methodSignature = "()Ljava/lang/String;";
	const char *className = "android_database_sqlite_SQLiteStatement";
...
java_lang_String *  android_database_sqlite_SQLiteStatement::simpleQueryForString()
{
...
android_os_ParcelFileDescriptor *  android_database_sqlite_SQLiteStatement::simpleQueryForBlobFileDescriptor()
{
