...
{
	LOGV("android_content_res_AssetFileDescriptor::android_content_res_AssetFileDescriptor(const android_content_res_AssetFileDescriptor& cc) invoked");
...
{
	LOGV("android_content_res_AssetFileDescriptor::android_content_res_AssetFileDescriptor(void * proxy) invoked");
...
{
	LOGV("android_content_res_AssetFileDescriptor::~android_content_res_AssetFileDescriptor() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
