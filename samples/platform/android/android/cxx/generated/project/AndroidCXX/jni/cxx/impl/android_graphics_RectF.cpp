...
AndroidCXX::java_lang_String android_graphics_RectF::toString()
{
	LOGV("AndroidCXX::java_lang_String android_graphics_RectF::toString() enter");
...
{
	LOGV("int android_graphics_RectF::hashCode() enter");
...
{
	LOGV("bool android_graphics_RectF::isEmpty() enter");
...
{
	LOGV("void android_graphics_RectF::sort() enter");
...
{
	LOGV("int android_graphics_RectF::describeContents() enter");
...
{
	LOGV("float android_graphics_RectF::width() enter");
...
{
	LOGV("float android_graphics_RectF::height() enter");
...
AndroidCXX::java_lang_String android_graphics_RectF::toShortString()
{
	LOGV("AndroidCXX::java_lang_String android_graphics_RectF::toShortString() enter");
...
{
	LOGV("float android_graphics_RectF::centerX() enter");
...
{
	LOGV("float android_graphics_RectF::centerY() enter");
...
{
	LOGV("void android_graphics_RectF::setEmpty() enter");
