...
// Functions
AndroidCXX::java_lang_String java_util_Currency::toString()
{
	LOGV("AndroidCXX::java_lang_String java_util_Currency::toString() enter");
...
AndroidCXX::java_lang_String java_util_Currency::getCurrencyCode()
{
	LOGV("AndroidCXX::java_lang_String java_util_Currency::getCurrencyCode() enter");
...
AndroidCXX::java_lang_String java_util_Currency::getSymbol()
{
	LOGV("AndroidCXX::java_lang_String java_util_Currency::getSymbol() enter");
...
{
	LOGV("int java_util_Currency::getDefaultFractionDigits() enter");
