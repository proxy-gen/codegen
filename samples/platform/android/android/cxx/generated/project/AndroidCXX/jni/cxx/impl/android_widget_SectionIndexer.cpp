...
android_widget_SectionIndexer::android_widget_SectionIndexer(void * proxy)
{
	LOGV("android_widget_SectionIndexer::android_widget_SectionIndexer(void * proxy) enter");
	...
	LOGV("android_widget_SectionIndexer::android_widget_SectionIndexer(void * proxy) exit");
}
...
{
	LOGV("int android_widget_SectionIndexer::getPositionForSection(int& arg0) enter");
	...
	LOGV("int android_widget_SectionIndexer::getPositionForSection(int& arg0) exit");

	return result;
}
int android_widget_SectionIndexer::getSectionForPosition(int& arg0)
{
	LOGV("int android_widget_SectionIndexer::getSectionForPosition(int& arg0) enter");
	...
	LOGV("int android_widget_SectionIndexer::getSectionForPosition(int& arg0) exit");
