...
void android_widget_SeekBar_OnSeekBarChangeListener::onProgressChanged(android_widget_SeekBar& arg0,int& arg1,bool& arg2)
{
	...
	const char *className = "android_widget_SeekBar_OnSeekBarChangeListener";
	...
	jobject jarg0;
	{
		...
		convert_proxy<android_widget_SeekBar>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
