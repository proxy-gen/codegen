...
{
	LOGV("android_widget_GridView::android_widget_GridView(const android_widget_GridView& cc) invoked");
...
{
	LOGV("android_widget_GridView::android_widget_GridView(void * proxy) invoked");
...
{
	LOGV("android_widget_GridView::~android_widget_GridView() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
bool android_widget_GridView::onKeyDown(int& arg0,android_view_KeyEvent& arg1)
{
	const char *methodName = "onKeyDown";
	const char *methodSignature = "(ILandroid/view/KeyEvent;)Z";
	const char *className = "android_widget_GridView";
	...
	LOGV("android_widget_GridView jni address %d", javaObject);
...
bool android_widget_GridView::onKeyUp(int& arg0,android_view_KeyEvent& arg1)
{
...
bool android_widget_GridView::onKeyMultiple(int& arg0,android_view_KeyEvent& arg1)
{
...
void android_widget_GridView::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_GridView::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
void android_widget_GridView::setAdapter(android_widget_ListAdapter& arg0)
{
...
void android_widget_GridView::setRemoteViewsAdapter(android_content_Intent& arg0)
{
...
android_widget_ListAdapter *  android_widget_GridView::getAdapter()
{
...
int android_widget_GridView::getGravity()
{
...
{
	const char *methodName = "getHorizontalSpacing";
	const char *methodSignature = "()I";
	const char *className = "android_widget_GridView";
...
int android_widget_GridView::getRequestedHorizontalSpacing()
{
	const char *methodName = "getRequestedHorizontalSpacing";
	const char *methodSignature = "()I";
	const char *className = "android_widget_GridView";
...
{
	const char *methodName = "getVerticalSpacing";
	const char *methodSignature = "()I";
	const char *className = "android_widget_GridView";
...
{
	const char *methodName = "getStretchMode";
	const char *methodSignature = "()I";
	const char *className = "android_widget_GridView";
...
{
	const char *methodName = "getColumnWidth";
	const char *methodSignature = "()I";
	const char *className = "android_widget_GridView";
...
int android_widget_GridView::getRequestedColumnWidth()
{
	const char *methodName = "getRequestedColumnWidth";
	const char *methodSignature = "()I";
	const char *className = "android_widget_GridView";
...
{
	const char *methodName = "getNumColumns";
	const char *methodSignature = "()I";
	const char *className = "android_widget_GridView";
