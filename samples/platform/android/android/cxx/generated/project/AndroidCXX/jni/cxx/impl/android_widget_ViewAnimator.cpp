...
{
	LOGV("android_widget_ViewAnimator::android_widget_ViewAnimator(const android_widget_ViewAnimator& cc) invoked");
...
{
	LOGV("android_widget_ViewAnimator::android_widget_ViewAnimator(void * proxy) invoked");
...
{
	LOGV("android_widget_ViewAnimator::~android_widget_ViewAnimator() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
void android_widget_ViewAnimator::addView(android_view_View& arg0,int& arg1,android_view_ViewGroup_LayoutParams& arg2)
{
	const char *methodName = "addView";
	const char *methodSignature = "(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V";
	const char *className = "android_widget_ViewAnimator";
...
void android_widget_ViewAnimator::removeView(android_view_View& arg0)
{
...
void android_widget_ViewAnimator::removeViewInLayout(android_view_View& arg0)
{
...
void android_widget_ViewAnimator::removeViewsInLayout(int& arg0)
{
...
void android_widget_ViewAnimator::removeViews(int& arg0)
{
...
void android_widget_ViewAnimator::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_ViewAnimator::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
android_view_View *  android_widget_ViewAnimator::getCurrentView()
{
...
android_view_animation_Animation *  android_widget_ViewAnimator::getInAnimation()
{
...
void android_widget_ViewAnimator::setInAnimation(android_view_animation_Animation& arg0,android_content_Context& arg1,int& arg2)
{
	const char *methodName = "setInAnimation";
	const char *methodSignature = "(Landroid/view/animation/Animation;Landroid/content/Context;I)V";
	const char *className = "android_widget_ViewAnimator";
...
android_view_animation_Animation *  android_widget_ViewAnimator::getOutAnimation()
{
...
void android_widget_ViewAnimator::setOutAnimation(android_content_Context& arg0,int& arg1,android_view_animation_Animation& arg2)
{
	const char *methodName = "setOutAnimation";
	const char *methodSignature = "(Landroid/content/Context;ILandroid/view/animation/Animation;)V";
	const char *className = "android_widget_ViewAnimator";
