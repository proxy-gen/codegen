...
template void convert_proxy<android_util_TypedValue>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_graphics_Movie>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_content_res_Resources_Theme>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_util_DisplayMetrics>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_content_res_AssetManager>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
android_content_res_Resources::android_content_res_Resources(const android_content_res_Resources& cc)
{
	LOGV("android_content_res_Resources::android_content_res_Resources(const android_content_res_Resources& cc) invoked");
...
{
	LOGV("android_content_res_Resources::android_content_res_Resources(void * proxy) invoked");
...
{
	LOGV("android_content_res_Resources::~android_content_res_Resources() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
bool android_content_res_Resources::getBoolean(int& arg0)
{
	...
	const char *className = "android_content_res_Resources";
...
void android_content_res_Resources::getValue(int& arg0,android_util_TypedValue& arg1,bool& arg2,java_lang_String& arg3)
{
	const char *methodName = "getValue";
	const char *methodSignature = "(ILandroid/util/TypedValue;ZLjava/lang/String;)V";
	const char *className = "android_content_res_Resources";
	...
	jobject jarg1;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_util_TypedValue>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
java_lang_String *  android_content_res_Resources::getString(int& arg0,std::vector<long>& arg1)
{
...
int android_content_res_Resources::getIdentifier(java_lang_String& arg0)
{
...
std::vector<long> android_content_res_Resources::getStringArray(int& arg0)
{
...
java_lang_CharSequence *  android_content_res_Resources::getText(int& arg0,java_lang_CharSequence& arg1)
{
...
java_lang_String *  android_content_res_Resources::getResourceName(int& arg0)
{
...
android_content_res_Resources *  android_content_res_Resources::getSystem()
{
...
java_lang_CharSequence *  android_content_res_Resources::getQuantityText(int& arg0)
{
...
java_lang_String *  android_content_res_Resources::getQuantityString(int& arg0,std::vector<long>& arg1)
{
...
std::vector<long> android_content_res_Resources::getTextArray(int& arg0)
{
	const char *methodName = "getTextArray";
	const char *methodSignature = "(I)[java/lang/CharSequence";
	const char *className = "android_content_res_Resources";
...
android_content_res_TypedArray *  android_content_res_Resources::obtainTypedArray(int& arg0)
{
...
float android_content_res_Resources::getFraction(int& arg0)
{
...
android_graphics_drawable_Drawable *  android_content_res_Resources::getDrawable(int& arg0)
{
...
android_graphics_drawable_Drawable *  android_content_res_Resources::getDrawableForDensity(int& arg0)
{
...
android_graphics_Movie *  android_content_res_Resources::getMovie(int& arg0)
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_graphics_Movie>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_graphics_Movie * ) (*((android_graphics_Movie *  *) cxx_value));
...
android_content_res_ColorStateList *  android_content_res_Resources::getColorStateList(int& arg0)
{
...
android_content_res_XmlResourceParser *  android_content_res_Resources::getLayout(int& arg0)
{
...
android_content_res_XmlResourceParser *  android_content_res_Resources::getAnimation(int& arg0)
{
...
android_content_res_XmlResourceParser *  android_content_res_Resources::getXml(int& arg0)
{
...
java_io_InputStream *  android_content_res_Resources::openRawResource(int& arg0,android_util_TypedValue& arg1)
{
...
android_content_res_AssetFileDescriptor *  android_content_res_Resources::openRawResourceFd(int& arg0)
{
...
void android_content_res_Resources::getValueForDensity(int& arg0,android_util_TypedValue& arg1,bool& arg2)
{
...
android_content_res_Resources_Theme *  android_content_res_Resources::newTheme()
{
...
android_content_res_TypedArray *  android_content_res_Resources::obtainAttributes(android_util_AttributeSet& arg0,std::vector<int>& arg1)
{
...
void android_content_res_Resources::updateConfiguration(android_content_res_Configuration& arg0,android_util_DisplayMetrics& arg1)
{
	...
	jobject jarg1;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_util_DisplayMetrics>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
android_util_DisplayMetrics *  android_content_res_Resources::getDisplayMetrics()
{
	...
	android_util_DisplayMetrics *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
	...
	result = (android_util_DisplayMetrics * ) (*((android_util_DisplayMetrics *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
android_content_res_Configuration *  android_content_res_Resources::getConfiguration()
{
	...
	android_content_res_Configuration *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
	...
	result = (android_content_res_Configuration * ) (*((android_content_res_Configuration *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
java_lang_String *  android_content_res_Resources::getResourcePackageName(int& arg0)
{
...
java_lang_String *  android_content_res_Resources::getResourceTypeName(int& arg0)
{
...
java_lang_String *  android_content_res_Resources::getResourceEntryName(int& arg0)
{
...
void android_content_res_Resources::parseBundleExtras(android_content_res_XmlResourceParser& arg0,android_os_Bundle& arg1)
{
...
void android_content_res_Resources::parseBundleExtra(java_lang_String& arg0,android_util_AttributeSet& arg1,android_os_Bundle& arg2)
{
...
android_content_res_AssetManager *  android_content_res_Resources::getAssets()
{
