...
public:
	...
	// Public Constructors
	android_view_View(AndroidCXX::android_content_Context& arg0);
	android_view_View(AndroidCXX::android_content_Context& arg0,AndroidCXX::android_util_AttributeSet& arg1);
	android_view_View(AndroidCXX::android_content_Context& arg0,AndroidCXX::android_util_AttributeSet& arg1,int& arg2);
	android_view_View();
	// Default Destructor
	...
	static AndroidCXX::android_view_View inflate(AndroidCXX::android_content_Context& arg0,int& arg1,AndroidCXX::android_view_ViewGroup& arg2);
	 AndroidCXX::java_lang_Object getTag();
	 AndroidCXX::java_lang_Object getTag(int& arg0);
	 void invalidate();
	 void invalidate(int& arg0,int& arg1,int& arg2,int& arg3);
	 void invalidate(AndroidCXX::android_graphics_Rect& arg0);
	 float getY();
	 float getX();
	 void restoreHierarchyState(AndroidCXX::android_util_SparseArray& arg0);
	 AndroidCXX::android_os_IBinder getWindowToken();
	 int getVisibility();
	 void setOnCreateContextMenuListener(AndroidCXX::android_view_View_OnCreateContextMenuListener& arg0);
	 ...
	 void startAnimation(AndroidCXX::android_view_animation_Animation& arg0);
	 void clearAnimation();
	 bool removeCallbacks(AndroidCXX::java_lang_Runnable& arg0);
	 bool post(AndroidCXX::java_lang_Runnable& arg0);
	 void saveHierarchyState(AndroidCXX::android_util_SparseArray& arg0);
	 AndroidCXX::android_view_animation_Animation getAnimation();
	 bool onKeyDown(int& arg0,AndroidCXX::android_view_KeyEvent& arg1);
	 void setId(int& arg0);
	 void setTag(int& arg0,AndroidCXX::java_lang_Object& arg1);
	 void setTag(AndroidCXX::java_lang_Object& arg0);
	 bool isFocusable();
	 bool isEnabled();
	 bool willNotDraw();
	...
	static int resolveSize(int& arg0,int& arg1);
	 AndroidCXX::android_view_View focusSearch(int& arg0);
	 bool dispatchUnhandledMove(AndroidCXX::android_view_View& arg0,int& arg1);
	 void clearFocus();
	 AndroidCXX::android_view_View findFocus();
	 bool hasFocusable();
	 void addFocusables(AndroidCXX::java_util_ArrayList& arg0,int& arg1);
	 ...
	 void setOnFocusChangeListener(AndroidCXX::android_view_View_OnFocusChangeListener& arg0);
	 void addOnLayoutChangeListener(AndroidCXX::android_view_View_OnLayoutChangeListener& arg0);
	 void removeOnLayoutChangeListener(AndroidCXX::android_view_View_OnLayoutChangeListener& arg0);
	 void addOnAttachStateChangeListener(AndroidCXX::android_view_View_OnAttachStateChangeListener& arg0);
	 void removeOnAttachStateChangeListener(AndroidCXX::android_view_View_OnAttachStateChangeListener& arg0);
	 ...
	 void setOnLongClickListener(AndroidCXX::android_view_View_OnLongClickListener& arg0);
	 bool performClick();
	 bool callOnClick();
	 bool performLongClick();
	 bool showContextMenu();
	 void setOnKeyListener(AndroidCXX::android_view_View_OnKeyListener& arg0);
	 void setOnTouchListener(AndroidCXX::android_view_View_OnTouchListener& arg0);
	 void setOnGenericMotionListener(AndroidCXX::android_view_View_OnGenericMotionListener& arg0);
	 void setOnHoverListener(AndroidCXX::android_view_View_OnHoverListener& arg0);
	 void setOnDragListener(AndroidCXX::android_view_View_OnDragListener& arg0);
	 bool requestRectangleOnScreen(AndroidCXX::android_graphics_Rect& arg0,bool& arg1);
	 bool requestRectangleOnScreen(AndroidCXX::android_graphics_Rect& arg0);
	 void sendAccessibilityEvent(int& arg0);
	 void announceForAccessibility(AndroidCXX::java_lang_CharSequence& arg0);
	 ...
	 void setAccessibilityDelegate(AndroidCXX::android_view_View_AccessibilityDelegate& arg0);
	 ...
	 AndroidCXX::java_util_ArrayList getFocusables(int& arg0);
	 ...
	 bool onFilterTouchEventForSecurity(AndroidCXX::android_view_MotionEvent& arg0);
	 int getWindowVisibility();
	 void getWindowVisibleDisplayFrame(AndroidCXX::android_graphics_Rect& arg0);
	 bool isInTouchMode();
	 ...
	 void setTouchDelegate(AndroidCXX::android_view_TouchDelegate& arg0);
	 ...
	 int getWidth();
	 int getHeight();
	 void getDrawingRect(AndroidCXX::android_graphics_Rect& arg0);
	 ...
	 void getHitRect(AndroidCXX::android_graphics_Rect& arg0);
	 void getFocusedRect(AndroidCXX::android_graphics_Rect& arg0);
	 bool getGlobalVisibleRect(AndroidCXX::android_graphics_Rect& arg0);
	 bool getGlobalVisibleRect(AndroidCXX::android_graphics_Rect& arg0,AndroidCXX::android_graphics_Point& arg1);
	 bool getLocalVisibleRect(AndroidCXX::android_graphics_Rect& arg0);
	 ...
	 void postOnAnimation(AndroidCXX::java_lang_Runnable& arg0);
	 void postOnAnimationDelayed(AndroidCXX::java_lang_Runnable& arg0,long& arg1);
	 void postInvalidate();
	 ...
	 void unscheduleDrawable(AndroidCXX::android_graphics_drawable_Drawable& arg0);
	 void refreshDrawableState();
	 std::vector<int> getDrawableState();
	 void setBackgroundResource(int& arg0);
	 void setBackground(AndroidCXX::android_graphics_drawable_Drawable& arg0);
	 ...
	 void getLocationOnScreen(std::vector<int>& arg0);
	 void getLocationInWindow(std::vector<int>& arg0);
	 AndroidCXX::android_view_View findViewWithTag(AndroidCXX::java_lang_Object& arg0);
	 int getBaseline();
	 void forceLayout();
	...
	static int getDefaultSize(int& arg0,int& arg1);
	 ...
	 bool performHapticFeedback(int& arg0,int& arg1);
	 ...
	 void setOnSystemUiVisibilityChangeListener(AndroidCXX::android_view_View_OnSystemUiVisibilityChangeListener& arg0);
	 bool startDrag(AndroidCXX::android_content_ClipData& arg0,AndroidCXX::android_view_View_DragShadowBuilder& arg1,AndroidCXX::java_lang_Object& arg2,int& arg3);
