...
android_support_v4_app_FragmentManager_BackStackEntry::android_support_v4_app_FragmentManager_BackStackEntry(Proxy proxy)
{
	LOGV("android_support_v4_app_FragmentManager_BackStackEntry::android_support_v4_app_FragmentManager_BackStackEntry(Proxy proxy) enter");
	...
	LOGV("android_support_v4_app_FragmentManager_BackStackEntry::android_support_v4_app_FragmentManager_BackStackEntry(Proxy proxy) exit");
}
Proxy android_support_v4_app_FragmentManager_BackStackEntry::proxy() const
{	
	LOGV("android_support_v4_app_FragmentManager_BackStackEntry::proxy() enter");	
	CXXContext *ctx = CXXContext::sharedInstance();
	...
	LOGV("android_support_v4_app_FragmentManager_BackStackEntry::proxy() exit");	
...
AndroidCXX::java_lang_String android_support_v4_app_FragmentManager_BackStackEntry::getName()
{
	...
	LOGV("android_support_v4_app_FragmentManager_BackStackEntry className %s methodName %s methodSignature %s", className, methodName, methodSignature);
