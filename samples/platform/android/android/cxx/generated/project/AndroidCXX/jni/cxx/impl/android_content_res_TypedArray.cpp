...
java_lang_String *  android_content_res_TypedArray::toString()
{
	...
	const char *className = "android_content_res_TypedArray";
...
int android_content_res_TypedArray::getInt(int& arg0)
{
...
int android_content_res_TypedArray::length()
{
...
bool android_content_res_TypedArray::getValue(int& arg0,android_util_TypedValue& arg1)
{
...
android_content_res_Resources *  android_content_res_TypedArray::getResources()
{
...
int android_content_res_TypedArray::getInteger(int& arg0)
{
...
java_lang_String *  android_content_res_TypedArray::getString(int& arg0)
{
...
void android_content_res_TypedArray::recycle()
{
...
java_lang_CharSequence *  android_content_res_TypedArray::getText(int& arg0)
{
...
std::vector<long> android_content_res_TypedArray::getTextArray(int& arg0)
{
...
int android_content_res_TypedArray::getDimensionPixelOffset(int& arg0)
{
...
int android_content_res_TypedArray::getDimensionPixelSize(int& arg0)
{
...
float android_content_res_TypedArray::getFraction(int& arg0,float& arg1)
{
...
android_graphics_drawable_Drawable *  android_content_res_TypedArray::getDrawable(int& arg0)
{
...
int android_content_res_TypedArray::getColor(int& arg0)
{
...
android_content_res_ColorStateList *  android_content_res_TypedArray::getColorStateList(int& arg0)
{
...
int android_content_res_TypedArray::getResourceId(int& arg0)
{
...
java_lang_String *  android_content_res_TypedArray::getPositionDescription()
{
...
int android_content_res_TypedArray::getIndexCount()
{
	const char *methodName = "getIndexCount";
	const char *methodSignature = "()I";
	const char *className = "android_content_res_TypedArray";
...
java_lang_String *  android_content_res_TypedArray::getNonResourceString(int& arg0)
{
...
int android_content_res_TypedArray::getLayoutDimension(int& arg0,java_lang_String& arg1)
{
...
android_util_TypedValue *  android_content_res_TypedArray::peekValue(int& arg0)
{
	...
	android_util_TypedValue *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature,jarg0);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
	...
	result = (android_util_TypedValue * ) (*((android_util_TypedValue *  *) cxx_value));
