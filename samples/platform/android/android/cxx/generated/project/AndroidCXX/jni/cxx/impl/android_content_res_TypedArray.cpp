...
// Functions
AndroidCXX::java_lang_String android_content_res_TypedArray::toString()
{
	LOGV("AndroidCXX::java_lang_String android_content_res_TypedArray::toString() enter");
...
{
	LOGV("int android_content_res_TypedArray::length() enter");
...
AndroidCXX::android_content_res_Resources android_content_res_TypedArray::getResources()
{
	LOGV("AndroidCXX::android_content_res_Resources android_content_res_TypedArray::getResources() enter");
...
{
	LOGV("void android_content_res_TypedArray::recycle() enter");
...
std::vector<java_lang_CharSequence > android_content_res_TypedArray::getTextArray(int& arg0)
{
	LOGV("std::vector<java_lang_CharSequence > android_content_res_TypedArray::getTextArray(int& arg0) enter");
	...
	LOGV("std::vector<java_lang_CharSequence > android_content_res_TypedArray::getTextArray(int& arg0) exit");
...
AndroidCXX::java_lang_String android_content_res_TypedArray::getPositionDescription()
{
	LOGV("AndroidCXX::java_lang_String android_content_res_TypedArray::getPositionDescription() enter");
...
{
	LOGV("int android_content_res_TypedArray::getIndexCount() enter");
