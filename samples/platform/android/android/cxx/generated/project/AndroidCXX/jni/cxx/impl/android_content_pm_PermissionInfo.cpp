...
{
	LOGV("android_content_pm_PermissionInfo::android_content_pm_PermissionInfo(const android_content_pm_PermissionInfo& cc) invoked");
...
{
	LOGV("android_content_pm_PermissionInfo::android_content_pm_PermissionInfo(void * proxy) invoked");
...
{
	LOGV("android_content_pm_PermissionInfo::~android_content_pm_PermissionInfo() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
java_lang_String *  android_content_pm_PermissionInfo::toString()
{
	const char *methodName = "toString";
	const char *methodSignature = "()Ljava/lang/String;";
	const char *className = "android_content_pm_PermissionInfo";
...
void android_content_pm_PermissionInfo::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
...
java_lang_CharSequence *  android_content_pm_PermissionInfo::loadDescription(android_content_pm_PackageManager& arg0)
{
