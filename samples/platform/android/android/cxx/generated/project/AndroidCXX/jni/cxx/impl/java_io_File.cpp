...
template void convert_proxy<java_io_FilenameFilter>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<java_io_FileFilter>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
java_io_File::java_io_File(const java_io_File& cc)
{
	LOGV("java_io_File::java_io_File(const java_io_File& cc) invoked");
...
{
	LOGV("java_io_File::java_io_File(void * proxy) invoked");
...
{
	LOGV("java_io_File::~java_io_File() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
bool java_io_File::equals(java_lang_Object& arg0)
{
	const char *methodName = "equals";
	const char *methodSignature = "(Ljava/lang/Object;)Z";
	const char *className = "java_io_File";
...
java_lang_String *  java_io_File::toString()
{
...
int java_io_File::compareTo(java_io_File& arg0)
{
...
java_lang_String *  java_io_File::getName()
{
...
java_lang_String *  java_io_File::getParent()
{
...
java_lang_String *  java_io_File::getCanonicalPath()
{
...
std::vector<long> java_io_File::list(java_io_FilenameFilter& arg0)
{
	const char *methodName = "list";
	const char *methodSignature = "(Ljava/io/FilenameFilter;)[java/lang/String";
	const char *className = "java_io_File";
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<java_io_FilenameFilter>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
java_io_File *  java_io_File::getParentFile()
{
...
java_lang_String *  java_io_File::getPath()
{
...
java_lang_String *  java_io_File::getAbsolutePath()
{
...
java_io_File *  java_io_File::getAbsoluteFile()
{
...
java_io_File *  java_io_File::getCanonicalFile()
{
...
java_net_URL *  java_io_File::toURL()
{
...
java_net_URI *  java_io_File::toURI()
{
...
std::vector<long> java_io_File::listFiles(java_io_FileFilter& arg0,java_io_FilenameFilter& arg1)
{
	const char *methodName = "listFiles";
	const char *methodSignature = "(Ljava/io/FileFilter;Ljava/io/FilenameFilter;)[java/io/File";
	const char *className = "java_io_File";
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<java_io_FileFilter>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	...
	long java_value = convert_jni__object_array_type_to_java(jni_result);
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<java_io_File>);				
...
bool java_io_File::renameTo(java_io_File& arg0)
{
...
std::vector<long> java_io_File::listRoots()
{
	const char *methodName = "listRoots";
	const char *methodSignature = "()[java/io/File";
	const char *className = "java_io_File";
...
java_io_File *  java_io_File::createTempFile(java_lang_String& arg0,java_io_File& arg1)
{
	const char *methodName = "createTempFile";
	const char *methodSignature = "(Ljava/lang/String;Ljava/io/File;)Ljava/io/File;";
	const char *className = "java_io_File";
