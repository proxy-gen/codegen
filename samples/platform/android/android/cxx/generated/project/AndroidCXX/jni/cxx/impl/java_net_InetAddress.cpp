...
template void convert_proxy<java_net_NetworkInterface>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
java_net_InetAddress::java_net_InetAddress(const java_net_InetAddress& cc)
{
	LOGV("java_net_InetAddress::java_net_InetAddress(const java_net_InetAddress& cc) invoked");
...
{
	LOGV("java_net_InetAddress::java_net_InetAddress(void * proxy) invoked");
...
{
	LOGV("java_net_InetAddress::~java_net_InetAddress() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
bool java_net_InetAddress::equals(java_lang_Object& arg0)
{
	const char *methodName = "equals";
	const char *methodSignature = "(Ljava/lang/Object;)Z";
	const char *className = "java_net_InetAddress";
...
java_lang_String *  java_net_InetAddress::toString()
{
...
std::vector<char> java_net_InetAddress::getAddress()
{
...
java_lang_String *  java_net_InetAddress::getHostName()
{
...
java_lang_String *  java_net_InetAddress::getHostAddress()
{
...
java_net_InetAddress *  java_net_InetAddress::getByName(java_lang_String& arg0)
{
...
bool java_net_InetAddress::isReachable(java_net_NetworkInterface& arg0,int& arg1)
{
	const char *methodName = "isReachable";
	const char *methodSignature = "(Ljava/net/NetworkInterface;I)Z";
	const char *className = "java_net_InetAddress";
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<java_net_NetworkInterface>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
java_lang_String *  java_net_InetAddress::getCanonicalHostName()
{
...
java_net_InetAddress *  java_net_InetAddress::getByAddress(std::vector<char>& arg0,java_lang_String& arg1)
{
	const char *methodName = "getByAddress";
	const char *methodSignature = "([[BLjava/lang/String;)Ljava/net/InetAddress;";
	const char *className = "java_net_InetAddress";
...
std::vector<long> java_net_InetAddress::getAllByName(java_lang_String& arg0)
{
	const char *methodName = "getAllByName";
	const char *methodSignature = "(Ljava/lang/String;)[java/net/InetAddress";
	const char *className = "java_net_InetAddress";
	...
	long java_value = convert_jni__object_array_type_to_java(jni_result);
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<java_net_InetAddress>);				
...
java_net_InetAddress *  java_net_InetAddress::getLocalHost()
{
