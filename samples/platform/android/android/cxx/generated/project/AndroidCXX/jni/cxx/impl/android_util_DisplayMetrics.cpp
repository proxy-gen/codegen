...
{
	LOGV("android_util_DisplayMetrics::android_util_DisplayMetrics(const android_util_DisplayMetrics& cc) invoked");
...
{
	LOGV("android_util_DisplayMetrics::android_util_DisplayMetrics(void * proxy) invoked");
...
{
	LOGV("android_util_DisplayMetrics::~android_util_DisplayMetrics() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
bool android_util_DisplayMetrics::equals(java_lang_Object& arg0,android_util_DisplayMetrics& arg1)
{
	const char *methodName = "equals";
	const char *methodSignature = "(Ljava/lang/Object;Landroid/util/DisplayMetrics;)Z";
	const char *className = "android_util_DisplayMetrics";
...
java_lang_String *  android_util_DisplayMetrics::toString()
{
...
void android_util_DisplayMetrics::setTo(android_util_DisplayMetrics& arg0)
{
