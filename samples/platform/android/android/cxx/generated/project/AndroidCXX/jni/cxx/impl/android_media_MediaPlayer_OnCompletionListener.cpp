...
// Functions
void android_media_MediaPlayer_OnCompletionListener::onCompletion(android_media_MediaPlayer& arg0)
{
	const char *methodName = "onCompletion";
	const char *methodSignature = "(Landroid/media/MediaPlayer;)V";
	const char *className = "android_media_MediaPlayer_OnCompletionListener";
