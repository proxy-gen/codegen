...
template void convert_proxy<android_widget_Filter_FilterListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
void android_widget_Filter::filter(java_lang_CharSequence& arg0,android_widget_Filter_FilterListener& arg1)
{
	const char *methodName = "filter";
	const char *methodSignature = "(Ljava/lang/CharSequence;Landroid/widget/Filter$FilterListener;)V";
	const char *className = "android_widget_Filter";
	...
	LOGV("android_widget_Filter jni address %d", javaObject);
	...
	jobject jarg1;
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.widget.Filter$FilterListener");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_Filter_FilterListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
java_lang_CharSequence *  android_widget_Filter::convertResultToString(java_lang_Object& arg0)
{
