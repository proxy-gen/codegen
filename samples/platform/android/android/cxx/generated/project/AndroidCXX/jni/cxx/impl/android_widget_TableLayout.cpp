...
template void convert_proxy<android_widget_TableLayout_LayoutParams>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
{
	LOGV("android_widget_TableLayout::android_widget_TableLayout(const android_widget_TableLayout& cc) invoked");
...
{
	LOGV("android_widget_TableLayout::android_widget_TableLayout(void * proxy) invoked");
...
{
	LOGV("android_widget_TableLayout::~android_widget_TableLayout() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
void android_widget_TableLayout::addView(android_view_View& arg0,int& arg1,android_view_ViewGroup_LayoutParams& arg2)
{
	const char *methodName = "addView";
	const char *methodSignature = "(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V";
	const char *className = "android_widget_TableLayout";
...
void android_widget_TableLayout::setOnHierarchyChangeListener(android_view_ViewGroup_OnHierarchyChangeListener& arg0)
{
...
android_widget_TableLayout_LayoutParams *  android_widget_TableLayout::generateLayoutParams(android_util_AttributeSet& arg0)
{
	...
	android_widget_TableLayout_LayoutParams *  result;
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.widget.TableLayout$LayoutParams");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_widget_TableLayout_LayoutParams>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_widget_TableLayout_LayoutParams * ) (*((android_widget_TableLayout_LayoutParams *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
void android_widget_TableLayout::requestLayout()
{
...
void android_widget_TableLayout::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_TableLayout::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
{
	const char *methodName = "isShrinkAllColumns";
...
{
	const char *methodName = "isStretchAllColumns";
	const char *methodSignature = "()Z";
	const char *className = "android_widget_TableLayout";
