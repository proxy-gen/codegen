...
{
	LOGV("void android_widget_TableLayout::requestLayout() enter");
...
{
	LOGV("bool android_widget_TableLayout::isShrinkAllColumns() enter");
...
{
	LOGV("bool android_widget_TableLayout::isStretchAllColumns() enter");
