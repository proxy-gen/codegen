...
#define LOG_TAG "android_view_View_OnCreateContextMenuListener"
...
void android_view_View_OnCreateContextMenuListener::onCreateContextMenu(AndroidCXX::android_view_ContextMenu const& arg0,AndroidCXX::android_view_View const& arg1,AndroidCXX::android_view_ContextMenu_ContextMenuInfo const& arg2)
{
	...
	LOGV("android_view_View_OnCreateContextMenuListener className %s methodName %s methodSignature %s", className, methodName, methodSignature);
	...
	LOGV("android_view_View_OnCreateContextMenuListener jni address %d", javaObject);
