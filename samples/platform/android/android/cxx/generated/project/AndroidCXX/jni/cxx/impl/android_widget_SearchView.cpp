...
template void convert_proxy<android_app_SearchableInfo>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_widget_SearchView_OnQueryTextListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_widget_SearchView_OnCloseListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_widget_SearchView_OnSuggestionListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_widget_CursorAdapter>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
android_widget_SearchView::android_widget_SearchView(const android_widget_SearchView& cc)
{
	LOGV("android_widget_SearchView::android_widget_SearchView(const android_widget_SearchView& cc) invoked");
...
{
	LOGV("android_widget_SearchView::android_widget_SearchView(void * proxy) invoked");
...
{
	LOGV("android_widget_SearchView::~android_widget_SearchView() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
java_lang_CharSequence *  android_widget_SearchView::getQuery()
{
	const char *methodName = "getQuery";
	const char *methodSignature = "()Ljava/lang/CharSequence;";
	const char *className = "android_widget_SearchView";
...
bool android_widget_SearchView::onKeyDown(int& arg0,android_view_KeyEvent& arg1)
{
...
void android_widget_SearchView::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_SearchView::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
void android_widget_SearchView::setSearchableInfo(android_app_SearchableInfo& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_app_SearchableInfo>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_widget_SearchView::setOnQueryTextListener(android_widget_SearchView_OnQueryTextListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_SearchView_OnQueryTextListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_widget_SearchView::setOnCloseListener(android_widget_SearchView_OnCloseListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_SearchView_OnCloseListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_widget_SearchView::setOnQueryTextFocusChangeListener(android_view_View_OnFocusChangeListener& arg0)
{
...
void android_widget_SearchView::setOnSuggestionListener(android_widget_SearchView_OnSuggestionListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_SearchView_OnSuggestionListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_widget_SearchView::setOnSearchClickListener(android_view_View_OnClickListener& arg0)
{
...
void android_widget_SearchView::setQuery(java_lang_CharSequence& arg0,bool& arg1)
{
...
void android_widget_SearchView::setQueryHint(java_lang_CharSequence& arg0)
{
...
java_lang_CharSequence *  android_widget_SearchView::getQueryHint()
{
...
void android_widget_SearchView::setSuggestionsAdapter(android_widget_CursorAdapter& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_CursorAdapter>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
android_widget_CursorAdapter *  android_widget_SearchView::getSuggestionsAdapter()
{
	...
	android_widget_CursorAdapter *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
	...
	result = (android_widget_CursorAdapter * ) (*((android_widget_CursorAdapter *  *) cxx_value));
