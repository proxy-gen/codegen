...
template void convert_proxy<android_widget_Toast>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
android_widget_Toast::android_widget_Toast(const android_widget_Toast& cc)
{
	LOGV("android_widget_Toast::android_widget_Toast(const android_widget_Toast& cc) invoked");
...
{
	LOGV("android_widget_Toast::android_widget_Toast(void * proxy) invoked");
...
{
	LOGV("android_widget_Toast::~android_widget_Toast() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
void android_widget_Toast::setText(java_lang_CharSequence& arg0,int& arg1)
{
	const char *methodName = "setText";
	const char *methodSignature = "(Ljava/lang/CharSequence;I)V";
	const char *className = "android_widget_Toast";
...
android_view_View *  android_widget_Toast::getView()
{
...
void android_widget_Toast::show()
{
...
void android_widget_Toast::setGravity(int& arg0)
{
...
void android_widget_Toast::setView(android_view_View& arg0)
{
...
void android_widget_Toast::setMargin(float& arg0)
{
...
{
	const char *methodName = "getHorizontalMargin";
...
float android_widget_Toast::getVerticalMargin()
{
	const char *methodName = "getVerticalMargin";
	const char *methodSignature = "()F";
	const char *className = "android_widget_Toast";
...
int android_widget_Toast::getXOffset()
{
	const char *methodName = "getXOffset";
	const char *methodSignature = "()I";
	const char *className = "android_widget_Toast";
...
int android_widget_Toast::getYOffset()
{
	const char *methodName = "getYOffset";
	const char *methodSignature = "()I";
	const char *className = "android_widget_Toast";
...
android_widget_Toast *  android_widget_Toast::makeText(android_content_Context& arg0,java_lang_CharSequence& arg1,int& arg2)
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.widget.Toast");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_widget_Toast>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_widget_Toast * ) (*((android_widget_Toast *  *) cxx_value));
