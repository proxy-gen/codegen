...
{
	LOGV("void android_widget_Toast::cancel() enter");
...
AndroidCXX::android_view_View android_widget_Toast::getView()
{
	LOGV("AndroidCXX::android_view_View android_widget_Toast::getView() enter");
...
{
	LOGV("void android_widget_Toast::show() enter");
...
{
	LOGV("int android_widget_Toast::getDuration() enter");
...
{
	LOGV("int android_widget_Toast::getGravity() enter");
...
{
	LOGV("float android_widget_Toast::getHorizontalMargin() enter");
...
{
	LOGV("float android_widget_Toast::getVerticalMargin() enter");
...
{
	LOGV("int android_widget_Toast::getXOffset() enter");
...
{
	LOGV("int android_widget_Toast::getYOffset() enter");
