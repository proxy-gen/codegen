...
template void convert_proxy<java_nio_channels_FileChannel_MapMode>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<java_nio_channels_WritableByteChannel>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
java_nio_channels_FileLock *  java_nio_channels_FileChannel::lock(long& arg0,bool& arg1)
{
	...
	const char *methodSignature = "(JZ)Ljava/nio/channels/FileLock;";
	const char *className = "java_nio_channels_FileChannel";
	...
	LOGV("java_nio_channels_FileChannel jni address %d", javaObject);
	...
	java_nio_channels_FileLock *  result;
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("java.nio.channels.FileLock");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<java_nio_channels_FileLock>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (java_nio_channels_FileLock * ) (*((java_nio_channels_FileLock *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
long java_nio_channels_FileChannel::size()
{
...
long java_nio_channels_FileChannel::position(long& arg0)
{
...
int java_nio_channels_FileChannel::write(java_nio_ByteBuffer& arg0,std::vector<long>& arg1,int& arg2,long& arg3)
{
	const char *methodName = "write";
	const char *methodSignature = "(Ljava/nio/ByteBuffer;[java/nio/ByteBufferIJ)I";
	const char *className = "java_nio_channels_FileChannel";
	...
	jobjectArray jarg1;
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<java_nio_ByteBuffer>);				
...
java_nio_channels_FileChannel *  java_nio_channels_FileChannel::truncate(long& arg0)
{
...
java_nio_MappedByteBuffer *  java_nio_channels_FileChannel::map(java_nio_channels_FileChannel_MapMode& arg0,long& arg1)
{
	const char *methodName = "map";
	const char *methodSignature = "(Ljava/nio/channels/FileChannel$MapMode;J)Ljava/nio/MappedByteBuffer;";
	const char *className = "java_nio_channels_FileChannel";
	...
	jobject jarg0;
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("java.nio.channels.FileChannel$MapMode");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<java_nio_channels_FileChannel_MapMode>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
int java_nio_channels_FileChannel::read(java_nio_ByteBuffer& arg0,std::vector<long>& arg1,int& arg2,long& arg3)
{
...
java_nio_channels_FileLock *  java_nio_channels_FileChannel::tryLock(long& arg0,bool& arg1)
{
...
long java_nio_channels_FileChannel::transferTo(long& arg0,java_nio_channels_WritableByteChannel& arg1)
{
	const char *methodName = "transferTo";
	const char *methodSignature = "(JLjava/nio/channels/WritableByteChannel;)J";
	const char *className = "java_nio_channels_FileChannel";
	...
	jobject jarg1;
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("java.nio.channels.WritableByteChannel");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<java_nio_channels_WritableByteChannel>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
long java_nio_channels_FileChannel::transferFrom(java_nio_channels_ReadableByteChannel& arg0,long& arg1)
{
	const char *methodName = "transferFrom";
	const char *methodSignature = "(Ljava/nio/channels/ReadableByteChannel;J)J";
	const char *className = "java_nio_channels_FileChannel";
	...
	jobject jarg0;
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("java.nio.channels.ReadableByteChannel");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<java_nio_channels_ReadableByteChannel>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
