...
// Functions
bool java_net_NetworkInterface::equals(java_lang_Object& arg0)
{
	const char *methodName = "equals";
	const char *methodSignature = "(Ljava/lang/Object;)Z";
	const char *className = "java_net_NetworkInterface";
...
java_lang_String *  java_net_NetworkInterface::toString()
{
...
java_lang_String *  java_net_NetworkInterface::getName()
{
...
java_net_NetworkInterface *  java_net_NetworkInterface::getParent()
{
	...
	java_net_NetworkInterface *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
	...
	result = (java_net_NetworkInterface * ) (*((java_net_NetworkInterface *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
java_lang_String *  java_net_NetworkInterface::getDisplayName()
{
...
java_net_NetworkInterface *  java_net_NetworkInterface::getByName(java_lang_String& arg0)
{
...
java_util_Enumeration *  java_net_NetworkInterface::getInetAddresses()
{
...
java_util_List *  java_net_NetworkInterface::getInterfaceAddresses()
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<java_net_InterfaceAddress>);				
...
java_util_Enumeration *  java_net_NetworkInterface::getSubInterfaces()
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<java_net_NetworkInterface>);				
...
java_net_NetworkInterface *  java_net_NetworkInterface::getByInetAddress(java_net_InetAddress& arg0)
{
...
java_util_Enumeration *  java_net_NetworkInterface::getNetworkInterfaces()
{
...
std::vector<char> java_net_NetworkInterface::getHardwareAddress()
{
