...
AndroidCXX::java_lang_String android_content_SyncAdapterType::toString()
{
	LOGV("AndroidCXX::java_lang_String android_content_SyncAdapterType::toString() enter");
...
{
	LOGV("int android_content_SyncAdapterType::hashCode() enter");
...
{
	LOGV("int android_content_SyncAdapterType::describeContents() enter");
...
{
	LOGV("bool android_content_SyncAdapterType::supportsUploading() enter");
...
{
	LOGV("bool android_content_SyncAdapterType::isUserVisible() enter");
...
{
	LOGV("bool android_content_SyncAdapterType::allowParallelSyncs() enter");
...
{
	LOGV("bool android_content_SyncAdapterType::isAlwaysSyncable() enter");
...
AndroidCXX::java_lang_String android_content_SyncAdapterType::getSettingsActivity()
{
	LOGV("AndroidCXX::java_lang_String android_content_SyncAdapterType::getSettingsActivity() enter");
