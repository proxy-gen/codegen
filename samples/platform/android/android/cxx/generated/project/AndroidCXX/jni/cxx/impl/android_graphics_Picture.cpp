...
{
	LOGV("android_graphics_Picture::android_graphics_Picture(const android_graphics_Picture& cc) invoked");
...
{
	LOGV("android_graphics_Picture::android_graphics_Picture(void * proxy) invoked");
...
{
	LOGV("android_graphics_Picture::~android_graphics_Picture() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
