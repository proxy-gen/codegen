...
template void convert_proxy<java_io_PrintStream>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
void java_io_PrintStream::println(char& arg0,bool& arg1,java_lang_Object& arg2,java_lang_String& arg3,std::vector<char>& arg4,double& arg5,float& arg6,long& arg7,int& arg8)
{
	const char *methodName = "println";
	const char *methodSignature = "(CZLjava/lang/Object;Ljava/lang/String;[[CDFJI)V";
	const char *className = "java_io_PrintStream";
...
java_io_PrintStream *  java_io_PrintStream::append(java_lang_CharSequence& arg0,int& arg1,char& arg2)
{
	const char *methodName = "append";
	const char *methodSignature = "(Ljava/lang/CharSequence;IC)Ljava/io/PrintStream;";
	const char *className = "java_io_PrintStream";
	...
	result = (java_io_PrintStream * ) (*((java_io_PrintStream *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
java_io_PrintStream *  java_io_PrintStream::format(java_util_Locale& arg0,java_lang_String& arg1,std::vector<long>& arg2)
{
	const char *methodName = "format";
	const char *methodSignature = "(Ljava/util/Locale;Ljava/lang/String;[java/lang/Object)Ljava/io/PrintStream;";
	const char *className = "java_io_PrintStream";
...
void java_io_PrintStream::write(std::vector<char>& arg0,int& arg1)
{
...
void java_io_PrintStream::print(float& arg0,double& arg1,std::vector<char>& arg2,java_lang_String& arg3,java_lang_Object& arg4,bool& arg5,char& arg6,int& arg7,long& arg8)
{
	const char *methodName = "print";
	const char *methodSignature = "(FD[[CLjava/lang/String;Ljava/lang/Object;ZCIJ)V";
	const char *className = "java_io_PrintStream";
	...
	jchar jarg6;
	{
		...
		// Convert to JNI
		jarg6 = convert_jni_char_to_jni(java_value);
	}
	jint jarg7;
	{
		long cxx_value = (long) & arg7;
	...
	jlong jarg8;
	{
		...
		// Convert to JNI
		jarg8 = convert_jni_long_to_jni(java_value);
	}
...
java_io_PrintStream *  java_io_PrintStream::printf(java_lang_String& arg0,std::vector<long>& arg1,java_util_Locale& arg2)
{
	const char *methodName = "printf";
	const char *methodSignature = "(Ljava/lang/String;[java/lang/ObjectLjava/util/Locale;)Ljava/io/PrintStream;";
	const char *className = "java_io_PrintStream";
