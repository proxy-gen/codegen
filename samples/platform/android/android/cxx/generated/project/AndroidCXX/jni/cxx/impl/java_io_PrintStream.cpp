...
{
	LOGV("java_io_PrintStream::java_io_PrintStream(const java_io_PrintStream& cc) invoked");
...
{
	LOGV("java_io_PrintStream::java_io_PrintStream(void * proxy) invoked");
...
{
	LOGV("java_io_PrintStream::~java_io_PrintStream() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
