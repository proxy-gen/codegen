...
#define LOG_TAG "java_util_concurrent_Executor"
...
void java_util_concurrent_Executor::execute(AndroidCXX::java_lang_Runnable const& arg0)
{
	...
	LOGV("java_util_concurrent_Executor className %s methodName %s methodSignature %s", className, methodName, methodSignature);
	...
	LOGV("java_util_concurrent_Executor jni address %d", javaObject);
