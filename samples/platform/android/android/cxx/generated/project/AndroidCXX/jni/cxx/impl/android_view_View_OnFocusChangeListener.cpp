...
void android_view_View_OnFocusChangeListener::onFocusChange(android_view_View& arg0,bool& arg1)
{
	const char *methodName = "onFocusChange";
	const char *methodSignature = "(Landroid/view/View;Z)V";
	const char *className = "android_view_View_OnFocusChangeListener";
