...
{
	LOGV("int android_widget_DialerFilter::getMode() enter");
...
{
	LOGV("bool android_widget_DialerFilter::isQwertyKeyboard() enter");
...
AndroidCXX::java_lang_CharSequence android_widget_DialerFilter::getLetters()
{
	LOGV("AndroidCXX::java_lang_CharSequence android_widget_DialerFilter::getLetters() enter");
...
AndroidCXX::java_lang_CharSequence android_widget_DialerFilter::getDigits()
{
	LOGV("AndroidCXX::java_lang_CharSequence android_widget_DialerFilter::getDigits() enter");
...
AndroidCXX::java_lang_CharSequence android_widget_DialerFilter::getFilterText()
{
	LOGV("AndroidCXX::java_lang_CharSequence android_widget_DialerFilter::getFilterText() enter");
...
{
	LOGV("void android_widget_DialerFilter::clearText() enter");
