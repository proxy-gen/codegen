...
template void convert_proxy<android_widget_ZoomButtonsController_OnZoomListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
{
	LOGV("android_widget_ZoomButtonsController::android_widget_ZoomButtonsController(const android_widget_ZoomButtonsController& cc) invoked");
...
{
	LOGV("android_widget_ZoomButtonsController::android_widget_ZoomButtonsController(void * proxy) invoked");
...
{
	LOGV("android_widget_ZoomButtonsController::~android_widget_ZoomButtonsController() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
bool android_widget_ZoomButtonsController::isVisible()
{
	...
	const char *className = "android_widget_ZoomButtonsController";
...
bool android_widget_ZoomButtonsController::onTouch(android_view_View& arg0,android_view_MotionEvent& arg1)
{
...
android_view_ViewGroup *  android_widget_ZoomButtonsController::getContainer()
{
	...
	result = (android_view_ViewGroup * ) (*((android_view_ViewGroup *  *) cxx_value));
...
void android_widget_ZoomButtonsController::setOnZoomListener(android_widget_ZoomButtonsController_OnZoomListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_ZoomButtonsController_OnZoomListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
android_view_View *  android_widget_ZoomButtonsController::getZoomControls()
{
