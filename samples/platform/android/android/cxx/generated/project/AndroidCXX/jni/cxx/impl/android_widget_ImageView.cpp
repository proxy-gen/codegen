...
{
	LOGV("android_widget_ImageView::android_widget_ImageView(const android_widget_ImageView& cc) invoked");
...
{
	LOGV("android_widget_ImageView::android_widget_ImageView(void * proxy) invoked");
...
{
	LOGV("android_widget_ImageView::~android_widget_ImageView() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
