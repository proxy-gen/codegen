...
void android_widget_ImageView::setVisibility(int& arg0)
{
	...
	const char *className = "android_widget_ImageView";
...
android_graphics_drawable_Drawable *  android_widget_ImageView::getDrawable()
{
...
void android_widget_ImageView::onPopulateAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_ImageView::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_ImageView::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
void android_widget_ImageView::invalidateDrawable(android_graphics_drawable_Drawable& arg0)
{
...
void android_widget_ImageView::setColorFilter(int& arg0,android_graphics_PorterDuff_Mode& arg1,android_graphics_ColorFilter& arg2)
{
	const char *methodName = "setColorFilter";
	const char *methodSignature = "(ILandroid/graphics/PorterDuff$Mode;Landroid/graphics/ColorFilter;)V";
	const char *className = "android_widget_ImageView";
...
android_graphics_ColorFilter *  android_widget_ImageView::getColorFilter()
{
...
void android_widget_ImageView::setImageURI(android_net_Uri& arg0)
{
...
void android_widget_ImageView::setImageDrawable(android_graphics_drawable_Drawable& arg0)
{
...
void android_widget_ImageView::setImageBitmap(android_graphics_Bitmap& arg0)
{
...
void android_widget_ImageView::setScaleType(android_widget_ImageView_ScaleType& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_ImageView_ScaleType>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
android_widget_ImageView_ScaleType *  android_widget_ImageView::getScaleType()
{
	...
	android_widget_ImageView_ScaleType *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
...
android_graphics_Matrix *  android_widget_ImageView::getImageMatrix()
{
...
void android_widget_ImageView::setImageMatrix(android_graphics_Matrix& arg0)
{
