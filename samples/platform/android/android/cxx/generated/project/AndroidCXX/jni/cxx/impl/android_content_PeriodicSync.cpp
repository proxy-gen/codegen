...
{
	LOGV("android_content_PeriodicSync::android_content_PeriodicSync(const android_content_PeriodicSync& cc) invoked");
...
{
	LOGV("android_content_PeriodicSync::android_content_PeriodicSync(void * proxy) invoked");
...
{
	LOGV("android_content_PeriodicSync::~android_content_PeriodicSync() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
bool android_content_PeriodicSync::equals(java_lang_Object& arg0)
{
	const char *methodName = "equals";
	const char *methodSignature = "(Ljava/lang/Object;)Z";
	const char *className = "android_content_PeriodicSync";
...
int android_content_PeriodicSync::describeContents()
{
...
void android_content_PeriodicSync::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
