...
// Functions
float java_nio_FloatBuffer::get(std::vector<float>& arg0,int& arg1)
{
	const char *methodName = "get";
	const char *methodSignature = "([[FI)F";
...
java_nio_FloatBuffer *  java_nio_FloatBuffer::put(java_nio_FloatBuffer& arg0,float& arg1,int& arg2,std::vector<float>& arg3)
{
	const char *methodName = "put";
	const char *methodSignature = "(Ljava/nio/FloatBuffer;FI[[F)Ljava/nio/FloatBuffer;";
	const char *className = "java_nio_FloatBuffer";
...
java_nio_FloatBuffer *  java_nio_FloatBuffer::wrap(std::vector<float>& arg0,int& arg1)
{
	const char *methodName = "wrap";
	const char *methodSignature = "([[FI)Ljava/nio/FloatBuffer;";
	const char *className = "java_nio_FloatBuffer";
