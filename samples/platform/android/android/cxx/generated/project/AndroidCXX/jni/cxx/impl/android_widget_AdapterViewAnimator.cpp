...
void android_widget_AdapterViewAnimator::advance()
{
	...
	const char *className = "android_widget_AdapterViewAnimator";
...
android_os_Parcelable *  android_widget_AdapterViewAnimator::onSaveInstanceState()
{
...
void android_widget_AdapterViewAnimator::onRestoreInstanceState(android_os_Parcelable& arg0)
{
...
bool android_widget_AdapterViewAnimator::onTouchEvent(android_view_MotionEvent& arg0)
{
...
void android_widget_AdapterViewAnimator::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_AdapterViewAnimator::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
void android_widget_AdapterViewAnimator::setAdapter(android_widget_Adapter& arg0)
{
...
android_view_View *  android_widget_AdapterViewAnimator::getSelectedView()
{
...
void android_widget_AdapterViewAnimator::setRemoteViewsAdapter(android_content_Intent& arg0)
{
...
android_widget_Adapter *  android_widget_AdapterViewAnimator::getAdapter()
{
...
android_view_View *  android_widget_AdapterViewAnimator::getCurrentView()
{
...
android_animation_ObjectAnimator *  android_widget_AdapterViewAnimator::getInAnimation()
{
...
void android_widget_AdapterViewAnimator::setInAnimation(android_animation_ObjectAnimator& arg0,android_content_Context& arg1,int& arg2)
{
	const char *methodName = "setInAnimation";
	const char *methodSignature = "(Landroid/animation/ObjectAnimator;Landroid/content/Context;I)V";
	const char *className = "android_widget_AdapterViewAnimator";
...
android_animation_ObjectAnimator *  android_widget_AdapterViewAnimator::getOutAnimation()
{
...
void android_widget_AdapterViewAnimator::setOutAnimation(android_animation_ObjectAnimator& arg0,android_content_Context& arg1,int& arg2)
{
