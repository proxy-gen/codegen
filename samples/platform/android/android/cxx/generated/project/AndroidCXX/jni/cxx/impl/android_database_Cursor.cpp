...
{
	LOGV("void android_database_Cursor::close() enter");
...
{
	LOGV("bool android_database_Cursor::isFirst() enter");
...
{
	LOGV("bool android_database_Cursor::isClosed() enter");
...
{
	LOGV("int android_database_Cursor::getPosition() enter");
...
AndroidCXX::android_os_Bundle android_database_Cursor::getExtras()
{
	LOGV("AndroidCXX::android_os_Bundle android_database_Cursor::getExtras() enter");
...
{
	LOGV("int android_database_Cursor::getCount() enter");
...
{
	LOGV("bool android_database_Cursor::moveToFirst() enter");
...
{
	LOGV("bool android_database_Cursor::moveToLast() enter");
...
{
	LOGV("bool android_database_Cursor::moveToNext() enter");
...
{
	LOGV("bool android_database_Cursor::moveToPrevious() enter");
...
{
	LOGV("bool android_database_Cursor::isLast() enter");
...
{
	LOGV("bool android_database_Cursor::isBeforeFirst() enter");
...
{
	LOGV("bool android_database_Cursor::isAfterLast() enter");
...
{
	LOGV("int android_database_Cursor::getColumnCount() enter");
...
void android_database_Cursor::copyStringToBuffer(int& arg0,AndroidCXX::android_database_CharArrayBuffer& arg1)
{
	...
	jobject jarg1;
	{
		...
		cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
		{
			CXXTypeHierarchy cxx_type_hierarchy = cxx_type_hierarchy_stack.top();
			cxx_type_hierarchy_stack.pop();
			cxx_type_hierarchy.type_name = std::string("android.database.CharArrayBuffer");
		}
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_android_database_CharArrayBuffer(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
{
	LOGV("void android_database_Cursor::deactivate() enter");

	const char *methodName = "deactivate";
	const char *methodSignature = "()V";
	const char *className = "android/database/Cursor";
...
{
	LOGV("bool android_database_Cursor::requery() enter");

	const char *methodName = "requery";
	const char *methodSignature = "()Z";
	const char *className = "android/database/Cursor";
...
{
	LOGV("bool android_database_Cursor::getWantsAllOnMoveCalls() enter");

	const char *methodName = "getWantsAllOnMoveCalls";
	const char *methodSignature = "()Z";
	const char *className = "android/database/Cursor";
