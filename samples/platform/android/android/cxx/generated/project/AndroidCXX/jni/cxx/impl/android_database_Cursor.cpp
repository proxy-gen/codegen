...
template void convert_proxy<android_database_CharArrayBuffer>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
short android_database_Cursor::getShort(int& arg0)
{
	...
	const char *className = "android_database_Cursor";
...
void android_database_Cursor::copyStringToBuffer(int& arg0,android_database_CharArrayBuffer& arg1)
{
	...
	jobject jarg1;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_database_CharArrayBuffer>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
