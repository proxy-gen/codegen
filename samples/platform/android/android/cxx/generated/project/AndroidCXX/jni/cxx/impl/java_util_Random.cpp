...
{
	LOGV("java_util_Random::java_util_Random(const java_util_Random& cc) invoked");
...
{
	LOGV("java_util_Random::java_util_Random(void * proxy) invoked");
...
{
	LOGV("java_util_Random::~java_util_Random() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
