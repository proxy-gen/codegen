...
{
	LOGV("android_content_pm_ConfigurationInfo::android_content_pm_ConfigurationInfo(const android_content_pm_ConfigurationInfo& cc) invoked");
...
{
	LOGV("android_content_pm_ConfigurationInfo::android_content_pm_ConfigurationInfo(void * proxy) invoked");
...
{
	LOGV("android_content_pm_ConfigurationInfo::~android_content_pm_ConfigurationInfo() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
java_lang_String *  android_content_pm_ConfigurationInfo::toString()
{
	const char *methodName = "toString";
	const char *methodSignature = "()Ljava/lang/String;";
	const char *className = "android_content_pm_ConfigurationInfo";

	LOGV("android_content_pm_ConfigurationInfo className %d methodName %s methodSignature %s", className, methodName, methodSignature);
...
int android_content_pm_ConfigurationInfo::describeContents()
{
...
void android_content_pm_ConfigurationInfo::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
...
java_lang_String *  android_content_pm_ConfigurationInfo::getGlEsVersion()
{
