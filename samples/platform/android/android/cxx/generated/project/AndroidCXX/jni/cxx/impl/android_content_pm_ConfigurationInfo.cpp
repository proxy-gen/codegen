...
android_content_pm_ConfigurationInfo::android_content_pm_ConfigurationInfo()
{
	...
	const char *className = "android/content/pm/ConfigurationInfo";
	...
	if (proxiedComponent == 0)
	{
		...
		jobject jarg0;
		{
			...
			cxx_type_hierarchy_stack.push(cxx_type_hierarchy);
			{
				...
				cxx_type_hierarchy.type_name = std::string("android.content.pm.ConfigurationInfo");
			}
			std::stack<long> converter_stack;
			converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
			convert_android_content_pm_ConfigurationInfo(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
// Functions
AndroidCXX::java_lang_String android_content_pm_ConfigurationInfo::toString()
{
	LOGV("AndroidCXX::java_lang_String android_content_pm_ConfigurationInfo::toString() enter");
...
{
	LOGV("int android_content_pm_ConfigurationInfo::describeContents() enter");
...
{
	LOGV("AndroidCXX::java_lang_String android_content_pm_ConfigurationInfo::getGlEsVersion() enter");
