...
android_widget_BaseAdapter::android_widget_BaseAdapter()
{
	...
	const char *className = "android/widget/BaseAdapter";

	LOGV("android_widget_BaseAdapter className %d methodName %s methodSignature %s", className, methodName, methodSignature);
...
// Functions
bool android_widget_BaseAdapter::isEmpty()
{
	LOGV("bool android_widget_BaseAdapter::isEmpty() enter");
...
bool android_widget_BaseAdapter::hasStableIds()
{
	LOGV("bool android_widget_BaseAdapter::hasStableIds() enter");
...
int android_widget_BaseAdapter::getViewTypeCount()
{
	LOGV("int android_widget_BaseAdapter::getViewTypeCount() enter");
...
bool android_widget_BaseAdapter::areAllItemsEnabled()
{
	LOGV("bool android_widget_BaseAdapter::areAllItemsEnabled() enter");
...
void android_widget_BaseAdapter::notifyDataSetChanged()
{
	LOGV("void android_widget_BaseAdapter::notifyDataSetChanged() enter");
...
void android_widget_BaseAdapter::notifyDataSetInvalidated()
{
	LOGV("void android_widget_BaseAdapter::notifyDataSetInvalidated() enter");
