...
android_view_ViewTreeObserver_OnGlobalLayoutListener::android_view_ViewTreeObserver_OnGlobalLayoutListener(Proxy proxy)
{
	LOGV("android_view_ViewTreeObserver_OnGlobalLayoutListener::android_view_ViewTreeObserver_OnGlobalLayoutListener(Proxy proxy) enter");
	...
	LOGV("android_view_ViewTreeObserver_OnGlobalLayoutListener::android_view_ViewTreeObserver_OnGlobalLayoutListener(Proxy proxy) exit");
}
Proxy android_view_ViewTreeObserver_OnGlobalLayoutListener::proxy() const
{	
	LOGV("android_view_ViewTreeObserver_OnGlobalLayoutListener::proxy() enter");	
	CXXContext *ctx = CXXContext::sharedInstance();
	...
	LOGV("android_view_ViewTreeObserver_OnGlobalLayoutListener::proxy() exit");	
...
void android_view_ViewTreeObserver_OnGlobalLayoutListener::onGlobalLayout()
{
	...
	LOGV("android_view_ViewTreeObserver_OnGlobalLayoutListener className %s methodName %s methodSignature %s", className, methodName, methodSignature);
