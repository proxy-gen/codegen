...
template void convert_proxy<android_view_LayoutInflater_Factory>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_view_LayoutInflater_Factory2>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_view_LayoutInflater_Filter>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
// Functions
android_view_LayoutInflater *  android_view_LayoutInflater::from(android_content_Context& arg0)
{
	const char *methodName = "from";
	const char *methodSignature = "(Landroid/content/Context;)Landroid/view/LayoutInflater;";
	const char *className = "android_view_LayoutInflater";
...
android_view_LayoutInflater_Factory *  android_view_LayoutInflater::getFactory()
{
	...
	android_view_LayoutInflater_Factory *  result;
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_view_LayoutInflater_Factory>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_view_LayoutInflater_Factory * ) (*((android_view_LayoutInflater_Factory *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
android_content_Context *  android_view_LayoutInflater::getContext()
{
...
android_view_View *  android_view_LayoutInflater::inflate(org_xmlpull_v1_XmlPullParser& arg0,android_view_ViewGroup& arg1,bool& arg2,int& arg3)
{
	const char *methodName = "inflate";
	const char *methodSignature = "(Lorg/xmlpull/v1/XmlPullParser;Landroid/view/ViewGroup;ZI)Landroid/view/View;";
	const char *className = "android_view_LayoutInflater";
...
void android_view_LayoutInflater::setFactory(android_view_LayoutInflater_Factory& arg0)
{
...
android_view_LayoutInflater *  android_view_LayoutInflater::cloneInContext(android_content_Context& arg0)
{
...
android_view_LayoutInflater_Factory2 *  android_view_LayoutInflater::getFactory2()
{
	...
	android_view_LayoutInflater_Factory2 *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_view_LayoutInflater_Factory2>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_view_LayoutInflater_Factory2 * ) (*((android_view_LayoutInflater_Factory2 *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
void android_view_LayoutInflater::setFactory2(android_view_LayoutInflater_Factory2& arg0)
{
...
android_view_LayoutInflater_Filter *  android_view_LayoutInflater::getFilter()
{
	...
	android_view_LayoutInflater_Filter *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_view_LayoutInflater_Filter>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_view_LayoutInflater_Filter * ) (*((android_view_LayoutInflater_Filter *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
void android_view_LayoutInflater::setFilter(android_view_LayoutInflater_Filter& arg0)
{
...
android_view_View *  android_view_LayoutInflater::createView(java_lang_String& arg0,android_util_AttributeSet& arg1)
{
	const char *methodName = "createView";
	const char *methodSignature = "(Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;";
	const char *className = "android_view_LayoutInflater";
