...
{
	LOGV("android_webkit_ConsoleMessage::android_webkit_ConsoleMessage(const android_webkit_ConsoleMessage& cc) invoked");
...
{
	LOGV("android_webkit_ConsoleMessage::android_webkit_ConsoleMessage(void * proxy) invoked");
...
{
	LOGV("android_webkit_ConsoleMessage::~android_webkit_ConsoleMessage() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
int android_webkit_ConsoleMessage::lineNumber()
{
	...
	const char *className = "android_webkit_ConsoleMessage";
...
java_lang_String *  android_webkit_ConsoleMessage::message()
{
...
java_lang_String *  android_webkit_ConsoleMessage::sourceId()
{
...
android_webkit_ConsoleMessage_MessageLevel *  android_webkit_ConsoleMessage::messageLevel()
{
	...
	android_webkit_ConsoleMessage_MessageLevel *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_webkit_ConsoleMessage_MessageLevel>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
