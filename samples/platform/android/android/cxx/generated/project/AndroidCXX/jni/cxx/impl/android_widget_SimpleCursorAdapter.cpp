...
template void convert_proxy<android_widget_SimpleCursorAdapter_ViewBinder>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_widget_SimpleCursorAdapter_CursorToStringConverter>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
android_widget_SimpleCursorAdapter::android_widget_SimpleCursorAdapter(const android_widget_SimpleCursorAdapter& cc)
{
	LOGV("android_widget_SimpleCursorAdapter::android_widget_SimpleCursorAdapter(const android_widget_SimpleCursorAdapter& cc) invoked");
...
{
	LOGV("android_widget_SimpleCursorAdapter::android_widget_SimpleCursorAdapter(void * proxy) invoked");
...
{
	LOGV("android_widget_SimpleCursorAdapter::~android_widget_SimpleCursorAdapter() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
java_lang_CharSequence *  android_widget_SimpleCursorAdapter::convertToString(android_database_Cursor& arg0)
{
	const char *methodName = "convertToString";
	const char *methodSignature = "(Landroid/database/Cursor;)Ljava/lang/CharSequence;";
	const char *className = "android_widget_SimpleCursorAdapter";
...
void android_widget_SimpleCursorAdapter::bindView(android_view_View& arg0,android_content_Context& arg1,android_database_Cursor& arg2)
{
...
android_database_Cursor *  android_widget_SimpleCursorAdapter::swapCursor(android_database_Cursor& arg0)
{
...
android_widget_SimpleCursorAdapter_ViewBinder *  android_widget_SimpleCursorAdapter::getViewBinder()
{
	...
	android_widget_SimpleCursorAdapter_ViewBinder *  result;
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_widget_SimpleCursorAdapter_ViewBinder>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_widget_SimpleCursorAdapter_ViewBinder * ) (*((android_widget_SimpleCursorAdapter_ViewBinder *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
void android_widget_SimpleCursorAdapter::setViewBinder(android_widget_SimpleCursorAdapter_ViewBinder& arg0)
{
...
void android_widget_SimpleCursorAdapter::setViewImage(android_widget_ImageView& arg0,java_lang_String& arg1)
{
...
void android_widget_SimpleCursorAdapter::setViewText(android_widget_TextView& arg0,java_lang_String& arg1)
{
...
android_widget_SimpleCursorAdapter_CursorToStringConverter *  android_widget_SimpleCursorAdapter::getCursorToStringConverter()
{
	...
	android_widget_SimpleCursorAdapter_CursorToStringConverter *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<android_widget_SimpleCursorAdapter_CursorToStringConverter>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (android_widget_SimpleCursorAdapter_CursorToStringConverter * ) (*((android_widget_SimpleCursorAdapter_CursorToStringConverter *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
void android_widget_SimpleCursorAdapter::setCursorToStringConverter(android_widget_SimpleCursorAdapter_CursorToStringConverter& arg0)
{
...
void android_widget_SimpleCursorAdapter::changeCursorAndColumns(android_database_Cursor& arg0,std::vector<long>& arg1,std::vector<int>& arg2)
{
	const char *methodName = "changeCursorAndColumns";
	const char *methodSignature = "(Landroid/database/Cursor;[java/lang/String[[I)V";
	const char *className = "android_widget_SimpleCursorAdapter";
