...
{
	LOGV("android_widget_ZoomControls::android_widget_ZoomControls(const android_widget_ZoomControls& cc) invoked");
...
{
	LOGV("android_widget_ZoomControls::android_widget_ZoomControls(void * proxy) invoked");
...
{
	LOGV("android_widget_ZoomControls::~android_widget_ZoomControls() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
