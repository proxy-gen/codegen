...
{
	LOGV("android_content_pm_PermissionGroupInfo::android_content_pm_PermissionGroupInfo(const android_content_pm_PermissionGroupInfo& cc) invoked");
...
{
	LOGV("android_content_pm_PermissionGroupInfo::android_content_pm_PermissionGroupInfo(void * proxy) invoked");
...
{
	LOGV("android_content_pm_PermissionGroupInfo::~android_content_pm_PermissionGroupInfo() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
java_lang_String *  android_content_pm_PermissionGroupInfo::toString()
{
	const char *methodName = "toString";
	const char *methodSignature = "()Ljava/lang/String;";
	const char *className = "android_content_pm_PermissionGroupInfo";
...
void android_content_pm_PermissionGroupInfo::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
...
java_lang_CharSequence *  android_content_pm_PermissionGroupInfo::loadDescription(android_content_pm_PackageManager& arg0)
{
