...
{
	LOGV("java_lang_Integer::java_lang_Integer(const java_lang_Integer& cc) invoked");
...
{
	LOGV("java_lang_Integer::java_lang_Integer(void * proxy) invoked");
...
{
	LOGV("java_lang_Integer::~java_lang_Integer() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
int java_lang_Integer::numberOfLeadingZeros(int& arg0)
{
	...
	const char *className = "java_lang_Integer";
...
bool java_lang_Integer::equals(java_lang_Object& arg0)
{
...
java_lang_String *  java_lang_Integer::toString(int& arg0)
{
...
int java_lang_Integer::compareTo(java_lang_Integer& arg0)
{
...
unsigned char java_lang_Integer::byteValue()
{
...
java_lang_Integer *  java_lang_Integer::valueOf(java_lang_String& arg0,int& arg1)
{
...
java_lang_String *  java_lang_Integer::toHexString(int& arg0)
{
...
java_lang_Integer *  java_lang_Integer::decode(java_lang_String& arg0)
{
...
int java_lang_Integer::parseInt(java_lang_String& arg0,int& arg1)
{
...
java_lang_String *  java_lang_Integer::toOctalString(int& arg0)
{
...
java_lang_String *  java_lang_Integer::toBinaryString(int& arg0)
{
...
java_lang_Integer *  java_lang_Integer::getInteger(java_lang_String& arg0,java_lang_Integer& arg1,int& arg2)
{
	const char *methodName = "getInteger";
	const char *methodSignature = "(Ljava/lang/String;Ljava/lang/Integer;I)Ljava/lang/Integer;";
	const char *className = "java_lang_Integer";
...
int java_lang_Integer::rotateLeft(int& arg0)
{
...
int java_lang_Integer::rotateRight(int& arg0)
{
