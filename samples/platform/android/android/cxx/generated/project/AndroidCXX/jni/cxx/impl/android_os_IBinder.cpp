...
{
	LOGV("AndroidCXX::java_lang_String android_os_IBinder::getInterfaceDescriptor() enter");
...
{
	LOGV("bool android_os_IBinder::pingBinder() enter");
...
{
	LOGV("bool android_os_IBinder::isBinderAlive() enter");
...
void android_os_IBinder::linkToDeath(AndroidCXX::android_os_IBinder_DeathRecipient const& arg0,int const& arg1)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_android_os_IBinder_DeathRecipient(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
