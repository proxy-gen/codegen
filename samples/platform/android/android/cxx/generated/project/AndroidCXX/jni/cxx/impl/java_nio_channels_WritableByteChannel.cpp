...
#define LOG_TAG "java_nio_channels_WritableByteChannel"
...
int java_nio_channels_WritableByteChannel::write(AndroidCXX::java_nio_ByteBuffer const& arg0)
{
	...
	LOGV("java_nio_channels_WritableByteChannel className %s methodName %s methodSignature %s", className, methodName, methodSignature);
	...
	LOGV("java_nio_channels_WritableByteChannel jni address %d", javaObject);
