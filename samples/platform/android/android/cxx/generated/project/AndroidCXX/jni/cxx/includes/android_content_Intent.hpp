...
public:
	...
	static AndroidCXX::android_content_Intent getIntentOld(AndroidCXX::java_lang_String& arg0);
	 ...
	 std::vector<android_os_Parcelable > getParcelableArrayExtra(AndroidCXX::java_lang_String& arg0);
	 ...
	 std::vector<java_lang_String > getStringArrayExtra(AndroidCXX::java_lang_String& arg0);
	 std::vector<java_lang_CharSequence > getCharSequenceArrayExtra(AndroidCXX::java_lang_String& arg0);
	 ...
	 AndroidCXX::android_content_Intent putExtra(AndroidCXX::java_lang_String& arg0,std::vector<android_os_Parcelable >& arg1);
	 ...
	 AndroidCXX::android_content_Intent putExtra(AndroidCXX::java_lang_String& arg0,std::vector<java_lang_String >& arg1);
	 AndroidCXX::android_content_Intent putExtra(AndroidCXX::java_lang_String& arg0,std::vector<java_lang_CharSequence >& arg1);
