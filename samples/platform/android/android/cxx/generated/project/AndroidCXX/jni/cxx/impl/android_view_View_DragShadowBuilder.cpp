...
{
	LOGV("android_view_View_DragShadowBuilder::android_view_View_DragShadowBuilder(const android_view_View_DragShadowBuilder& cc) invoked");
...
{
	LOGV("android_view_View_DragShadowBuilder::android_view_View_DragShadowBuilder(void * proxy) invoked");
...
{
	LOGV("android_view_View_DragShadowBuilder::~android_view_View_DragShadowBuilder() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
