...
{
	LOGV("AndroidCXX::java_lang_CharSequence android_widget_ToggleButton::getTextOn() enter");
...
{
	LOGV("AndroidCXX::java_lang_CharSequence android_widget_ToggleButton::getTextOff() enter");
