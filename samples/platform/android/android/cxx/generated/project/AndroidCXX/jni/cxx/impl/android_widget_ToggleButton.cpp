...
{
	LOGV("android_widget_ToggleButton::android_widget_ToggleButton(const android_widget_ToggleButton& cc) invoked");
...
{
	LOGV("android_widget_ToggleButton::android_widget_ToggleButton(void * proxy) invoked");
...
{
	LOGV("android_widget_ToggleButton::~android_widget_ToggleButton() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
