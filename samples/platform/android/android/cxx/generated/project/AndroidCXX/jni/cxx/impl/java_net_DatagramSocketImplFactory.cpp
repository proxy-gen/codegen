...
AndroidCXX::java_net_DatagramSocketImpl java_net_DatagramSocketImplFactory::createDatagramSocketImpl()
{
	...
	AndroidCXX::java_net_DatagramSocketImpl result;
	...
	result = (AndroidCXX::java_net_DatagramSocketImpl) (AndroidCXX::java_net_DatagramSocketImpl((AndroidCXX::java_net_DatagramSocketImpl *) cxx_value));
