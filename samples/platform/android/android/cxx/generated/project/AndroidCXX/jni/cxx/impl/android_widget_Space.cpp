...
{
	LOGV("android_widget_Space::android_widget_Space(const android_widget_Space& cc) invoked");
...
{
	LOGV("android_widget_Space::android_widget_Space(void * proxy) invoked");
...
{
	LOGV("android_widget_Space::~android_widget_Space() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
