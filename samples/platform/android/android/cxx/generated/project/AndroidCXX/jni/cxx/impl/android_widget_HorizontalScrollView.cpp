...
android_widget_HorizontalScrollView::android_widget_HorizontalScrollView(AndroidCXX::android_content_Context const& arg0)
{
	...
	LOGV("android_widget_HorizontalScrollView className %s methodName %s methodSignature %s", className, methodName, methodSignature);
...
{
	LOGV("bool android_widget_HorizontalScrollView::shouldDelayChildPressedState() enter");
...
{
	LOGV("void android_widget_HorizontalScrollView::requestLayout() enter");
...
{
	LOGV("void android_widget_HorizontalScrollView::computeScroll() enter");
...
{
	LOGV("int android_widget_HorizontalScrollView::getMaxScrollAmount() enter");
...
{
	LOGV("bool android_widget_HorizontalScrollView::isFillViewport() enter");
...
{
	LOGV("bool android_widget_HorizontalScrollView::isSmoothScrollingEnabled() enter");
