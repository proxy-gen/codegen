...
template void convert_proxy<android_widget_Adapter>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_widget_AdapterView_OnItemLongClickListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<android_widget_AdapterView_OnItemSelectedListener>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
void android_widget_AdapterView::addView(android_view_View& arg0,int& arg1,android_view_ViewGroup_LayoutParams& arg2)
{
	const char *methodName = "addView";
	const char *methodSignature = "(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V";
	const char *className = "android_widget_AdapterView";
...
void android_widget_AdapterView::removeView(android_view_View& arg0)
{
...
bool android_widget_AdapterView::dispatchPopulateAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
bool android_widget_AdapterView::onRequestSendAccessibilityEvent(android_view_View& arg0,android_view_accessibility_AccessibilityEvent& arg1)
{
...
void android_widget_AdapterView::setOnClickListener(android_view_View_OnClickListener& arg0)
{
...
void android_widget_AdapterView::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_AdapterView::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
void android_widget_AdapterView::setAdapter(android_widget_Adapter& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_Adapter>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
bool android_widget_AdapterView::performItemClick(android_view_View& arg0,int& arg1,long& arg2)
{
...
android_view_View *  android_widget_AdapterView::getSelectedView()
{
...
void android_widget_AdapterView::setOnItemClickListener(android_widget_AdapterView_OnItemClickListener& arg0)
{
...
android_widget_AdapterView_OnItemClickListener *  android_widget_AdapterView::getOnItemClickListener()
{
...
void android_widget_AdapterView::setOnItemLongClickListener(android_widget_AdapterView_OnItemLongClickListener& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_widget_AdapterView_OnItemLongClickListener>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
android_widget_AdapterView_OnItemLongClickListener *  android_widget_AdapterView::getOnItemLongClickListener()
{
	...
	android_widget_AdapterView_OnItemLongClickListener *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
	...
	result = (android_widget_AdapterView_OnItemLongClickListener * ) (*((android_widget_AdapterView_OnItemLongClickListener *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
void android_widget_AdapterView::setOnItemSelectedListener(android_widget_AdapterView_OnItemSelectedListener& arg0)
{
...
android_widget_AdapterView_OnItemSelectedListener *  android_widget_AdapterView::getOnItemSelectedListener()
{
...
android_widget_Adapter *  android_widget_AdapterView::getAdapter()
{
	...
	result = (android_widget_Adapter * ) (*((android_widget_Adapter *  *) cxx_value));
...
java_lang_Object *  android_widget_AdapterView::getSelectedItem()
{
...
int android_widget_AdapterView::getPositionForView(android_view_View& arg0)
{
...
void android_widget_AdapterView::setEmptyView(android_view_View& arg0)
{
...
android_view_View *  android_widget_AdapterView::getEmptyView()
{
...
java_lang_Object *  android_widget_AdapterView::getItemAtPosition(int& arg0)
{
