...
{
	LOGV("android_widget_ScrollView::android_widget_ScrollView(const android_widget_ScrollView& cc) invoked");
...
{
	LOGV("android_widget_ScrollView::android_widget_ScrollView(void * proxy) invoked");
...
{
	LOGV("android_widget_ScrollView::~android_widget_ScrollView() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
void android_widget_ScrollView::addView(android_view_View& arg0,int& arg1,android_view_ViewGroup_LayoutParams& arg2)
{
	const char *methodName = "addView";
	const char *methodSignature = "(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V";
	const char *className = "android_widget_ScrollView";
...
bool android_widget_ScrollView::onTouchEvent(android_view_MotionEvent& arg0)
{
...
bool android_widget_ScrollView::onGenericMotionEvent(android_view_MotionEvent& arg0)
{
...
bool android_widget_ScrollView::dispatchKeyEvent(android_view_KeyEvent& arg0)
{
...
void android_widget_ScrollView::requestChildFocus(android_view_View& arg0)
{
...
bool android_widget_ScrollView::requestChildRectangleOnScreen(android_view_View& arg0,android_graphics_Rect& arg1,bool& arg2)
{
...
bool android_widget_ScrollView::onInterceptTouchEvent(android_view_MotionEvent& arg0)
{
...
bool android_widget_ScrollView::shouldDelayChildPressedState()
{
...
void android_widget_ScrollView::requestLayout()
{
...
void android_widget_ScrollView::onInitializeAccessibilityEvent(android_view_accessibility_AccessibilityEvent& arg0)
{
...
void android_widget_ScrollView::onInitializeAccessibilityNodeInfo(android_view_accessibility_AccessibilityNodeInfo& arg0)
{
...
bool android_widget_ScrollView::performAccessibilityAction(int& arg0,android_os_Bundle& arg1)
{
...
void android_widget_ScrollView::scrollTo(int& arg0)
{
...
void android_widget_ScrollView::draw(android_graphics_Canvas& arg0)
{
...
void android_widget_ScrollView::smoothScrollBy(int& arg0)
{
...
bool android_widget_ScrollView::executeKeyEvent(android_view_KeyEvent& arg0)
{
...
void android_widget_ScrollView::smoothScrollTo(int& arg0)
{
