...
{
	LOGV("bool android_widget_ScrollView::shouldDelayChildPressedState() enter");
...
{
	LOGV("void android_widget_ScrollView::requestLayout() enter");
...
{
	LOGV("void android_widget_ScrollView::computeScroll() enter");
...
{
	LOGV("int android_widget_ScrollView::getMaxScrollAmount() enter");
...
{
	LOGV("bool android_widget_ScrollView::isFillViewport() enter");
...
{
	LOGV("bool android_widget_ScrollView::isSmoothScrollingEnabled() enter");
