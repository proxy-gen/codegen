...
{
	LOGV("android_text_style_URLSpan::android_text_style_URLSpan(const android_text_style_URLSpan& cc) invoked");
...
{
	LOGV("android_text_style_URLSpan::android_text_style_URLSpan(void * proxy) invoked");
...
{
	LOGV("android_text_style_URLSpan::~android_text_style_URLSpan() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
// Functions
java_lang_String *  android_text_style_URLSpan::getURL()
{
	const char *methodName = "getURL";
	const char *methodSignature = "()Ljava/lang/String;";
	const char *className = "android_text_style_URLSpan";
...
void android_text_style_URLSpan::writeToParcel(android_os_Parcel& arg0,int& arg1)
{
...
void android_text_style_URLSpan::onClick(android_view_View& arg0)
{
