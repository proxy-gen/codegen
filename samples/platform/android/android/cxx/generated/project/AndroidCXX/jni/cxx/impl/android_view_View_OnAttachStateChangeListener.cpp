...
#define LOG_TAG "android_view_View_OnAttachStateChangeListener"
...
void android_view_View_OnAttachStateChangeListener::onViewAttachedToWindow(AndroidCXX::android_view_View const& arg0)
{
	...
	LOGV("android_view_View_OnAttachStateChangeListener className %s methodName %s methodSignature %s", className, methodName, methodSignature);
	...
	LOGV("android_view_View_OnAttachStateChangeListener jni address %d", javaObject);
