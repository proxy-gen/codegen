...
{
	LOGV("android_view_TouchDelegate::android_view_TouchDelegate(const android_view_TouchDelegate& cc) invoked");
...
{
	LOGV("android_view_TouchDelegate::android_view_TouchDelegate(void * proxy) invoked");
...
{
	LOGV("android_view_TouchDelegate::~android_view_TouchDelegate() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
bool android_view_TouchDelegate::onTouchEvent(android_view_MotionEvent& arg0)
{
	...
	const char *className = "android_view_TouchDelegate";
	...
	LOGV("android_view_TouchDelegate jni address %d", javaObject);
