...
{
	LOGV("android_app_Application::android_app_Application(const android_app_Application& cc) invoked");
...
{
	LOGV("android_app_Application::android_app_Application(void * proxy) invoked");
...
{
	LOGV("android_app_Application::~android_app_Application() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
