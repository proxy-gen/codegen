...
#define LOG_TAG "android_view_View_OnGenericMotionListener"
...
bool android_view_View_OnGenericMotionListener::onGenericMotion(android_view_View& arg0,android_view_MotionEvent& arg1)
{
	const char *methodName = "onGenericMotion";
	const char *methodSignature = "(Landroid/view/View;Landroid/view/MotionEvent;)Z";
	const char *className = "android_view_View_OnGenericMotionListener";
	...
	LOGV("android_view_View_OnGenericMotionListener jni address %d", javaObject);
