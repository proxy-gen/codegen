...
template void convert_proxy<android_os_IInterface>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<java_lang_Exception>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

template void convert_proxy<java_util_HashMap>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);
...
template void convert_proxy<android_os_Parcelable_Creator>(long& java_value, long& cxx_value, const CXXTypeHierarchy cxx_type_hierarchy, const converter_t& converter_type, std::stack<long>& converter_stack);

// Default Instance Constructors
android_os_Parcel::android_os_Parcel(const android_os_Parcel& cc)
{
	LOGV("android_os_Parcel::android_os_Parcel(const android_os_Parcel& cc) invoked");
...
{
	LOGV("android_os_Parcel::android_os_Parcel(void * proxy) invoked");
...
{
	LOGV("android_os_Parcel::~android_os_Parcel() invoked");
	CXXContext *ctx = CXXContext::sharedInstance();
	long address = (long) this;
	jobject proxiedComponent = ctx->findProxyComponent(address);
	if (proxiedComponent != 0)
...
void android_os_Parcel::writeInt(int& arg0)
{
	...
	const char *className = "android_os_Parcel";
...
unsigned char android_os_Parcel::readByte()
{
...
void android_os_Parcel::writeByte(unsigned char& arg0)
{
...
java_lang_String *  android_os_Parcel::readString()
{
...
void android_os_Parcel::writeValue(java_lang_Object& arg0)
{
...
void android_os_Parcel::writeString(java_lang_String& arg0)
{
...
void android_os_Parcel::writeArray(std::vector<long>& arg0)
{
...
std::vector<long> android_os_Parcel::readArray(java_lang_ClassLoader& arg0)
{
	const char *methodName = "readArray";
	const char *methodSignature = "(Ljava/lang/ClassLoader;)[java/lang/Object";
	const char *className = "android_os_Parcel";
...
android_os_ParcelFileDescriptor *  android_os_Parcel::readFileDescriptor()
{
...
void android_os_Parcel::writeFileDescriptor(java_io_FileDescriptor& arg0)
{
...
android_os_Parcel *  android_os_Parcel::obtain()
{
	...
	result = (android_os_Parcel * ) (*((android_os_Parcel *  *) cxx_value));
...
std::vector<char> android_os_Parcel::marshall()
{
...
void android_os_Parcel::unmarshall(std::vector<char>& arg0,int& arg1)
{
...
void android_os_Parcel::appendFrom(android_os_Parcel& arg0,int& arg1)
{
...
void android_os_Parcel::writeInterfaceToken(java_lang_String& arg0)
{
...
void android_os_Parcel::enforceInterface(java_lang_String& arg0)
{
...
void android_os_Parcel::writeByteArray(std::vector<char>& arg0,int& arg1)
{
...
void android_os_Parcel::writeStrongBinder(android_os_IBinder& arg0)
{
...
void android_os_Parcel::writeStrongInterface(android_os_IInterface& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_os_IInterface>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_os_Parcel::writeMap(java_util_Map& arg0)
{
...
void android_os_Parcel::writeBundle(android_os_Bundle& arg0)
{
...
void android_os_Parcel::writeList(java_util_List& arg0)
{
...
void android_os_Parcel::writeSparseArray(android_util_SparseArray& arg0)
{
...
void android_os_Parcel::writeSparseBooleanArray(android_util_SparseBooleanArray& arg0)
{
...
void android_os_Parcel::writeStringArray(std::vector<long>& arg0)
{
	const char *methodName = "writeStringArray";
	const char *methodSignature = "([java/lang/String)V";
	const char *className = "android_os_Parcel";
...
std::vector<long> android_os_Parcel::createStringArray()
{
...
void android_os_Parcel::readStringArray(std::vector<long>& arg0)
{
...
void android_os_Parcel::writeBinderArray(std::vector<long>& arg0)
{
	const char *methodName = "writeBinderArray";
	const char *methodSignature = "([android/os/IBinder)V";
	const char *className = "android_os_Parcel";
	...
	jobjectArray jarg0;
	{
		...
		{
			{
				converter_stack.push((long) &convert_proxy<android_os_IBinder>);				
...
std::vector<long> android_os_Parcel::createBinderArray()
{
	const char *methodName = "createBinderArray";
	const char *methodSignature = "()[android/os/IBinder";
	const char *className = "android_os_Parcel";
...
void android_os_Parcel::readBinderArray(std::vector<long>& arg0)
{
...
void android_os_Parcel::writeTypedList(java_util_List& arg0)
{
...
void android_os_Parcel::writeStringList(java_util_List& arg0)
{
...
void android_os_Parcel::writeBinderList(java_util_List& arg0)
{
...
void android_os_Parcel::writeTypedArray(std::vector<long>& arg0,int& arg1)
{
	const char *methodName = "writeTypedArray";
	const char *methodSignature = "([android/os/ParcelableI)V";
	const char *className = "android_os_Parcel";
...
void android_os_Parcel::writeParcelable(android_os_Parcelable& arg0,int& arg1)
{
...
void android_os_Parcel::writeSerializable(java_io_Serializable& arg0)
{
...
void android_os_Parcel::writeException(java_lang_Exception& arg0)
{
	...
	jobject jarg0;
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<java_lang_Exception>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_os_Parcel::readException(int& arg0,java_lang_String& arg1)
{
...
android_os_IBinder *  android_os_Parcel::readStrongBinder()
{
...
void android_os_Parcel::readMap(java_util_Map& arg0,java_lang_ClassLoader& arg1)
{
...
void android_os_Parcel::readList(java_util_List& arg0,java_lang_ClassLoader& arg1)
{
...
java_util_HashMap *  android_os_Parcel::readHashMap(java_lang_ClassLoader& arg0)
{
	...
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
		...
		std::stack<long> converter_stack;
		converter_t converter_type = (converter_t) CONVERT_TO_CXX;
		convert_proxy<java_util_HashMap>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
	}
	result = (java_util_HashMap * ) (*((java_util_HashMap *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
android_os_Bundle *  android_os_Parcel::readBundle(java_lang_ClassLoader& arg0)
{
...
std::vector<char> android_os_Parcel::createByteArray()
{
...
void android_os_Parcel::readByteArray(std::vector<char>& arg0)
{
...
java_util_ArrayList *  android_os_Parcel::readArrayList(java_lang_ClassLoader& arg0)
{
...
android_util_SparseArray *  android_os_Parcel::readSparseArray(java_lang_ClassLoader& arg0)
{
	...
	android_util_SparseArray *  result;
	jobject jni_result = (jobject) jni->invokeObjectMethod(javaObject,className,methodName,methodSignature,jarg0);
	long cxx_value = (long) 0;
	long java_value = convert_jni_java_lang_Object_to_java(jni_result);
	{
	...
	result = (android_util_SparseArray * ) (*((android_util_SparseArray *  *) cxx_value));
		
	jni->popLocalFrame();

	return result;
}
android_util_SparseBooleanArray *  android_os_Parcel::readSparseBooleanArray()
{
...
java_util_ArrayList *  android_os_Parcel::createTypedArrayList(android_os_Parcelable_Creator& arg0)
{
	...
	jobject jarg0;
	{
		...
		converter_t converter_type = (converter_t) CONVERT_TO_JAVA;
		convert_proxy<android_os_Parcelable_Creator>(java_value,cxx_value,cxx_type_hierarchy,converter_type,converter_stack);
...
void android_os_Parcel::readTypedList(java_util_List& arg0,android_os_Parcelable_Creator& arg1)
{
...
java_util_ArrayList *  android_os_Parcel::createStringArrayList()
{
...
java_util_ArrayList *  android_os_Parcel::createBinderArrayList()
{
...
void android_os_Parcel::readStringList(java_util_List& arg0)
{
...
void android_os_Parcel::readBinderList(java_util_List& arg0)
{
...
std::vector<long> android_os_Parcel::createTypedArray(android_os_Parcelable_Creator& arg0)
{
	const char *methodName = "createTypedArray";
	const char *methodSignature = "(Landroid/os/Parcelable$Creator;)[java/lang/Object";
	const char *className = "android_os_Parcel";
...
void android_os_Parcel::readTypedArray(std::vector<long>& arg0,android_os_Parcelable_Creator& arg1)
{
	const char *methodName = "readTypedArray";
	const char *methodSignature = "([java/lang/ObjectLandroid/os/Parcelable$Creator;)V";
	const char *className = "android_os_Parcel";
...
void android_os_Parcel::writeParcelableArray(std::vector<long>& arg0,int& arg1)
{
...
java_lang_Object *  android_os_Parcel::readValue(java_lang_ClassLoader& arg0)
{
...
android_os_Parcelable *  android_os_Parcel::readParcelable(java_lang_ClassLoader& arg0)
{
...
std::vector<long> android_os_Parcel::readParcelableArray(java_lang_ClassLoader& arg0)
{
	const char *methodName = "readParcelableArray";
	const char *methodSignature = "(Ljava/lang/ClassLoader;)[android/os/Parcelable";
	const char *className = "android_os_Parcel";
...
java_io_Serializable *  android_os_Parcel::readSerializable()
{
