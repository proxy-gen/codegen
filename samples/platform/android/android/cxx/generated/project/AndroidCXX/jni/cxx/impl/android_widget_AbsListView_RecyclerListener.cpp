...
#define LOG_TAG "android_widget_AbsListView_RecyclerListener"
...
void android_widget_AbsListView_RecyclerListener::onMovedToScrapHeap(android_view_View& arg0)
{
	const char *methodName = "onMovedToScrapHeap";
	const char *methodSignature = "(Landroid/view/View;)V";
	const char *className = "android_widget_AbsListView_RecyclerListener";
	...
	LOGV("android_widget_AbsListView_RecyclerListener jni address %d", javaObject);
