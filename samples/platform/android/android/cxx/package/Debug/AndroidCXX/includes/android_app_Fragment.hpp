...
class android_app_Fragment : public AndroidCXX::android_content_ComponentCallbacks2,public AndroidCXX::android_view_View_OnCreateContextMenuListener
{
public:

	// Public Constructor
	android_app_Fragment(Proxy * aProxy = new Proxy());
