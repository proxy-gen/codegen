...
class android_widget_ProgressBar : public AndroidCXX::java_lang_Object
{
public:

	// Public Constructor
	android_widget_ProgressBar(AndroidCXX::android_content_Context const& arg0,Proxy * aProxy = new Proxy());
	android_widget_ProgressBar(AndroidCXX::android_content_Context const& arg0,AndroidCXX::android_util_AttributeSet const& arg1,Proxy * aProxy = new Proxy());
	android_widget_ProgressBar(AndroidCXX::android_content_Context const& arg0,AndroidCXX::android_util_AttributeSet const& arg1,int const& arg2,Proxy * aProxy = new Proxy());
	android_widget_ProgressBar(const android_widget_ProgressBar& cc);
	android_widget_ProgressBar(Proxy * aProxy);
	Proxy * proxy() const;	
	// Default Destructor
