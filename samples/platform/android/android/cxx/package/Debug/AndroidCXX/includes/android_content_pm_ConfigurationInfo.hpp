...
public:
	...
	// Public Constructor
	android_content_pm_ConfigurationInfo(Proxy * aProxy = new Proxy());
	android_content_pm_ConfigurationInfo(AndroidCXX::android_content_pm_ConfigurationInfo const& arg0,Proxy * aProxy = new Proxy());
	Proxy * proxy() const;	
	// Default Destructor
