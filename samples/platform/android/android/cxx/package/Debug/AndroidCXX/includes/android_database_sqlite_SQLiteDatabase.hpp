...
public:
	...
	// Functions
	 ...
	 int _delete(AndroidCXX::java_lang_String const& arg0,AndroidCXX::java_lang_String const& arg1,std::vector<AndroidCXX::java_lang_String > const& arg2);
	 ...
	 AndroidCXX::android_database_Cursor query(bool const& arg0,AndroidCXX::java_lang_String const& arg1,std::vector<AndroidCXX::java_lang_String > const& arg2,AndroidCXX::java_lang_String const& arg3,std::vector<AndroidCXX::java_lang_String > const& arg4,AndroidCXX::java_lang_String const& arg5,AndroidCXX::java_lang_String const& arg6,AndroidCXX::java_lang_String const& arg7,AndroidCXX::java_lang_String const& arg8);
	 AndroidCXX::android_database_Cursor query(AndroidCXX::java_lang_String const& arg0,std::vector<AndroidCXX::java_lang_String > const& arg1,AndroidCXX::java_lang_String const& arg2,std::vector<AndroidCXX::java_lang_String > const& arg3,AndroidCXX::java_lang_String const& arg4,AndroidCXX::java_lang_String const& arg5,AndroidCXX::java_lang_String const& arg6,AndroidCXX::java_lang_String const& arg7);
	 AndroidCXX::android_database_Cursor query(AndroidCXX::java_lang_String const& arg0,std::vector<AndroidCXX::java_lang_String > const& arg1,AndroidCXX::java_lang_String const& arg2,std::vector<AndroidCXX::java_lang_String > const& arg3,AndroidCXX::java_lang_String const& arg4,AndroidCXX::java_lang_String const& arg5,AndroidCXX::java_lang_String const& arg6);
	...
	static AndroidCXX::android_database_sqlite_SQLiteDatabase create(AndroidCXX::android_database_sqlite_SQLiteDatabase_CursorFactory const& arg0);
	 bool isOpen();
	 int update(AndroidCXX::java_lang_String const& arg0,AndroidCXX::android_content_ContentValues const& arg1,AndroidCXX::java_lang_String const& arg2,std::vector<AndroidCXX::java_lang_String > const& arg3);
	 int getVersion();
	...
	static AndroidCXX::java_lang_String findEditTable(AndroidCXX::java_lang_String const& arg0);
	 ...
	 AndroidCXX::android_database_Cursor rawQuery(AndroidCXX::java_lang_String const& arg0,std::vector<AndroidCXX::java_lang_String > const& arg1,AndroidCXX::android_os_CancellationSignal const& arg2);
	 AndroidCXX::android_database_Cursor rawQuery(AndroidCXX::java_lang_String const& arg0,std::vector<AndroidCXX::java_lang_String > const& arg1);
	 AndroidCXX::android_database_Cursor rawQueryWithFactory(AndroidCXX::android_database_sqlite_SQLiteDatabase_CursorFactory const& arg0,AndroidCXX::java_lang_String const& arg1,std::vector<AndroidCXX::java_lang_String > const& arg2,AndroidCXX::java_lang_String const& arg3);
	 AndroidCXX::android_database_Cursor rawQueryWithFactory(AndroidCXX::android_database_sqlite_SQLiteDatabase_CursorFactory const& arg0,AndroidCXX::java_lang_String const& arg1,std::vector<AndroidCXX::java_lang_String > const& arg2,AndroidCXX::java_lang_String const& arg3,AndroidCXX::android_os_CancellationSignal const& arg4);
	 ...
	 int updateWithOnConflict(AndroidCXX::java_lang_String const& arg0,AndroidCXX::android_content_ContentValues const& arg1,AndroidCXX::java_lang_String const& arg2,std::vector<AndroidCXX::java_lang_String > const& arg3,int const& arg4);
	 void execSQL(AndroidCXX::java_lang_String const& arg0,std::vector<AndroidCXX::java_lang_Object > const& arg1);
