...
public:
	...
	// Functions
	 ...
	 std::vector<AndroidCXX::java_lang_String > getStringArray(AndroidCXX::java_lang_String const& arg0);
	 ...
	 void putParcelableArray(AndroidCXX::java_lang_String const& arg0,std::vector<AndroidCXX::android_os_Parcelable > const& arg1);
	 ...
	 void putStringArray(AndroidCXX::java_lang_String const& arg0,std::vector<AndroidCXX::java_lang_String > const& arg1);
	 void putCharSequenceArray(AndroidCXX::java_lang_String const& arg0,std::vector<AndroidCXX::java_lang_CharSequence > const& arg1);
	 ...
	 std::vector<AndroidCXX::android_os_Parcelable > getParcelableArray(AndroidCXX::java_lang_String const& arg0);
	 ...
	 std::vector<AndroidCXX::java_lang_CharSequence > getCharSequenceArray(AndroidCXX::java_lang_String const& arg0);
