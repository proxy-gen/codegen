...
public:
	...
	// Public Constructor
	android_widget_CalendarView(AndroidCXX::android_content_Context const& arg0,Proxy * aProxy = new Proxy());
	android_widget_CalendarView(AndroidCXX::android_content_Context const& arg0,AndroidCXX::android_util_AttributeSet const& arg1,Proxy * aProxy = new Proxy());
	android_widget_CalendarView(AndroidCXX::android_content_Context const& arg0,AndroidCXX::android_util_AttributeSet const& arg1,int const& arg2,Proxy * aProxy = new Proxy());
	android_widget_CalendarView(const android_widget_CalendarView& cc);
	android_widget_CalendarView(Proxy * aProxy);
	Proxy * proxy() const;	
	// Default Destructor
