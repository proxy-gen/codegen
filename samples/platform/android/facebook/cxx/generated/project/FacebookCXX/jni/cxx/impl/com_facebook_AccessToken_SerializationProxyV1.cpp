...
com_facebook_AccessToken_SerializationProxyV1::com_facebook_AccessToken_SerializationProxyV1(Proxy proxy)
{
	LOGV("com_facebook_AccessToken_SerializationProxyV1::com_facebook_AccessToken_SerializationProxyV1(Proxy proxy) enter");
	...
	LOGV("com_facebook_AccessToken_SerializationProxyV1::com_facebook_AccessToken_SerializationProxyV1(Proxy proxy) exit");
}
Proxy com_facebook_AccessToken_SerializationProxyV1::proxy() const
{	
	LOGV("com_facebook_AccessToken_SerializationProxyV1::proxy() enter");	
	CXXContext *ctx = CXXContext::sharedInstance();
	...
	LOGV("com_facebook_AccessToken_SerializationProxyV1::proxy() exit");	
