...
#define LOG_TAG "com_facebook_widget_GraphObjectAdapter_OnErrorListener"
...
void com_facebook_widget_GraphObjectAdapter_OnErrorListener::onError(FacebookCXX::com_facebook_widget_GraphObjectAdapter const& arg0,FacebookCXX::com_facebook_FacebookException const& arg1)
{
	...
	LOGV("com_facebook_widget_GraphObjectAdapter_OnErrorListener className %s methodName %s methodSignature %s", className, methodName, methodSignature);
	...
	LOGV("com_facebook_widget_GraphObjectAdapter_OnErrorListener jni address %d", javaObject);
