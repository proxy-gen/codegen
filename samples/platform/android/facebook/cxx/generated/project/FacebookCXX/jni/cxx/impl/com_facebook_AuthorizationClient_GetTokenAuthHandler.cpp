...
com_facebook_AuthorizationClient_GetTokenAuthHandler::com_facebook_AuthorizationClient_GetTokenAuthHandler(void * proxy)
{
	LOGV("com_facebook_AuthorizationClient_GetTokenAuthHandler::com_facebook_AuthorizationClient_GetTokenAuthHandler(void * proxy) enter");
	...
	LOGV("com_facebook_AuthorizationClient_GetTokenAuthHandler::com_facebook_AuthorizationClient_GetTokenAuthHandler(void * proxy) exit");
}
com_facebook_AuthorizationClient_GetTokenAuthHandler::com_facebook_AuthorizationClient_GetTokenAuthHandler()
{
	...
	const char *className = "com/facebook/AuthorizationClient$GetTokenAuthHandler";

	LOGV("com_facebook_AuthorizationClient_GetTokenAuthHandler className %d methodName %s methodSignature %s", className, methodName, methodSignature);
