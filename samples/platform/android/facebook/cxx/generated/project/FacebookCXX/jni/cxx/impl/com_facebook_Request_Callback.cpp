...
com_facebook_Request_Callback::com_facebook_Request_Callback(void * proxy)
{
	LOGV("com_facebook_Request_Callback::com_facebook_Request_Callback(void * proxy) enter");
	...
	LOGV("com_facebook_Request_Callback::com_facebook_Request_Callback(void * proxy) exit");
}
com_facebook_Request_Callback::com_facebook_Request_Callback()
{
	...
	const char *className = "com/facebook/Request$Callback";
...
// Functions
void com_facebook_Request_Callback::onCompleted(FacebookCXX::com_facebook_Response& arg0)
{
	LOGV("void com_facebook_Request_Callback::onCompleted(FacebookCXX::com_facebook_Response& arg0) enter");
	...
	LOGV("void com_facebook_Request_Callback::onCompleted(FacebookCXX::com_facebook_Response& arg0) exit");
