...
com_facebook_model_GraphObject_Factory_ProxyBase::com_facebook_model_GraphObject_Factory_ProxyBase(Proxy proxy)
{
	LOGV("com_facebook_model_GraphObject_Factory_ProxyBase::com_facebook_model_GraphObject_Factory_ProxyBase(Proxy proxy) enter");
	...
	LOGV("com_facebook_model_GraphObject_Factory_ProxyBase::com_facebook_model_GraphObject_Factory_ProxyBase(Proxy proxy) exit");
}
Proxy com_facebook_model_GraphObject_Factory_ProxyBase::proxy() const
{	
	LOGV("com_facebook_model_GraphObject_Factory_ProxyBase::proxy() enter");	
	CXXContext *ctx = CXXContext::sharedInstance();
	...
	LOGV("com_facebook_model_GraphObject_Factory_ProxyBase::proxy() exit");	
