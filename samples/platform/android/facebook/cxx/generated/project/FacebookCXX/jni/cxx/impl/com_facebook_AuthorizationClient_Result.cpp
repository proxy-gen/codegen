...
com_facebook_AuthorizationClient_Result::com_facebook_AuthorizationClient_Result(void * proxy)
{
	LOGV("com_facebook_AuthorizationClient_Result::com_facebook_AuthorizationClient_Result(void * proxy) enter");
	...
	LOGV("com_facebook_AuthorizationClient_Result::com_facebook_AuthorizationClient_Result(void * proxy) exit");
}
// TODO: remove
// 
// 
...
// 	const char *className = "com/facebook/AuthorizationClient$Result";

// 	LOGV("com_facebook_AuthorizationClient_Result className %d methodName %s methodSignature %s", className, methodName, methodSignature);
