...
public:
	...
	com_facebook_widget_PlacePickerFragment(FacebookCXX::android_os_Bundle& arg0);
	// Default Destructor
	virtual ~com_facebook_widget_PlacePickerFragment();
	// Functions
	 FacebookCXX::android_location_Location getLocation();
	 ...
	 void onAttach(FacebookCXX::android_app_Activity& arg0);
	 void onActivityCreated(FacebookCXX::android_os_Bundle& arg0);
	 void onDetach();
	 void setLocation(FacebookCXX::android_location_Location& arg0);
	 ...
	 FacebookCXX::java_lang_String getSearchText();
	 void setSearchText(FacebookCXX::java_lang_String& arg0);
	 void onSearchBoxTextChanged(FacebookCXX::java_lang_String& arg0,bool& arg1);
};	
