...
{
	LOGV("com_facebook_Settings_1::com_facebook_Settings_1(const com_facebook_Settings_1& cc) enter");
	...
	LOGV("com_facebook_Settings_1::com_facebook_Settings_1(const com_facebook_Settings_1& cc) exit");
}
com_facebook_Settings_1::com_facebook_Settings_1(Proxy proxy)
{
	LOGV("com_facebook_Settings_1::com_facebook_Settings_1(Proxy proxy) enter");
	...
	LOGV("com_facebook_Settings_1::com_facebook_Settings_1(Proxy proxy) exit");
}
Proxy com_facebook_Settings_1::proxy() const
{	
	LOGV("com_facebook_Settings_1::proxy() enter");	
	CXXContext *ctx = CXXContext::sharedInstance();
	...
	LOGV("com_facebook_Settings_1::proxy() exit");	
...
// Functions
AndroidCXX::java_lang_Thread com_facebook_Settings_1::newThread(AndroidCXX::java_lang_Runnable const& arg0)
{
	LOGV("AndroidCXX::java_lang_Thread com_facebook_Settings_1::newThread(AndroidCXX::java_lang_Runnable const& arg0) enter");
	...
	LOGV("com_facebook_Settings_1 jni address %d", javaObject);
	...
	LOGV("AndroidCXX::java_lang_Thread com_facebook_Settings_1::newThread(AndroidCXX::java_lang_Runnable const& arg0) exit");
