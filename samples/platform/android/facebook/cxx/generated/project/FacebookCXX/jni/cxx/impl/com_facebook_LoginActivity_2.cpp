...
// Functions
void com_facebook_LoginActivity_2::onBackgroundProcessingStarted()
{
	LOGV("void com_facebook_LoginActivity_2::onBackgroundProcessingStarted() enter");
	...
	LOGV("com_facebook_LoginActivity_2 jni address %d", javaObject);
...
void com_facebook_LoginActivity_2::onBackgroundProcessingStopped()
{
	LOGV("void com_facebook_LoginActivity_2::onBackgroundProcessingStopped() enter");
