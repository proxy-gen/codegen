...
com_facebook_widget_ProfilePictureView_OnErrorListener::com_facebook_widget_ProfilePictureView_OnErrorListener(void * proxy)
{
	LOGV("com_facebook_widget_ProfilePictureView_OnErrorListener::com_facebook_widget_ProfilePictureView_OnErrorListener(void * proxy) enter");
...
// Functions
void com_facebook_widget_ProfilePictureView_OnErrorListener::onError(FacebookCXX::com_facebook_FacebookException& arg0)
{
	LOGV("void com_facebook_widget_ProfilePictureView_OnErrorListener::onError(FacebookCXX::com_facebook_FacebookException& arg0) enter");
	...
	LOGV("void com_facebook_widget_ProfilePictureView_OnErrorListener::onError(FacebookCXX::com_facebook_FacebookException& arg0) exit");
