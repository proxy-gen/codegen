...
#define LOG_TAG "com_facebook_android_Facebook"
...
void com_facebook_android_Facebook::dialog(AndroidCXX::android_content_Context const& arg0,AndroidCXX::java_lang_String const& arg1,AndroidCXX::android_os_Bundle const& arg2,FacebookCXX::com_facebook_android_Facebook_DialogListener const& arg3)
{
	...
	LOGV("com_facebook_android_Facebook jni address %d", javaObject);
...
FacebookCXX::com_facebook_Session com_facebook_android_Facebook::getSession()
{
	LOGV("FacebookCXX::com_facebook_Session com_facebook_android_Facebook::getSession() enter");
...
AndroidCXX::java_lang_String com_facebook_android_Facebook::getAccessToken()
{
	LOGV("AndroidCXX::java_lang_String com_facebook_android_Facebook::getAccessToken() enter");
...
bool com_facebook_android_Facebook::shouldExtendAccessToken()
{
	LOGV("bool com_facebook_android_Facebook::shouldExtendAccessToken() enter");
...
bool com_facebook_android_Facebook::getShouldAutoPublishInstall()
{
	LOGV("bool com_facebook_android_Facebook::getShouldAutoPublishInstall() enter");
...
{
	LOGV("bool com_facebook_android_Facebook::isSessionValid() enter");
...
long com_facebook_android_Facebook::getAccessExpires()
{
	LOGV("long com_facebook_android_Facebook::getAccessExpires() enter");
...
long com_facebook_android_Facebook::getLastAccessUpdate()
{
	LOGV("long com_facebook_android_Facebook::getLastAccessUpdate() enter");
...
{
	LOGV("AndroidCXX::java_lang_String com_facebook_android_Facebook::getAppId() enter");
