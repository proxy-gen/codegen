...
com_facebook_widget_GraphObjectAdapter_2::com_facebook_widget_GraphObjectAdapter_2(Proxy proxy)
{
	LOGV("com_facebook_widget_GraphObjectAdapter_2::com_facebook_widget_GraphObjectAdapter_2(Proxy proxy) enter");
	...
	LOGV("com_facebook_widget_GraphObjectAdapter_2::com_facebook_widget_GraphObjectAdapter_2(Proxy proxy) exit");
}
Proxy com_facebook_widget_GraphObjectAdapter_2::proxy() const
{	
	LOGV("com_facebook_widget_GraphObjectAdapter_2::proxy() enter");	
	CXXContext *ctx = CXXContext::sharedInstance();
	...
	LOGV("com_facebook_widget_GraphObjectAdapter_2::proxy() exit");	
...
// Functions
void com_facebook_widget_GraphObjectAdapter_2::onCompleted(FacebookCXX::com_facebook_widget_ImageResponse const& arg0)
{
	LOGV("void com_facebook_widget_GraphObjectAdapter_2::onCompleted(FacebookCXX::com_facebook_widget_ImageResponse const& arg0) enter");
	...
	LOGV("com_facebook_widget_GraphObjectAdapter_2 className %s methodName %s methodSignature %s", className, methodName, methodSignature);
	...
	LOGV("void com_facebook_widget_GraphObjectAdapter_2::onCompleted(FacebookCXX::com_facebook_widget_ImageResponse const& arg0) exit");
