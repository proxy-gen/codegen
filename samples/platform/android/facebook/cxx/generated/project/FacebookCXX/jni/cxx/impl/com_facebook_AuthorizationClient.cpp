...
com_facebook_AuthorizationClient::com_facebook_AuthorizationClient(Proxy proxy)
{
	LOGV("com_facebook_AuthorizationClient::com_facebook_AuthorizationClient(Proxy proxy) enter");
	...
	LOGV("com_facebook_AuthorizationClient::com_facebook_AuthorizationClient(Proxy proxy) exit");
}
Proxy com_facebook_AuthorizationClient::proxy() const
{	
	LOGV("com_facebook_AuthorizationClient::proxy() enter");	
	CXXContext *ctx = CXXContext::sharedInstance();
	...
	LOGV("com_facebook_AuthorizationClient::proxy() exit");	
