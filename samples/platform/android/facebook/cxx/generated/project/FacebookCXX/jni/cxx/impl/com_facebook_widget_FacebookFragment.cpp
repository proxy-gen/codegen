...
// Functions
void com_facebook_widget_FacebookFragment::onDestroy()
{
	LOGV("void com_facebook_widget_FacebookFragment::onDestroy() enter");
	...
	LOGV("com_facebook_widget_FacebookFragment jni address %d", javaObject);
