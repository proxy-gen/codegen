...
com_facebook_widget_PlacePickerFragment_AsNeededLoadingStrategy::com_facebook_widget_PlacePickerFragment_AsNeededLoadingStrategy(Proxy proxy)
{
	LOGV("com_facebook_widget_PlacePickerFragment_AsNeededLoadingStrategy::com_facebook_widget_PlacePickerFragment_AsNeededLoadingStrategy(Proxy proxy) enter");
	...
	LOGV("com_facebook_widget_PlacePickerFragment_AsNeededLoadingStrategy::com_facebook_widget_PlacePickerFragment_AsNeededLoadingStrategy(Proxy proxy) exit");
}
Proxy com_facebook_widget_PlacePickerFragment_AsNeededLoadingStrategy::proxy() const
{	
	LOGV("com_facebook_widget_PlacePickerFragment_AsNeededLoadingStrategy::proxy() enter");	
	CXXContext *ctx = CXXContext::sharedInstance();
	...
	LOGV("com_facebook_widget_PlacePickerFragment_AsNeededLoadingStrategy::proxy() exit");	
...
// Functions
void com_facebook_widget_PlacePickerFragment_AsNeededLoadingStrategy::attach(FacebookCXX::com_facebook_widget_GraphObjectAdapter const& arg0)
{
	LOGV("void com_facebook_widget_PlacePickerFragment_AsNeededLoadingStrategy::attach(FacebookCXX::com_facebook_widget_GraphObjectAdapter const& arg0) enter");
	...
	LOGV("com_facebook_widget_PlacePickerFragment_AsNeededLoadingStrategy className %s methodName %s methodSignature %s", className, methodName, methodSignature);
	...
	LOGV("void com_facebook_widget_PlacePickerFragment_AsNeededLoadingStrategy::attach(FacebookCXX::com_facebook_widget_GraphObjectAdapter const& arg0) exit");
