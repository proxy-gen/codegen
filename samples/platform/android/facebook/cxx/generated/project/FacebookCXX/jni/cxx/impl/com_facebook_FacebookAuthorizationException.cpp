...
com_facebook_FacebookAuthorizationException::com_facebook_FacebookAuthorizationException(void * proxy)
{
	LOGV("com_facebook_FacebookAuthorizationException::com_facebook_FacebookAuthorizationException(void * proxy) enter");
	...
	LOGV("com_facebook_FacebookAuthorizationException::com_facebook_FacebookAuthorizationException(void * proxy) exit");
}
// Public Constructors
