...
com_facebook_FacebookSdkVersion::com_facebook_FacebookSdkVersion(Proxy proxy)
{
	LOGV("com_facebook_FacebookSdkVersion::com_facebook_FacebookSdkVersion(Proxy proxy) enter");
	...
	LOGV("com_facebook_FacebookSdkVersion::com_facebook_FacebookSdkVersion(Proxy proxy) exit");
}
Proxy com_facebook_FacebookSdkVersion::proxy() const
{	
	LOGV("com_facebook_FacebookSdkVersion::proxy() enter");	
	CXXContext *ctx = CXXContext::sharedInstance();
	...
	LOGV("com_facebook_FacebookSdkVersion::proxy() exit");	
