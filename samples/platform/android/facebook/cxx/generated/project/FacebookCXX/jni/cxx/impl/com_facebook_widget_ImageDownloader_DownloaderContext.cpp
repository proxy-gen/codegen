...
com_facebook_widget_ImageDownloader_DownloaderContext::com_facebook_widget_ImageDownloader_DownloaderContext(void * proxy)
{
	LOGV("com_facebook_widget_ImageDownloader_DownloaderContext::com_facebook_widget_ImageDownloader_DownloaderContext(void * proxy) enter");
	...
	LOGV("com_facebook_widget_ImageDownloader_DownloaderContext::com_facebook_widget_ImageDownloader_DownloaderContext(void * proxy) exit");
}
// TODO: remove
// 
// 
...
// 	const char *className = "com/facebook/widget/ImageDownloader$DownloaderContext";

// 	LOGV("com_facebook_widget_ImageDownloader_DownloaderContext className %d methodName %s methodSignature %s", className, methodName, methodSignature);
