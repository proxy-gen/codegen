...
com_facebook_widget_WorkQueue::com_facebook_widget_WorkQueue(void * proxy)
{
	LOGV("com_facebook_widget_WorkQueue::com_facebook_widget_WorkQueue(void * proxy) enter");
	...
	LOGV("com_facebook_widget_WorkQueue::com_facebook_widget_WorkQueue(void * proxy) exit");
}
com_facebook_widget_WorkQueue::com_facebook_widget_WorkQueue()
{
	...
	const char *className = "com/facebook/widget/WorkQueue";

	LOGV("com_facebook_widget_WorkQueue className %d methodName %s methodSignature %s", className, methodName, methodSignature);
