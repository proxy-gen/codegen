...
com_facebook_widget_ImageResponse::com_facebook_widget_ImageResponse(void * proxy)
{
	LOGV("com_facebook_widget_ImageResponse::com_facebook_widget_ImageResponse(void * proxy) enter");
	...
	LOGV("com_facebook_widget_ImageResponse::com_facebook_widget_ImageResponse(void * proxy) exit");
}
com_facebook_widget_ImageResponse::com_facebook_widget_ImageResponse()
{
	...
	const char *className = "com/facebook/widget/ImageResponse";

	LOGV("com_facebook_widget_ImageResponse className %d methodName %s methodSignature %s", className, methodName, methodSignature);
