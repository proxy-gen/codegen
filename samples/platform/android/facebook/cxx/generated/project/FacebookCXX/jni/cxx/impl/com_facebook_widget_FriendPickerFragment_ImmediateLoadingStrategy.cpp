...
com_facebook_widget_FriendPickerFragment_ImmediateLoadingStrategy::com_facebook_widget_FriendPickerFragment_ImmediateLoadingStrategy(Proxy proxy)
{
	LOGV("com_facebook_widget_FriendPickerFragment_ImmediateLoadingStrategy::com_facebook_widget_FriendPickerFragment_ImmediateLoadingStrategy(Proxy proxy) enter");
	...
	LOGV("com_facebook_widget_FriendPickerFragment_ImmediateLoadingStrategy::com_facebook_widget_FriendPickerFragment_ImmediateLoadingStrategy(Proxy proxy) exit");
}
Proxy com_facebook_widget_FriendPickerFragment_ImmediateLoadingStrategy::proxy() const
{	
	LOGV("com_facebook_widget_FriendPickerFragment_ImmediateLoadingStrategy::proxy() enter");	
	CXXContext *ctx = CXXContext::sharedInstance();
	...
	LOGV("com_facebook_widget_FriendPickerFragment_ImmediateLoadingStrategy::proxy() exit");	
