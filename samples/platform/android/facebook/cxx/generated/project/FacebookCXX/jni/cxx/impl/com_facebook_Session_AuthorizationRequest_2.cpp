...
com_facebook_Session_AuthorizationRequest_2::com_facebook_Session_AuthorizationRequest_2(void * proxy)
{
	LOGV("com_facebook_Session_AuthorizationRequest_2::com_facebook_Session_AuthorizationRequest_2(void * proxy) enter");
	...
	LOGV("com_facebook_Session_AuthorizationRequest_2::com_facebook_Session_AuthorizationRequest_2(void * proxy) exit");
}
...
// Functions
void com_facebook_Session_AuthorizationRequest_2::startActivityForResult(FacebookCXX::android_content_Intent& arg0,int& arg1)
{
	LOGV("void com_facebook_Session_AuthorizationRequest_2::startActivityForResult(FacebookCXX::android_content_Intent& arg0,int& arg1) enter");
	...
	LOGV("void com_facebook_Session_AuthorizationRequest_2::startActivityForResult(FacebookCXX::android_content_Intent& arg0,int& arg1) exit");

}
FacebookCXX::android_app_Activity com_facebook_Session_AuthorizationRequest_2::getActivityContext()
{
	LOGV("FacebookCXX::android_app_Activity com_facebook_Session_AuthorizationRequest_2::getActivityContext() enter");
	...
	LOGV("FacebookCXX::android_app_Activity com_facebook_Session_AuthorizationRequest_2::getActivityContext() exit");
