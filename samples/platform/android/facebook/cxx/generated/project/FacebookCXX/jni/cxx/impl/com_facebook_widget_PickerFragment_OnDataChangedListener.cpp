...
void com_facebook_widget_PickerFragment_OnDataChangedListener::onDataChanged(FacebookCXX::com_facebook_widget_PickerFragment const& arg0)
{
	...
	LOGV("com_facebook_widget_PickerFragment_OnDataChangedListener className %s methodName %s methodSignature %s", className, methodName, methodSignature);
	...
	LOGV("com_facebook_widget_PickerFragment_OnDataChangedListener jni address %d", javaObject);
