...
CXX_SRC_FILES := $(call find_src_files,cxx/impl) $(call find_src_files,../../../../project/FacebookCXX/jni/cxx/impl)

CXX_INCLUDES := $(LOCAL_PATH)/cxx/includes $(LOCAL_PATH)/../../../../project/FacebookCXX/jni/cxx/includes
...
LOCAL_WHOLE_STATIC_LIBRARIES += FacebookCXX_static
...
$(call import-module, project/FacebookCXX/jni)
