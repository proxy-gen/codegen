...
LD_LIBRARY_PATH=${android_indexer_cxx} python ${generator_dir}/generator.py --config $my_dir/generated/config/FacebookCXX/config.py --platform android --generate-code --generate-projects --generate-wrapper-projects --namespace FacebookCXX --output-dir $my_dir/generated --include-config-path $samples_dir --package FacebookCXX --file FacebookCXX --include-package AndroidCXX --include-package-rel-path ../../../android/cxx/generated/project/exported/AndroidCXX --wrapper-file FacebookWrapperCXX --log info
