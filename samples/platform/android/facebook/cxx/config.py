...
config = {
	...
	'classes' : [
		...
		},
		{
			...
			'extends' : [{'name': 'com.facebook.widget.WebDialog$Builder'}, {'name': 'java.lang.Object'}],
			'fields' : [
			],	
			'functions' : [
				{
		...
		},
		{
			...
			'tags' : ['_interface', '_no_callback', '_proxy'],
			'extends' : [{'name': 'java.lang.Object'}],
			'fields' : [
			],	
			'functions' : [
		...
		},
		{
			...
			'tags' : ['_no_callback', '_proxy'],
			'extends' : [{'name': 'com.facebook.AuthorizationClient$AuthHandler'}, {'name': 'java.lang.Object'}],
			'fields' : [
			],	
			'functions' : [
			],	
		...
		},
		{
			...
			'tags' : ['_no_callback', '_proxy'],
			'extends' : [{'name': 'com.facebook.AuthorizationClient$KatanaAuthHandler'}, {'name': 'java.lang.Object'}],
			'fields' : [
			],	
			'functions' : [
			],	
		...
		},
		{
			...
			'tags' : ['_instance', '_proxy'],
			'extends' : [{'name': 'com.facebook.FacebookException'}, {'name': 'java.lang.Object'}],
			'fields' : [
			],	
			'functions' : [
			],	
		...
		},
		{
			...
			'tags' : ['_no_callback', '_proxy'],
			'extends' : [{'name': 'android.os.Handler'}, {'name': 'java.lang.Object'}],
			'fields' : [
			],	
			'functions' : [
				{
		...
		},
		{
			...
			'tags' : ['_proxy'],
			'extends' : [{'name': 'com.facebook.Session'}, {'name': 'java.lang.Object'}],
			'fields' : [
			],	
			'functions' : [
				{
		...
		},
		{
			...
			'tags' : ['_no_callback', '_proxy'],
			'extends' : [{'name': 'android.content.BroadcastReceiver'}, {'name': 'java.lang.Object'}],
			'fields' : [
			],	
			'functions' : [
				{
		...
		},
		{
			...
			'tags' : ['_instance', '_proxy'],
			'extends' : [{'name': 'com.facebook.widget.WebDialog'}, {'name': 'java.lang.Object'}],
			'fields' : [
			],	
			'functions' : [
			],	
		...
		},
		{
			...
			'tags' : ['_instance', '_no_callback', '_proxy'],
			'extends' : [{'name': 'java.lang.Object'}, {'name': 'java.util.AbstractList'}],
			'implements' : [{'name': 'com.facebook.model.GraphObjectList'}],
			'fields' : [
			],	
			'functions' : [
				{
		...
		},
		{
			...
			'tags' : ['_instance', '_no_callback', '_proxy'],
			'extends' : [{'name': 'com.facebook.model.GraphObject$Factory$ProxyBase'}, {'name': 'java.lang.Object'}],
			'fields' : [
			],	
			'functions' : [
				{
		...
		},
		{
			...
			'tags' : ['_no_callback', '_proxy'],
			'extends' : [{'name': 'android.support.v4.app.Fragment'}, {'name': 'java.lang.Object'}],
			'fields' : [
			],	
			'functions' : [
				{
		...
		},
		{
			...
			'tags' : ['_instance', '_proxy'],
			'extends' : [{'name': 'com.facebook.widget.PickerFragment'}, {'name': 'java.lang.Object'}],
			'fields' : [
				{
		...
		},
		{
			...
			'tags' : ['_no_callback', '_proxy'],
			'extends' : [{'name': 'com.facebook.widget.PickerFragment$LoadingStrategy'}, {'name': 'java.lang.Object'}],
			'fields' : [
			],	
			'functions' : [
			],	
		...
		},
		{
			...
			'tags' : ['_instance', '_no_callback', '_proxy'],
			'extends' : [{'name': 'android.widget.BaseAdapter'}, {'name': 'java.lang.Object'}],
		...
		},
		{
			...
			'tags' : ['_instance', '_no_callback', '_proxy'],
			'extends' : [{'name': 'android.support.v4.content.Loader'}, {'name': 'java.lang.Object'}],
			'fields' : [
			],	
			'functions' : [
				{
		...
		},
		{
			...
			'tags' : ['_no_callback', '_proxy'],
			'extends' : [{'name': 'java.io.BufferedInputStream'}, {'name': 'java.lang.Object'}],
			'fields' : [
			],	
			'functions' : [
				{
		...
		},
		{
			...
			'tags' : ['_instance', '_proxy'],
			'extends' : [{'name': 'android.widget.Button'}, {'name': 'java.lang.Object'}],
			'fields' : [
			],	
			'functions' : [
				{
		...
		},
		{
			...
			'tags' : ['_no_callback', '_proxy'],
			'extends' : [{'name': 'com.facebook.widget.PickerFragment$SelectionStrategy'}, {'name': 'java.lang.Object'}],
			'fields' : [
			],	
			'functions' : [
				{
		...
		},
		{
			...
			'tags' : ['_abstract', '_no_callback', '_proxy'],
			'extends' : [{'name': 'com.facebook.widget.GraphObjectAdapter'}, {'name': 'java.lang.Object'}],
			'fields' : [
			],	
			'functions' : [
			],	
		...
		},
		{
			...
			'tags' : ['_instance', '_proxy'],
			'extends' : [{'name': 'android.widget.FrameLayout'}, {'name': 'java.lang.Object'}],
			'fields' : [
				{
					'name' : 'CUSTOM',
					'tags' : ['_proxy', '_static'],
		...
		},
		{
			...
			'tags' : ['_instance', '_proxy'],
			'extends' : [{'name': 'com.facebook.widget.FacebookFragment'}, {'name': 'java.lang.Object'}],
			'fields' : [
			],	
			'functions' : [
				{
		...
		},
		{
			...
			'tags' : ['_instance', '_proxy'],
			'extends' : [{'name': 'android.app.Dialog'}, {'name': 'java.lang.Object'}],
			'fields' : [
				{
					'name' : 'DEFAULT_THEME',
					'tags' : ['_proxy', '_static'],
		...
		},
		{
			...
			'tags' : ['_instance', '_proxy'],
			'extends' : [{'name': 'com.facebook.widget.WebDialog$BuilderBase'}, {'name': 'java.lang.Object'}],
			'fields' : [
			],	
			'functions' : [
			],	
		...
		},
		{
			...
			'tags' : ['_no_callback', '_proxy'],
			'extends' : [{'name': 'android.webkit.WebViewClient'}, {'name': 'java.lang.Object'}],
			'fields' : [
			],	
			'functions' : [
				{
