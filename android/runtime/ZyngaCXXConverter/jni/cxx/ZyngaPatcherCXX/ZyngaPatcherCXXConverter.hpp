...
class ZyngaPatcherCXXConverter
{
public:
	...
	static ZyngaPatcherCXXConverter* sharedInstance();
protected:

	static ZyngaPatcherCXXConverter* sm_sharedInstance;
	ZyngaPatcherCXXConverter();
	virtual ~ZyngaPatcherCXXConverter();
};
