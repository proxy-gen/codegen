/*
 * ZyngaMiSocialCXXConverter.cpp
 *
 *  Created on: Apr 4, 2013
 *      Author: rvergis
 */

#include "ZyngaMiSocialCXXConverter.hpp"

#define LOG_TAG "ZyngaMiSocialCXXConverter"
#define LOGV(...) ((void)__android_log_print(ANDROID_LOG_VERBOSE, LOG_TAG, __VA_ARGS__))
#define LOGW(...) ((void)__android_log_print(ANDROID_LOG_WARN, LOG_TAG, __VA_ARGS__))
#define LOGW_V(message, args) ((void)__android_log_print(ANDROID_LOG_WARN, LOG_TAG, message, args))

ZyngaMiSocialCXXConverter* ZyngaMiSocialCXXConverter::sm_sharedInstance = new ZyngaMiSocialCXXConverter();

ZyngaMiSocialCXXConverter::ZyngaMiSocialCXXConverter()
{
	LOGV("ZyngaMiSocialCXXConverter constructor invoked");
}

ZyngaMiSocialCXXConverter::~ZyngaMiSocialCXXConverter()
{
	LOGV("ZyngaMiSocialCXXConverter destructor invoked");
}

ZyngaMiSocialCXXConverter* ZyngaMiSocialCXXConverter::sharedInstance()
{
	return sm_sharedInstance;
}

void ZyngaMiSocialCXXConverter::readBoolFromPayload(jobject obj, bool &result)
{
...
void ZyngaMiSocialCXXConverter::readStringFromPayload(jobject obj, std::string& result)
{
	JNIContext *jni = JNIContext::sharedInstance();
...
void ZyngaMiSocialCXXConverter::readIntFromPayload(jobject obj, int& result)
{
	JNIContext *jni = JNIContext::sharedInstance();
...
void ZyngaMiSocialCXXConverter::readMiSocialFriendVectorFromPayload(jobject obj, std::vector<std::map<std::string,std::string> > &result)
{
		JNIContext *jni = JNIContext::sharedInstance();
...
void ZyngaMiSocialCXXConverter::readMiSocialFriendMapFromPayload(jobject obj, std::map<std::string,std::vector<std::map<std::string,std::string> > > &result)
{
	JNIContext *jni = JNIContext::sharedInstance();
...
void ZyngaMiSocialCXXConverter::readStringMapFromPayload(jobject obj, std::map<std::string, std::string> &result)
{
	JNIContext *jni = JNIContext::sharedInstance();
...
void ZyngaMiSocialCXXConverter::fromCXXMapToBundle(std::map<std::string,std::string> map, jobject &result)
{
...
void ZyngaMiSocialCXXConverter::fromCXXVectorToJSONArray(std::vector<std::string> vec, jobject &result)
{
	JNIContext *jni = JNIContext::sharedInstance();
...
void ZyngaMiSocialCXXConverter::fromCXXMapToMap(std::map<std::string,std::string> map, jobject &result)
{
	JNIContext *jni = JNIContext::sharedInstance();
