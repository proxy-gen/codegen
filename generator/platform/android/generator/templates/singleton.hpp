...
#ifndef _$singleton_class_name
#define _$singleton_class_name
//
// Scroll Down 
//
...
#if $singleton_head_file_name != $proxied_file_name
...
#if $singleton_class_name != $proxied_type
class $proxied_type;
#end if
#end if
#end for
