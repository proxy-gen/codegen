...
class BaseGenerator(object):
	...
	def __init__(self):
		...
		self.config['include_config_file_path'] = None
...
def main():
	...
	if opts.include_config_file_path:
		platform_generator.config['include_config_file_path'] = opts.include_config_file_path
